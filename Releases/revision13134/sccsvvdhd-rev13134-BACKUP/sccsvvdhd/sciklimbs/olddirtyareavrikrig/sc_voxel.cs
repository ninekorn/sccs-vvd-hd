...
namespace sccs
{
    public class sc_voxel : ITransform, IComponent
    {
        ...
        public sc_voxel.DInstanceData[] instancesDataRIGHT { get; set; }
        public sc_voxel.DInstanceData[] instancesDataUP { get; set; }
        ...
        public bool Initialize(scdirectx D3D, int width, int height, int depth, float tileSize, int divX, int divY, float _sizeX, float _sizeY, float _sizeZ, Vector4 color, int instX, int instY, int instZ, IntPtr windowsHandle, Matrix matroxer, int isTerrain, float offsetPosX, float offsetPosY, float offsetPosZ, World the_world, float mass, bool is_static, scdirectx.BodyTag _tag, int minx, int miny, int minz, float diagmaxx, float diagmaxy, float diagmaxz, float diagminx, float diagminy, float diagminz, int ChunkWidth_L_, int ChunkWidth_R_, int ChunkHeight_L_, int ChunkHeight_R_, int ChunkDepth_L_, int ChunkDepth_R_, float planesize_, Vector3 offset_pos, float maxDistance, float vertoffsetx, float vertoffsety, float vertoffsetz, int addToWorld, int _voxel_type)
        {
        ...
        int[] map;
        int[] triangles;
        private bool InitializeBuffer(scdirectx D3D, int width, int height, int depth, float sizex, float sizey, float sizez, float tileSize, int instX, int instY, int instZ, IntPtr windowsHandle, Matrix matroxer, int isTerrain, float offsetPosX, float offsetPosY, float offsetPosZ, scdirectx.BodyTag _tag, int minx, int miny, int minz, float diagmaxx, float diagmaxy, float diagmaxz, float diagminx, float diagminy, float diagminz, int ChunkWidth_L, int ChunkWidth_R, int ChunkHeight_L, int ChunkHeight_R, int ChunkDepth_L, int ChunkDepth_R, float planesize, Vector3 offset_pos, float maxDistance, float vertoffsetx, float vertoffsety, float vertoffsetz)
        {
            try
            {
                List<Vector3> verts;
                ...
                alternateinstancescount = InstanceCount;
