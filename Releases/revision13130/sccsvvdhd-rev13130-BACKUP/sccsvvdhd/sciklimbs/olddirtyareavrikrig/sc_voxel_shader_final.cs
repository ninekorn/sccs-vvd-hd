...
namespace sccs
{
    public class sc_voxel_shader_final                 // 228 lines
    {
        ...
        public sc_voxel.DLightBuffer[] _DLightBuffer;

        public bool Initialize(Device device, IntPtr windowsHandler, SharpDX.Direct3D11.Buffer ConstantLightBuffer, sc_voxel.DLightBuffer[] DLightBuffer)
        {
        ...
        private void RenderShader(DeviceContext deviceContext, sc_voxel.DLightBuffer[] _DLightBuffer_, sc_voxel _cuber)
        {
            ...
            /*if (_cuber.alternateinstancescount == 0)
            {
                _cuber.alternateinstancescount = _cuber._instX * _cuber._instY * _cuber._instZ;
            }*/
