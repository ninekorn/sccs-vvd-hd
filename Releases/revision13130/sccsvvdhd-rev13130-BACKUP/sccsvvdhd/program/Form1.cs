...
namespace sccsr14sc
{
    ...
    public partial class Form1 : Form
    {
        ...
        public String picturebox2drawString0 = "tu:";
        public String picturebox2drawString1 = "tr:";
            ...
            */
            ...
            //if (pictureBox1.BackgroundImage != null)
            {
                ...
                */
                ...
                float width = 1920;// 200.0F;

                float height = 1080;// 50.0F;
            ...
            if (size++ > 0 && isAltTabWindow(hWnd))
            {
                ...
                if (sb.ToString() == SelectedTitle)
                {
                    ...
                    if (SelectedTitle.ToLower().Contains("microsoft") && SelectedTitle.ToLower().Contains("edge"))
                    {
                        ...
                        var iswinmax = sccsr14sc.Form1.IsWindowMaximized(hWnd);
   ...
   bool fAttach);
        ...
        */
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (this.checkBox1.Checked)
            {
                ...
                else
                {
                    ...
                    currentform.Size = new System.Drawing.Size(1920, 1080);
                    currentform.FormBorderStyle = FormBorderStyle.None;
                    currentform.WindowState = FormWindowState.Maximized;
                    currentform.TopMost = true;
        ...
        private void checkBox2_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (this.checkBox2.Checked)
            {
                label2.Text = "Made by Steve Chassé's Core Systems voxel virtual desktop high definition ! (sccs-vvd-hd). using sharpdx.direct11. made in C#"; 

                /*sccsr14sc.Form1.thebutton3.Invoke((MethodInvoker)delegate
                {

                    sccsr14sc.Form1.thebutton3.Text = "Shrink";
                });*/
            ...
            else if (!this.checkBox2.Checked)
            {
                ...
                /*sccsr14sc.Form1.thebutton3.Invoke((MethodInvoker)delegate
                {
                    ...
                    sccsr14sc.Form1.thebutton3.Text = "Maximize";
                });*/
                //this.button3.Text = "Maximize";
                ...
                */
                ...
                Program.SetWindowPos(capturedprogram, (IntPtr)Program.SpecialWindowHandles.HWND_NOTOPMOST, 0, 0, 1920, 1080, (uint)Program.SetWindowPosFlags.SWP_SHOWWINDOW);
        ...
        private void comboBox5_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            lastsccsvvdhdpointlighttype = sccsvvdhdresolutionvalue;
