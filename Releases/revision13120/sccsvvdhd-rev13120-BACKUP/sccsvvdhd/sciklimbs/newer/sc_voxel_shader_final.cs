...
namespace sccs
{
    public class sc_voxel_shader_final                 // 228 lines
    {
        ...
        public sccs.sc_voxel.DLightBuffer[] _DLightBuffer;

        public bool Initialize(Device device, IntPtr windowsHandler, SharpDX.Direct3D11.Buffer ConstantLightBuffer, sccs.sc_voxel.DLightBuffer[] DLightBuffer)
        {
        ...
        private bool InitializeShader(Device device, IntPtr windowsHandler, string vsFileName, string psFileName)
        {
            try
            {
                ...
                */
                ...
                vsFileName = sccsvvdhd.Properties.Resources.texture_voxelVS;// "../../../_sc_instance_shader/" + "texture.vs";
                psFileName = sccsvvdhd.Properties.Resources.texture_voxelPS;// "../../../_sc_instance_shader/" + "texture.ps";

                //vertexShaderByteCode = ShaderBytecode.Compile(vsFileName, "TextureVertexShader", "vs_4_0", ShaderFlags.None, SharpDX.D3DCompiler.EffectFlags.None);
                //pixelShaderByteCode = ShaderBytecode.Compile(psFileName, "TexturePixelShader", "ps_4_0", ShaderFlags.None, SharpDX.D3DCompiler.EffectFlags.None);
                var gsFileName = sccsvvdhd.Properties.Resources.geoshaderikrig;// "../../../_sc_instance_shader/" + "texture.ps";
                ...
                var geometryShaderByteCode = ShaderBytecode.Compile(gsFileName, "GS", "gs_5_0", ShaderFlags.None, SharpDX.D3DCompiler.EffectFlags.None);
        ...
        private bool SetShaderParameters(DeviceContext deviceContext, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture, Matrix[] worldMatrix_instances)
        {
            try
            {
                ...
                deviceContext.GeometryShader.SetConstantBuffer(bufferPositionNumber, ConstantMatrixBuffer);

                deviceContext.PixelShader.SetShaderResource(0, texture);
                deviceContext.GeometryShader.SetShaderResource(0, texture);
        ...
        private void RenderShader(DeviceContext deviceContext, sc_voxel.DLightBuffer[] _DLightBuffer_, sc_voxel _cuber)
        {
            ...
            if (_switchOnce == 0)
            {
                ...
                {
                    sccs.Program.MessageBox((IntPtr)0, ex.ToString() + "", "Oculus Error", 0);
                }
                //_switchOnce = 1;
            }
            ...
            //Console.WriteLine("ik rig frame arrives here");

            //deviceContext.DrawIndexedInstanced(_cuber.IndexCount, _cuber.altinstancecount, 0, 0, 0);
