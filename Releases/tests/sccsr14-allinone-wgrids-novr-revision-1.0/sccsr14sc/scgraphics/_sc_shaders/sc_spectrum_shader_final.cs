...
namespace SCCoreSystems.SC_Graphics
{
    public class sc_spectrum_shader_final// 228 lines
    {
        ...
        public SCCoreSystems.SC_Graphics.sc_spectrum.DLightBuffer[] _DLightBuffer;

        public bool Initialize(Device device, IntPtr windowsHandler, SharpDX.Direct3D11.Buffer ConstantLightBuffer, SCCoreSystems.SC_Graphics.sc_spectrum.DLightBuffer[] DLightBuffer)
        {
