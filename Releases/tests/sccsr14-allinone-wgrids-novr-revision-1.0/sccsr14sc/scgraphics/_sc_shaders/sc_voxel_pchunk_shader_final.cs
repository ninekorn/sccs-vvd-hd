...
{
    public class sc_voxel_pchunk_pchunk_shader_final                 // 228 lines
    {
        ...
        public sc_voxel_pchunk_pchunk_shader_final()
        {
        ...
        public SCCoreSystems.SC_Graphics.sc_voxel_pchunk.DLightBuffer[] _DLightBuffer;

        public bool Initialize(Device device, IntPtr windowsHandler, SharpDX.Direct3D11.Buffer ConstantLightBuffer, SCCoreSystems.SC_Graphics.sc_voxel_pchunk.DLightBuffer[] DLightBuffer)
        {
        ...
        private bool InitializeShader(Device device, IntPtr windowsHandler, string vsFileName, string psFileName)
        {
            try
            {
                ...
                */
                ...
                vsFileName = SCCoreSystems.Properties.Resources.texture_voxelPlanet;// "../../../_sc_instance_shader/" + "texture.vs";
                psFileName = SCCoreSystems.Properties.Resources.texture_voxelPlanet1;// "../../../_sc_instance_shader/" + "texture.ps";
                var gsFileName = SCCoreSystems.Properties.Resources.HLSL;// "../../../_sc_instance_shader/" + "texture.ps";
        ...
        public bool Render(DeviceContext deviceContext, int VertexCount, int InstanceCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture, sc_voxel_pchunk.DLightBuffer[] _DLightBuffer_, sc_voxel_pchunk _cuber)
        {
        ...
        private void RenderShader(DeviceContext deviceContext, sc_voxel_pchunk.DLightBuffer[] _DLightBuffer_, sc_voxel_pchunk _cuber)
        {
            ...
            deviceContext.GeometryShader.Set(null); // null
