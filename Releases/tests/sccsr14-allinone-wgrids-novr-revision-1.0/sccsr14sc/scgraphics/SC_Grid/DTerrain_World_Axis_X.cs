...
{
    public class DTerrain_World_Axis_X                   // 179 lines
    {
        // Structs
        ...
        // Methods.
        public bool Initialize(SCCoreSystems.sc_console.SC_console_directx D3D, int width, int height, float size_screen, int divX, int divY,float a, float r, float g, float b)
        {
        ...
        private bool InitializeBuffers(SCCoreSystems.sc_console.SC_console_directx D3D)
        {
            try
            {
                ...
                for (int x = -_divX; x < (_divX); x++)
                {
                    //float xx = x - oriWidth;
                    for (int y = -_divY; y < (_divY); y++)
                    {
