...
{
    public class DTerrain_Screen                   // 179 lines
    {
        // Structs
        ...
        // Methods.
        public bool Initialize(SCCoreSystems.sc_console.SC_console_directx D3D, int width, int height, float tileSize, int divX, int divY,float a, float r, float g, float b, float depthScreen, float offsetDepth, float maxwidthMul, float maxheightMul)
        {
            _tileSize = tileSize;
