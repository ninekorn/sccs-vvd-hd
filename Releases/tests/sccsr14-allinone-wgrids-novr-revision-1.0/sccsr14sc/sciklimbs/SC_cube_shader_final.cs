...
namespace sccs.scgraphics
{
    public class SC_cube_shader_final                 // 228 lines
    {
        ...
        public sccs.scgraphics.SC_cube.DLightBuffer[] _DLightBuffer;

        public bool Initialize(Device device, IntPtr windowsHandler, SharpDX.Direct3D11.Buffer ConstantLightBuffer, sccs.scgraphics.SC_cube.DLightBuffer[] DLightBuffer, int shadertype)
        {
        ...
        private bool InitializeShader(Device device, IntPtr windowsHandler, string vsFileName, string psFileName, int shadertype)
        {
            try
            {
                ...
                */
                ...
                /*vsFileName = sccsr14sc.Properties.Resources.textureVS;// "../../../_sc_instance_shader/" + "texture.vs";
                psFileName = sccsr14sc.Properties.Resources.texturePS;// "../../../_sc_instance_shader/" + "texture.ps";
                var gsFileName = sccsr14sc.Properties.Resources.HLSL;
                ...
                */
                ...
                {
                    vsFileName = sccsr14sc.Properties.Resources.textureVSassets;// "../../../_sc_instance_shader/" + "texture.vs";
                    psFileName = sccsr14sc.Properties.Resources.texturePSassets;// "../../../_sc_instance_shader/" + "texture.ps";
                    var gsFileName = sccsr14sc.Properties.Resources.HLSL;
