...
namespace sccs
{
    public class chunkscreen : IDisposable
    {
        ...
        public void Dispose()
        {
            ...
            */
            ...
            _chunkArray = null; //
            _tempChunkArray = null; //
            _tempChunkArrayRightFace = null; //
            _tempChunkArrayLeftFace = null; //
            _tempChunkArrayFrontFace = null; //
            _tempChunkArrayBackFace = null; //
            _tempChunkArrayBottomFace = null; //
            _chunkVertexArray = null; //
            _testVertexArray = null; //


            fastNoise = null; //new FastNoise();
            ...
            somechunkkeyboardpriminstanceindex = 0;
            chunkprimindex = 0;
            chunkinstindex = 0;
            ...
            out double m21d, out double m22d, out double m23d, out double m24d, out double m31d, out double m32d, out double m33d, out double m34d, out double m41d, out double m42d, out double m43d, out double m44d, int someswtc)// , int somechunkkeyboardpriminstanceindex_, int chunkprimindex_, int chunkinstindex_
        {
            ...
            if (swtcsetneighboors == 0 || swtcsetneighboors == -1 || swtcsetneighboors == 1 || swtcsetneighboors == -3)
            {
                ...
                for (int i = 0; i < sometotal; i++)
                {
                    //if (t0 < sometotal)
                    {
                        ...
                        var someindexmain = xx + (width) * (yy + (depth) * zz);
            ...
            */
            ...
            float DarrayOfDeVectorMapTempTwoW = 521098764321098765432109876543210.0123456789012345678901234567890125f;// 1;*/
            /*
            double arrayofbytemaprowm11 = Program.usetypeofvoxel;// 1; //111111111111111111111111111
            double arrayofbytemaprowm12 = Program.usetypeofvoxel;// 1; //111111111111111111111111111
            double arrayofbytemaprowm13 = Program.usetypeofvoxel;// 1; //111111111111111111111111111
            double arrayofbytemaprowm14 = Program.usetypeofvoxel;// 1; //111111111111111111111111111

            double arrayofbytemaprowm21 = Program.usetypeofvoxel;// 1; //111111111111111111111111111
            double arrayofbytemaprowm22 = Program.usetypeofvoxel;// 1; //111111111111111111111111111
            double arrayofbytemaprowm23 = Program.usetypeofvoxel;// 1; //111111111111111111111111111
            double arrayofbytemaprowm24 = Program.usetypeofvoxel;// 1; //111111111111111111111111111

            double arrayofbytemaprowm31 = Program.usetypeofvoxel;// 1; //111111111111111111111111111
            double arrayofbytemaprowm32 = Program.usetypeofvoxel;// 1; //111111111111111111111111111
            double arrayofbytemaprowm33 = Program.usetypeofvoxel;// 1; //111111111111111111111111111
            double arrayofbytemaprowm34 = Program.usetypeofvoxel;// 1; //111111111111111111111111111

            double arrayofbytemaprowm41 = Program.usetypeofvoxel;// 1; //111111111111111111111111111
            double arrayofbytemaprowm42 = Program.usetypeofvoxel;// 1; //111111111111111111111111111
            double arrayofbytemaprowm43 = Program.usetypeofvoxel;// 1; //111111111111111111111111111
            double arrayofbytemaprowm44 = Program.usetypeofvoxel;// 1; //111111111111111111111111111
            */
            ...
            float somevar = 1111111111111111.11111111111111111f;


            if (somevar == arrayofbytemaprowm11a)
            {
                Program.MessageBox((IntPtr)0, "m11adder" + m11adder + " val: " + (arrayofbytemaprowm11a - somevar).ToString(), "sccsmsg", 0);
