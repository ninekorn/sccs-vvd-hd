...
namespace sccs
{
    public class scchunkvscreen
    {
        ...
        public scchunkvscreenshader shaderOfChunk;
        ...
        public struct chunkData
        {
            ...
            public scchunkvscreenshader chunkShader;
        ...
        public scchunkvscreen(SharpDX.Direct3D11.Device device, float xi, float yi, float zi, Vector4 color, int width, int height, int depth, Vector3 pos,int mapWidth_, int mapHeight_, int mapDepth_, int tinyChunkWidth_, int tinyChunkHeight_,int tinyChunkDepth_, int mapObjectInstanceWidth_, int mapObjectInstanceHeight_,int mapObjectInstanceDepth_, float planesize_) //,DInstanceType[] _instances
        {
            ...
            var vsFileNameByteArray = sccsr14wpf.Properties.Resources.textureTrig;
            var psFileNameByteArray = sccsr14wpf.Properties.Resources.textureTrig1;
            var gsFileNameByteArray = sccsr14wpf.Properties.Resources.geometryshader;
