...
namespace sccs
{
    ...
    public class chunk
    {
        ...
        public byte[] startBuildingArray(Vector3 currentPosition, out Vector4[] vertexArray, out int[] indicesArray,out byte[] mapper, out sclevelgenchunk.DVertex[] dVertexArray, out Vector3[] norms, out Vector2[] tex) //, out int vertexNum, out int indicesNum
        {
