    ...
    internal class GraphicsCapture : ICaptureMethod
    {
        ...
        public void StartCapture(IntPtr hWnd, Device device, Factory factory)
        {
            ...
            */
            ...
            _hWnd = capturePicker.PickCaptureTarget(hWnd);

            capturedwindowname = capturePicker.selectedwindowname;
            ...
            var hr = NativeMethodsgc.CreateDirect3D11DeviceFromDXGIDevice(device.NativePointer, out var pUnknown);
            if (hr != 0)
            {
                StopCapture();
                return;
