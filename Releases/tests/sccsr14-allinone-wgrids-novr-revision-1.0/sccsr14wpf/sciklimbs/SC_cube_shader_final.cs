...
namespace sccs.scgraphics
{
    public class SC_cube_shader_final                 // 228 lines
    {
        ...
        public bool Initialize(Device device, IntPtr windowsHandler, SharpDX.Direct3D11.Buffer ConstantLightBuffer, sccs.scgraphics.SC_cube.DLightBuffer[] DLightBuffer)
        {
        ...
        private bool InitializeShader(Device device, IntPtr windowsHandler, string vsFileName, string psFileName)
        {
            try
            {
                ...
                */
                ...
                vsFileName = sccsr14wpf.Properties.Resources.textureVS;// "../../../_sc_instance_shader/" + "texture.vs";
                psFileName = sccsr14wpf.Properties.Resources.texturePS;// "../../../_sc_instance_shader/" + "texture.ps";
                var gsFileName = sccsr14wpf.Properties.Resources.HLSL;
