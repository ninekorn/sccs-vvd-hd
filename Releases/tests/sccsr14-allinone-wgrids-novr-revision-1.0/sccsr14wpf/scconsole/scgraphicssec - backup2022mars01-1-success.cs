       ...
       // sccs.scgraphics.sc_voxel.DLightBuffer[] _DLightBuffer_voxel_cube = new sc_voxel.DLightBuffer[1];
                                    ...
                                    for (int xxx = 0; xxx < somevoxelvirtualdesktopw; xxx++)
                                    {
                                        for (int yyy = 0; yyy < somevoxelvirtualdesktoph; yyy++)
                                        {
                                            for (int zzz = 0; zzz < somevoxelvirtualdesktopd; zzz++)
                                            {
                                                ...
                                                somevoxelvirtualdesktop[somevoxelindex].currentWorldMatrix = somevoxelvirtualdesktop[somevoxelindex].worldmatofobj;
        ...
        public unsafe void oculuscontrolsNRecordSoundNMousePointer(Matrix projMatrix, Matrix camViewMatrix)
        {
            ...
            */
            ...
            Matrix tempmatsc = somevoxelvirtualdesktop[0].currentWorldMatrix;
           ...
           */
            ...
            */
            ...
            float somevalx = 2.0f * 1.04f;// 1.125f; //9.0f // 
            float somevaly = 3.555555555555555555555555556f * 1.04f; //16.0f 1.7777777777777777777777777777778f // 

            Vector3 somemaxposleftbottom = cameraPos - (direction_feet_right * (-1.0f/somevalx)); //9
            ...
            worldMatrix_instances_screen_assets[0][0][8] = tempmat;
            ...
            worldMatrix_instances_screen_assets[0][0][8].M43 = (float)pointOnScreenn.Z;

            somemaxposleftbottom = cameraPos - (direction_feet_right * (-1.0f / somevalx)); //9
            somemaxposleftbottom = somemaxposleftbottom + (direction_feet_up * (-1.0f / somevaly)); //16

            worldMatrix_instances_screen_assets[0][0][9] = tempmat;
            ...
            worldMatrix_instances_screen_assets[0][0][9].M43 = (float)pointOnScreenn.Z;

            somemaxposleftbottom = cameraPos + (direction_feet_right * (-1.0f / somevalx)); //9
            somemaxposleftbottom = somemaxposleftbottom - (direction_feet_up * (-1.0f / somevaly)); //16

            worldMatrix_instances_screen_assets[0][0][10] = tempmat;
            ...
            worldMatrix_instances_screen_assets[0][0][10].M43 = (float)pointOnScreenn.Z;


            somemaxposleftbottom = cameraPos + (direction_feet_right * (-1.0f / somevalx)); //9
            somemaxposleftbottom = somemaxposleftbottom + (direction_feet_up * (-1.0f / somevaly)); //16

            worldMatrix_instances_screen_assets[0][0][11] = tempmat;
            ...
            worldMatrix_instances_screen_assets[0][0][11].M43 = (float)pointOnScreenn.Z;
