...
namespace sccs.scgraphics
{
    public class scgraphicssec //: sccs.scgraphics.scupdate//SC_Intermediate_Update
    {
       ...
       // sccs.scgraphics.sc_voxel.DLightBuffer[] _DLightBuffer_voxel_cube = new sc_voxel.DLightBuffer[1];
        ...
        public unsafe void oculuscontrolsNRecordSoundNMousePointer(Matrix projMatrix)
        {
            ...
            */
            ...
            worldMatrix_instances_screen_assets[0][0][5].M41 = (float)someposleftTop.X;
            worldMatrix_instances_screen_assets[0][0][5].M42 = (float)someposleftTop.Y;
            worldMatrix_instances_screen_assets[0][0][5].M43 = (float)someposleftTop.Z;


            Vector3 pointinfrontof = someposleftTop + (direction_feet_forward);
            Vector3 raydir = someposleftTop - pointinfrontof;
            raydir.Normalize();

            //var raymouse = new Ray(positionofmouseonscreen, direction_feet_forward);
            var raymouse = new Ray(someposleftTop, raydir);
            ...
            */
            ...
            worldMatrix_instances_screen_assets[0][0][1].M43 = (float)mouseintersectsscreenvec.Z;
            */
