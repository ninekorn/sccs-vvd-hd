...
namespace sccs.scgraphics
{
    public class scgraphicssec //: sccs.scgraphics.scupdate//SC_Intermediate_Update
    {
        ...
        public int somevoxelvirtualdesktopw = 2;
        public int somevoxelvirtualdesktoph = 2;
                                                                            ...
                                                                            for (int zz = 0; zz < somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInDepth; zz++)
                                                                            {
                                                                                ...
                                                                                */
                                                                                ...
                                                                                else if (somevoxelvirtualdesktopglobals.tinyChunkWidth == 8 && somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInWidth == 240 && somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight == 135 && somevoxelvirtualdesktopw == 2 && somevoxelvirtualdesktoph == 2)
                                                                                {
                                                                                    ...
                                                                                    //size of screen 480 * 270
                                                                                    //size of parts 240 * 135

                                                                                    //var someoffset = (xx) + (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInWidth * 2) * (yy + (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight * 2) * zz);

                                                                                    var somemainindexx = (somevoxelvirtualdesktopindex * 240) * somepixelsize; ///(480 * xxx) * 4;
                                                                                    var somemainindexy = (somevoxelvirtualdesktopindex * 135) * somepixelsize;// (270 * yyy) * 4;
                                                                                    //var somemainindex = (((1080 - ((270) * xxx)) * 1920) + (((480) * yyy) + (0)));
                                                                                    //var somemainindex = 0;// (((1080 - ((270) * xxx)) * 1920) + (((480) * yyy) + (0))) * somepixelsize;

                                                                                    if (somevoxelvirtualdesktopindex == 0)
                                                                                    {
                                                                                        //divxadd = (xx * 4 * 2) + ((xx * 2 * xxx) * 4);// (c * xx);
                                                                                        //divyadd = (yy * 4 * 2) + ((yy * 2 * yyy) * 4);// (c * yy);
                                                                                        divxadd = (xx * 8);// (c * xx);
                                                                                        divyadd = (yy * 8);// (c * yy);
                                                                                    }
                                                                                    else if (somevoxelvirtualdesktopindex == 1)
                                                                                    {
                                                                                        divxadd = (xx * 4);// + somemainindexx;// (c * xx);
                                                                                        divyadd = (yy * 4);//  + somemainindexy;// (c * yy);
                                                                                    }
                                                                                    else if (somevoxelvirtualdesktopindex == 2)
                                                                                    {
                                                                                        divxadd = (xx * 4);// + somemainindexx;// (c * xx);
                                                                                        divyadd = (yy * 4);//  + somemainindexy;// (c * yy);
                                                                                    }
                                                                                    else if (somevoxelvirtualdesktopindex == 3)
                                                                                    {
                                                                                        divxadd = (xx * 4);//  + somemainindexx;// (c * xx);
                                                                                        divyadd = (yy * 4);//  + somemainindexy;// (c * yy);
                                                                                    }
                                                                                    ...
                                                                                    /*else if (somevoxelvirtualdesktopindex == 1)
                                                                                    {
                                                                                        divxadd = (xx * 4) + (somevoxelvirtualdesktopindex * xx);
                                                                                        divyadd = (yy * 4) + (somevoxelvirtualdesktopindex * yy);
                                                                                    }
                                                                                    else if (somevoxelvirtualdesktopindex == 2)
                                                                                    {
                                                                                        divxadd = (xx * 4) + (somevoxelvirtualdesktopindex * xx);
                                                                                    ...
                                                                                    //var somemainindex = (((1080 - (divyadd * xxx)) * 1920) + ((divxadd * yyy) + (0))) * somepixelsize;
                                                                                ...
                                                                                var somemultiplier = somevoxelvirtualdesktopglobals.planeSize * -100; //-25 // -100
                                                                                ...
                                                                                var somemindexx = somevoxelvirtualdesktopindex;
                                                                                /*if (somemindexx == 0)
                                                                                {
                                                                                    somemindexx = 1;
                                                                                }
                                                                                ...
                                                                                var somemindexy = somevoxelvirtualdesktopindex;
                                                                                /*if (somemindexy == 0)
                                                                                {
                                                                                    somemindexy = 1;
                                                                                }
                                                                                ...
                                                                                if (somepixelarrayvalue != null && somepixelarrayvalue.Length > 0 && MainWindow.exitedprogram == -1)
                                                                                {
                                                                                    ...
                                                                                    else if (somevoxelvirtualdesktopglobals.tinyChunkWidth == 8)
                                                                                    {
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (0 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (0 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (0 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (1 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (0 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (2 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (0 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (3 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (0 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (4 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (0 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (5 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (0 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (6 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (0 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (7 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (1 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (0 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (1 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (1 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (1 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (2 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (1 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (3 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (1 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (4 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (1 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (5 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (1 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (6 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (1 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (7 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                        ...
                                                                                        //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser), "scmsg",0); // 8294400
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (2 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (0 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M11 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (2 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (1 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M12 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (2 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (2 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M13 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (2 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (3 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M14 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (2 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (4 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M21 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (2 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (5 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M22 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (2 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (6 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M23 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (2 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (7 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M24 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (3 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (0 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M31 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (3 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (1 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M32 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (3 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (2 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M33 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (3 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (3 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M34 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (3 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (4 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M41 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (3 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (5 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M42 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (3 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (6 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M43 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (3 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (7 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M44 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser), "scmsg",0); // 8294400
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (4 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (0 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M11 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (4 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (1 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M12 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (4 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (2 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M13 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (4 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (3 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M14 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (4 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (4 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M21 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (4 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (5 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M22 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (4 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (6 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M23 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (4 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (7 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M24 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (5 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (0 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M31 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (5 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (1 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M32 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (5 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (2 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M33 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (5 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (3 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M34 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (5 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (4 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M41 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (5 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (5 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M42 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (5 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (6 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M43 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (5 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (7 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M44 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser), "scmsg",0); // 8294400
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (6 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (0 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M11 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (6 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (1 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M12 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (6 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (2 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M13 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (6 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (3 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M14 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (6 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (4 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M21 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (6 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (5 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M22 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (6 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (6 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M23 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (6 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (7 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M24 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (7 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (0 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M31 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (7 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (1 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M32 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (7 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (2 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M33 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (7 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (3 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M34 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (7 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (4 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M41 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (7 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (5 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M42 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (7 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (6 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M43 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                        ...
                                                                                        bytePoser = ((((someresh + (someresh * somemindexy)) - (divyadd + (7 * someindexmy))) * (someresw + (someresw * somemindexx))) + (divxadd + (7 * someindexmx))) * somepixelsize;
                                                                                        if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M44 = somepixelarrayvalue[bytePoser] * somemultiplier;
                                                                                            }
                                                                                            catch (Exception ex)
                                                                                            {
                                                                                                //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
