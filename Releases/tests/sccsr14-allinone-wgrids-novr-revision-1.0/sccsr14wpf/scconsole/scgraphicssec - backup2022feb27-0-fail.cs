...
namespace sccs.scgraphics
{
    public class scgraphicssec //: sccs.scgraphics.scupdate//SC_Intermediate_Update
    {
                        ...
                        for (int x = 0; x < Program.worldwidth; x++)
                        {
                            for (int y = 0; y < Program.worldheight; y++)
                            {
                                for (int z = 0; z < Program.worlddepth; z++)
                                {
                                    ...
                                    var pitcher = (float)(Math.PI * (RotationInstScreenx) / 180.0f);
                                    var yawer = (float)(Math.PI * (RotationInstScreeny) / 180.0f);
                                    var roller = (float)(Math.PI * (RotationInstScreenz) / 180.0f);
                                    var somematrixroter = SharpDX.Matrix.RotationYawPitchRoll(yawer, pitcher, roller);
        ...
        public unsafe void oculuscontrolsNRecordSoundNMousePointer(Matrix projMatrix)
        {
            ...
            var planer = new Plane(new Vector3(somevoxelvirtualdesktop[0].currentWorldMatrix.M41, somevoxelvirtualdesktop[0].currentWorldMatrix.M42, somevoxelvirtualdesktop[0].currentWorldMatrix.M43), screenNormalForward);
            //var screen_mat = worldMatrix_instances_screens[0][0][0];
            //Matrix screen_mat = somevoxelvirtualdesktop[0].worldmatofobj;
            ...
            */
            ...
            var someRay = new Ray(cameraPos, direction_feet_forward);
            ...
            var intersecter = someRay.Intersects(ref planer, out cameraforwardintersectsscreen);
            ...
            */
            ...
            var pointOnScreenn = new Vector3(mouseintersectsscreenvec.X, mouseintersectsscreenvec.Y, mouseintersectsscreenvec.Z);
            ...
            currentPosWidth = widthLength - dd1; // 
            currentPosHeight = heightLength - bb;
            ...
            //var somediffx = positionOfScreen.X + intersectpointforscreen.X;


            // Console.WriteLine(intersectpointforscreen.X);

            /*var somepretendedposintersectx = intersectpointforscreen.X + positionOfScreen.X - posoffsetx;


            if (somepretendedposintersectx >= positionOfScreen.X - posoffsetx && somepretendedposintersectx < positionOfScreen.X + posoffsetx)
            {
                Console.WriteLine(intersectpointforscreen.X + " true" + " "+ positionOfScreen.X + " " + positionOfScreen.Y +  " " + positionOfScreen.Z);
            }
            else
            {
                Console.WriteLine(intersectpointforscreen.X + " false" + " " + positionOfScreen.X + " " + positionOfScreen.Y + " " + positionOfScreen.Z);
            }*/
            ...
            */
            ...
            //Console.WriteLine(Program.someform.mousex + " " + Program.someform.mousey);
            ...
            //Console.WriteLine(somepoint.X + " " + somepoint.Y);

            //Program.mousesim.MoveMouseTo();
            ...
            _intersectTouchRightMatrix = somevoxelvirtualdesktop[0].worldmatofobj;
            ...
            _intersectTouchLeftMatrix = somevoxelvirtualdesktop[0].worldmatofobj;
           ...
           // _MicrosoftWindowsMouseRight(percentXRight, percentYRight, thumbStickRight, percentXLeft, percentYLeft, thumbStickLeft, percentXRight, percentYRight);
            ...
            //NEW LOGIC FOR OUT OF BOUNDS NOT REALLY WORKING THAT WELL.
            //NEW LOGIC FOR OUT OF BOUNDS NOT REALLY WORKING THAT WELL.
            //NEW LOGIC FOR OUT OF BOUNDS NOT REALLY WORKING THAT WELL.
