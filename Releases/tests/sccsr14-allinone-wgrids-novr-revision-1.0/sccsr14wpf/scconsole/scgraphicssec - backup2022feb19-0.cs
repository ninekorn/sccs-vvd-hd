...
namespace sccs.scgraphics
{
    public class scgraphicssec //: sccs.scgraphics.scupdate//SC_Intermediate_Update
    {
        ...
        public scmessageobjectjitter[][] workonvdiv(scmessageobjectjitter[][] _sc_jitter_tasks)
        {
                                ...
                                for (int x = 0; x < somevoxelvirtualdesktopglobals.numberOfObjectInWidth; x++)
                                {
                                    for (int y = 0; y < somevoxelvirtualdesktopglobals.numberOfObjectInHeight; y++)
                                    {
                                        for (int z = 0; z < somevoxelvirtualdesktopglobals.numberOfObjectInDepth; z++)
                                        {
                                            ...
                                            //somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c] = somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].shaderOfChunk.writetostream(somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c], c, sccs.scgraphics.scupdate.screencaptureframe.ShaderResource, somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].voxeltype);
        ...
        public scmessageobjectjitter[][] scwritetostream(scmessageobjectjitter[][] _sc_jitter_tasks)
        {
