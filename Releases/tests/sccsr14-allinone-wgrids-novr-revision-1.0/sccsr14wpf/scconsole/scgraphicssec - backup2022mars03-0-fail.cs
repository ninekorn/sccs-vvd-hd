...
namespace sccs.scgraphics
{
    public class scgraphicssec //: sccs.scgraphics.scupdate//SC_Intermediate_Update
    {
        ...
        int lastmousevirtualx = 0;
        int lastmousevirtualy = 0;
...
*/
        ...
        public unsafe void oculuscontrolsNRecordSoundNMousePointer(Matrix projMatrix, Matrix camViewMatrix)
        {
            ...
            */
            ...
            Vector3 screenorigindir = cameraPos + (direction_feet_forward * 1.0f);// new Vector3(somevoxelvirtualdesktop[0].worldmatofobj.M41, somevoxelvirtualdesktop[0].worldmatofobj.M42, somevoxelvirtualdesktop[0].worldmatofobj.M43);
            Matrix tempmatsc = somevoxelvirtualdesktop[0].worldmatofobj;
            Quaternion otherQuatsc;
            Quaternion.RotationMatrix(ref tempmatsc, out otherQuatsc);
            ...
            worldMatrix_instances_screen_assets[0][0][18] = tempMatrix;
            ...
            */
            ...
            someposleftTop = (vertbottomleft) + (screenNormalRight * (somemousex)); //9 // (screenNormalRight * sizeWidtherer)
            ...
            if (MainWindow.vewindowsfoundedz != IntPtr.Zero && canworkx == 0 && canworky == 0)
            {
                ...
                if (watchforgetmouseclick.Elapsed.Milliseconds > 0)
                {
                    ...
                    {
                        //MainWindow.MessageBox((IntPtr)0, "0", "sccs message 1", 0);




                        //Console.WriteLine(MainWindow.mlbuttondown);

                        if (MainWindow.mlbuttondown == 1) // keynmouseinput._MouseState.Buttons[0]) //
                        //if (MainWindow.keynmouseinput._MouseState.Buttons[0])
                        {
                            //MainWindow.MessageBox((IntPtr)0, "1", "sccs message 1", 0);
                            ...
                            if (mousebuttonframecounter == 0)
                            {
                                ...
                                */
                                ...
                                //MainWindow.MessageBox((IntPtr)0, "found handle " + iHandle, "sccs message 1", 0);



                                //SendMessage(iHandle, WM_LBUTTONDOWN, 0, (positionmouseinvy << 16) | positionmouseinvx);
                                //SendMessage(iHandle, WM_LBUTTONUP, 0, 0);

                                //mouse_event(0x0001, (uint)positionmouseinvx, (uint)positionmouseinvy, 0, 0);
                                //MainWindow.MessageBox((IntPtr)0, "found handle " + ((positionmouseinvy << 16) | positionmouseinvx), "sccs message 1", 0);

                                MainWindow.mlbuttondown = 0;
                                // Specify the point you want to click
                                //var screenPoint = this.PointToScreen(new Point(button2.Left, button2.Top));
                                //var screenPoint = new Point(positionmouseinvx, positionmouseinvy);
                                ...
                                {
                                    SendMessage(MainWindow.vewindowsfoundedz, BM_CLICK, IntPtr.Zero, IntPtr.Zero);
                                }*/
                                ...
                                /*
                                SendMessage(MainWindow.vewindowsfoundedz, WM_LBUTTONDOWN, IntPtr.Zero, (IntPtr)lparm);
                                SendMessage(MainWindow.vewindowsfoundedz, WM_LBUTTONUP, IntPtr.Zero, (IntPtr)lparm);
                                */
                                ...
                                /*uint X = (uint)positionmouseinvx;
                                uint Y = (uint)positionmouseinvy;
                                ...
                                */
                                ...
                                // retrieve Notepad main window handle 
                                /*IntPtr hWnd = MainWindow.vewindowsfoundedz;// FindWindow("voidexpanse", "voidexpanse");

                                if (!hWnd.Equals(IntPtr.Zero))

                                {
                                    //MainWindow.MessageBox((IntPtr)0, "found handle " + hWnd, "sccs message 1", 0);
                                    // make the minimized window be normal
                                    //ShowWindowAsync(hWnd, SW_SHOWNORMAL);
                                    ...
                                    Console.WriteLine("trying to access website");
                                }
                                else
                                {
                                    MainWindow.MessageBox((IntPtr)0, "didn't find handle " + hWnd, "sccs message 1", 0);
                                }*/
                                ...
                                Input[] inputs = new Input[]
                                {
                                    new Input
                                    {
                                        ...
                                        u = new InputUnion
                                        {
                                            mi = new MouseInput
                                            {
                                                //dx = (int)positionmouseinvx,
                                                //dy = (int)positionmouseinvy,
                                                dwFlags = (uint)(MouseEventF.LeftDown), //MouseEventF.Move | 
                                                dwExtraInfo = GetMessageExtraInfo()
                                            }
                                        }
                                    }
