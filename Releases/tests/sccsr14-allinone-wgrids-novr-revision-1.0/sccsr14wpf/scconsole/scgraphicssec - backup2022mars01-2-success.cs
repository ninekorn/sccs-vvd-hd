...
namespace sccs.scgraphics
{
    public class scgraphicssec //: sccs.scgraphics.scupdate//SC_Intermediate_Update
    {
        ...
        float _screen_assets_size_z = 0.005f;
        float _size_screen;
       ...
       // sccs.scgraphics.sc_voxel.DLightBuffer[] _DLightBuffer_voxel_cube = new sc_voxel.DLightBuffer[1];
                        ...
                        for (int x = 0; x < Program.worldwidth; x++)
                        {
                            for (int y = 0; y < Program.worldheight; y++)
                            {
                                for (int z = 0; z < Program.worlddepth; z++)
                                {
                                    ...
                                    somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInWidth = 240; //256 // 512 // 128
                                    somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight = 135; //128 // 256 // 72
                                    ...
                                    var pitch = (float)(Math.PI * (25) / 180.0f);
        ...
        public unsafe void oculuscontrolsNRecordSoundNMousePointer(Matrix projMatrix, Matrix camViewMatrix)
        {
           ...
           */
            ...
            var positionOfMousereducedx = (((2.0f * (float)mousex) / (float)sccs.scgraphics.scdirectx.D3D.SurfaceWidth) - 1.0f);
            var positionOfMousereducedy = ((((2.0f * (float)mousey) / (float)sccs.scgraphics.scdirectx.D3D.SurfaceHeight) - 1.0f) * -1.0f);
            ...
            */
            ...
            /*float somevalxx = 2.0f * 1.04f;// 1.125f; //9.0f // 
            float somevalyy = 3.555555555555555555555555556f * 1.04f; //16.0f 1.7777777777777777777777777777778f // 

            Vector3 somemaxposleftbottom = screenorigindir - (directionoriginscreenr * (-1.0f/somevalxx)); //9
            somemaxposleftbottom = somemaxposleftbottom - (directionoriginscreenu * (-1.0f/somevalyy)); //16

            //Console.WriteLine("x:" + somemaxposleftbottom.X + " y:" + somemaxposleftbottom.Y);

            worldMatrix_instances_screen_assets[0][0][8] = tempMatrix;
            worldMatrix_instances_screen_assets[0][0][8].M41 = (float)somemaxposleftbottom.X;
            worldMatrix_instances_screen_assets[0][0][8].M42 = (float)somemaxposleftbottom.Y;
            worldMatrix_instances_screen_assets[0][0][8].M43 = (float)somemaxposleftbottom.Z;

            somemaxposleftbottom = screenorigindir - (directionoriginscreenr * (-1.0f / somevalxx)); //9
            somemaxposleftbottom = somemaxposleftbottom + (directionoriginscreenu * (-1.0f / somevalyy)); //16

            worldMatrix_instances_screen_assets[0][0][9] = tempMatrix;
            worldMatrix_instances_screen_assets[0][0][9].M41 = (float)somemaxposleftbottom.X;
            worldMatrix_instances_screen_assets[0][0][9].M42 = (float)somemaxposleftbottom.Y;
            worldMatrix_instances_screen_assets[0][0][9].M43 = (float)somemaxposleftbottom.Z;

            somemaxposleftbottom = screenorigindir + (directionoriginscreenr * (-1.0f / somevalxx)); //9
            somemaxposleftbottom = somemaxposleftbottom - (directionoriginscreenu * (-1.0f / somevalyy)); //16

            worldMatrix_instances_screen_assets[0][0][10] = tempMatrix;
            worldMatrix_instances_screen_assets[0][0][10].M41 = (float)somemaxposleftbottom.X;
            worldMatrix_instances_screen_assets[0][0][10].M42 = (float)somemaxposleftbottom.Y;
            worldMatrix_instances_screen_assets[0][0][10].M43 = (float)somemaxposleftbottom.Z;

            somemaxposleftbottom = screenorigindir + (directionoriginscreenr * (-1.0f / somevalxx)); //9
            somemaxposleftbottom = somemaxposleftbottom + (directionoriginscreenu * (-1.0f / somevalyy)); //16

            worldMatrix_instances_screen_assets[0][0][11] = tempMatrix;
            worldMatrix_instances_screen_assets[0][0][11].M41 = (float)somemaxposleftbottom.X;
            worldMatrix_instances_screen_assets[0][0][11].M42 = (float)somemaxposleftbottom.Y;
            worldMatrix_instances_screen_assets[0][0][11].M43 = (float)somemaxposleftbottom.Z;*/
            ...
            //Matrix inverseViewMatrix = Matrix.Invert(camViewMatrix);
            ...
            /*if (Math.Abs(diffy0) >= Math.Abs(diffy1))
            {
                Vector3 somePos = positionCursorTopRight + (screenNormalUp * (diffy1));
                worldMatrix_instances_screen_assets[0][0][7] = tempMatrix;
                worldMatrix_instances_screen_assets[0][0][7].M41 = (float)somePos.X;
                //worldMatrix_instances_screen_assets[0][0][6].M42 = (float)someposleftTop.Y;
                //worldMatrix_instances_screen_assets[0][0][6].M43 = (float)pointOnScreenn.Z;
            ...
            {
                Vector3 somePos = positionCursorbottomright + (screenNormalUp * (diffy0));
                worldMatrix_instances_screen_assets[0][0][7] = tempMatrix;
                worldMatrix_instances_screen_assets[0][0][7].M41 = (float)somePos.X;
                //worldMatrix_instances_screen_assets[0][0][6].M42 = (float)someposleftTop.Y;
                //worldMatrix_instances_screen_assets[0][0][6].M43 = (float)pointOnScreenn.Z;
            ...
            //Vector3 vert00mid = vert00;
            //vert00mid.Y += sizeheighterer;
            //float adjacent = (pointOnScreenn - someposleftTop).Length();
            //float hyp = RRR;
            //float angleOfA = (float)Math.Acos(diffy / hypothenusecursortotopright);
            //Console.WriteLine("arad:" + angleOfA + " adeg:" + sc_maths.RadianToDegree(angleOfA));

            /*
            Vector2 posonscreen0 = new Vector2(positionCursorTopRight.X, positionCursorTopRight.Y);
            Vector2 posonscreen1 = new Vector2(mouseintersectsscreenvec.X, mouseintersectsscreenvec.Y);

            var angle2d = sc_maths.AngleBetween(posonscreen0, posonscreen1);

            //var angle3d = sc_maths.AngleBetweener(positionCursorTopRight, mouseintersectsscreenvec, true);
            Console.WriteLine(angle2d);*/
            ...
            //float diffy = positionCursorTopRight.Y - mouseintersectsscreenvec.Y;
            //float diffy2 = positionCursorbottomright.Y - mouseintersectsscreenvec.Y;
            //float averagey = (diffy + diffy2) / 2;
            //float averagey = (float)((Math.Abs(diffy) + Math.Abs(diffy2))) / 2;
            ...
            /*
            if (Program.keynmouseinput.IsMouseButtonDown())
            {
                ...
                //SendMessage((int)Program.testGetWindowThreadProcessId, WM_LBUTTONDOWN | WM_LBUTTONUP, 0, lparm);
            ...
            //Vector3 camviewmatrixpos = new Vector3(inverseViewMatrix.M41, inverseViewMatrix.M42, inverseViewMatrix.M43);
            //Console.WriteLine(camviewmatrixpos);

            /*Matrix modelmatrix = Matrix.Translation(somevoxelvirtualdesktop[0].worldmatofobj.M41, somevoxelvirtualdesktop[0].worldmatofobj.M42, somevoxelvirtualdesktop[0].worldmatofobj.M43); ;// Matrix.Translation(-5.0f, 1.0f, 5.0f);
            //Matrix modelmatrix = Matrix.Translation(somevoxelvirtualdesktop[0].currentWorldMatrix.M41, somevoxelvirtualdesktop[0].currentWorldMatrix.M42, somevoxelvirtualdesktop[0].currentWorldMatrix.M43);
            //Vector3 positionmodel = new Vector3(somevoxelvirtualdesktop[0].currentWorldMatrix.M41, somevoxelvirtualdesktop[0].currentWorldMatrix.M42, somevoxelvirtualdesktop[0].currentWorldMatrix.M43);
            //Vector3 camvec = inverseViewMatrix * modelmatrix * positionmodel;

            Matrix worldMatrix = Matrix.Multiply(sccs.scgraphics.scdirectx.D3D.WorldMatrix, modelmatrix);
            ...
            //float adjacent = (float)(Math.Cos(25) * 0.54f);
            //float opposite = (float)(Math.Sin(25) * 0.54f);
            //Console.WriteLine(opposite);

            //float somevalxx = ((opposite * 1920) / 1080);
            //float somevalyy = opposite;

            //float somevalx = 2.0f * (1.04f + 0);// 1.125f; //9.0f // 
            //float somevaly = 3.555555555555555555555555556f * (1.04f + 0); //16.0f 1.7777777777777777777777777777778f // 

            //float somevaltest = 2.08f;
            ...
            var distfromscreenx = (currentScreenPos - cameraPos).Length();
            */
            ...
            var distfromscreeny = (currentScreenPos - cameraPos).Length();
            */
            ...
            //Console.WriteLine("d0:" + distfromscreenx + " d1:" + distfromscreeny);
            //Console.WriteLine("d0:" + distfromscreen);

            float somevaltestx = 2.08f/ 1.0f;
            float somevaltesty = 3.6977777777777777777777777777778f / 1.0f;

            float somevalx = somevaltestx;
            float somevaly = somevaltesty;
            //float somevalx = 9.0f / 4.25f;// 1.125f; //9.0f // 4.32675f
            //float somevaly = 16.0f / 4.25f; //16.0f 1.7777777777777777777777777777778f // 

            //float distfromscreen = 1.0f;//from middle of screen

            //var rayOrigin = Vector3.TransformCoordinate(backcampos, inversedWorldMatrix);
            ...
            Vector3 camposother = cameraPos;
            //camposother.Y = mouseintersectsscreenvec.Y;

            float distfromcamera = (mouseintersectsscreenvec - camposother).Length();




            somevaltestx = 2.08f / distfromcamera;
            somevaltesty = 3.6977777777777777777777777777778f / distfromcamera;

            somevalx = somevaltestx;
            somevaly = somevaltesty;
            //float somevalx = 9.0f / 4.25f;// 1.125f; //9.0f // 4.32675f
            //float somevaly = 16.0f / 4.25f; //16.0f 1.7777777777777777777777777777778f // 
            ...
            //someposleftTop = someposleftTop + (direction_feet_forward * 0.650f);
            backcampos = cameraPos - (direction_feet_forward * (1.85f * distfromcamera)); //1.9f

            campostopoint = (someposleftTop - backcampos);
            campostopoint.Normalize();

            raymouse = new Ray(backcampos, campostopoint);
            //mouseintersectsscreenvec;
            mouseintersectsscreen = raymouse.Intersects(ref planer, out mouseintersectsscreenvec);

            //camposother = cameraPos;
            //camposother.Y = mouseintersectsscreenvec.Y;
            //distfromcamera = (mouseintersectsscreenvec - camposother).Length();


           // Console.WriteLine("cam:" + distfromcamera);
            ...
            */
            ...
            //NO SCREENROTATION APPROX CORRECT VALUES
            //NO SCREENROTATION APPROX CORRECT VALUES
            //NO SCREENROTATION APPROX CORRECT VALUES
            //float somevalx = 2.0f * (1.04f + 0);// 1.125f; //9.0f // 
            //float somevaly = 3.555555555555555555555555556f * (1.04f +0); //16.0f 1.7777777777777777777777777777778f // 
            ...
            *///NO SCREENROTATION APPROX CORRECT VALUES
            ...
            //Vector3 backcampos = cameraPos - (direction_feet_forward * 1000f);



            //var distancefromintersect = (mouseintersectsscreenvec - backcampos).Length();
            /*
            backcampos = cameraPos - (direction_feet_forward * distancefromintersect); //1.9f
            ...
            */
            ...
            /*Vector3 position = new Vector3(someposleftTop.X, someposleftTop.Y, someposleftTop.Z);
            ...
            */
            ...
            TestIntersection(mousex, mousey, projMatrix, out rayori, out raydir);
            //var raymouse = new Ray(positionofmouseonscreen, direction_feet_forward);
            var raymouse = new Ray(rayori, raydir);
            Vector3 mouseintersectsscreenvec;
            var mouseintersectsscreen = raymouse.Intersects(ref planer, out mouseintersectsscreenvec);
            ...
            positionOfMousereducedx /= (projMatrix.M11 * 4.0f);
            positionOfMousereducedy /= (projMatrix.M22 * 4.0f);



            //positionOfMousereducedx /= 2.0f * 3.0f;
            //positionOfMousereducedy /= 3.555555555555555555555555556f * 3.0f;


            Vector3 direction = new Vector3();
            direction.X = (positionOfMousereducedx * inverseViewMatrix.M11) + (positionOfMousereducedy * inverseViewMatrix.M21) + inverseViewMatrix.M31;
            direction.Y = (positionOfMousereducedx * inverseViewMatrix.M12) + (positionOfMousereducedy * inverseViewMatrix.M22) + inverseViewMatrix.M32;
            direction.Z = (positionOfMousereducedx * inverseViewMatrix.M23) + (positionOfMousereducedy * inverseViewMatrix.M23) + inverseViewMatrix.M33;
            //direction.Normalize();

            // Now transform the ray origin and the ray direction from view space to world space.
            var rayOrigin = Vector3.TransformCoordinate(someposleftTop, inversedWorldMatrix);
            var rayDirection = Vector3.TransformNormal(direction, inversedWorldMatrix);
            rayDirection = Vector3.Normalize(rayDirection);



            raymouse = new Ray(rayOrigin, rayDirection);
            //Vector3 mouseintersectsscreenvec;
            mouseintersectsscreen = raymouse.Intersects(ref planer, out mouseintersectsscreenvec);

            mouseintersectsscreenvec.X += positionmodel.X;
            mouseintersectsscreenvec.Y += positionmodel.Y;


            //worldMatrix_instances_screen_assets[0][0][6] = tempmat;
            worldMatrix_instances_screen_assets[0][0][6] = Matrix.Identity;
            worldMatrix_instances_screen_assets[0][0][6].M41 = (float)mouseintersectsscreenvec.X;
            //worldMatrix_instances_screen_assets[0][0][6].M42 = (float)someposleftTop.Y;
            //worldMatrix_instances_screen_assets[0][0][6].M43 = (float)pointOnScreenn.Z;
            worldMatrix_instances_screen_assets[0][0][6].M42 = (float)mouseintersectsscreenvec.Y;
            ...
            someposleftTop = cameraPos + (direction_feet_right * (positionOfMousereducedx / somevalx)); //9
            someposleftTop = someposleftTop + (direction_feet_up * (positionOfMousereducedy / somevaly)); //16
            someposleftTop = someposleftTop + (direction_feet_forward * 0.1f);
            ...
            //Vector3 directionpointbottomlefttocursor = someposleftTop -  new Vector3(worldMatrix_instances_screen_assets[0][0][8].M41, worldMatrix_instances_screen_assets[0][0][8].M42, worldMatrix_instances_screen_assets[0][0][8].M43);
            //directionpointbottomlefttocursor.Normalize();

            //var somerotvecup = sc_maths.rotatevecxaxis(directionpointbottomlefttocursor.X, directionpointbottomlefttocursor.Y, directionpointbottomlefttocursor.Z, 90);
            //somerotvecup.Normalize();
            //Vector3 crossprod;
            //Vector3.Cross(ref directionpointbottomlefttocursor, ref somerotvecup, out crossprod);

            /*var rotdir = sc_maths.makeRotationDir(directionpointbottomlefttocursor, direction_feet_forward);
            Quaternion somequ;
            Quaternion.RotationMatrix(ref rotdir, out somequ);
            //somequ.Invert();


            Matrix rotmatrix;
            Matrix.RotationQuaternion(ref somequ, out rotmatrix);

            Vector3 bottomleftcorner = new Vector3(worldMatrix_instances_screen_assets[0][0][8].M41, worldMatrix_instances_screen_assets[0][0][8].M42, worldMatrix_instances_screen_assets[0][0][8].M43);

            Matrix outmat;
            Vector3 zerovec = Vector3.Zero;
            sc_maths.AffineTransformation(1.0f,ref zerovec , ref somequ, ref bottomleftcorner, out outmat);


            //rotmatrix.M41 = worldMatrix_instances_screen_assets[0][0][8].M41;
            //rotmatrix.M42 = worldMatrix_instances_screen_assets[0][0][8].M42;
            //rotmatrix.M43 = worldMatrix_instances_screen_assets[0][0][8].M43;

            worldMatrix_instances_screen_assets[0][0][6] = outmat;*/
            //worldMatrix_instances_screen_assets[0][0][5] = Matrix.Identity;
            /*worldMatrix_instances_screen_assets[0][0][6].M41 = (float)someposleftTop.X;
            //worldMatrix_instances_screen_assets[0][0][6].M42 = (float)someposleftTop.Y;
            //worldMatrix_instances_screen_assets[0][0][6].M43 = (float)pointOnScreenn.Z;
            ...
            /*
            somevalx = 9.0f;// 1.125f; //9.0f
            somevaly = 16.0f; //16.0f 1.7777777777777777777777777777778f

            somemaxposleftbottom = cameraPos - (direction_feet_right * (-1.0f / somevalx)); //9
            somemaxposleftbottom = somemaxposleftbottom - (direction_feet_up * (-1.0f / somevaly)); //16

            //Console.WriteLine("x:" + somemaxposleftbottom.X + " y:" + somemaxposleftbottom.Y);

            worldMatrix_instances_screen_assets[0][0][13] = tempMatrix;
            worldMatrix_instances_screen_assets[0][0][13].M41 = (float)somemaxposleftbottom.X;
            worldMatrix_instances_screen_assets[0][0][13].M42 = (float)somemaxposleftbottom.Y;
            worldMatrix_instances_screen_assets[0][0][13].M43 = (float)somemaxposleftbottom.Z;

            somemaxposleftbottom = cameraPos - (direction_feet_right * (-1.0f / somevalx)); //9
            somemaxposleftbottom = somemaxposleftbottom + (direction_feet_up * (-1.0f / somevaly)); //16

            worldMatrix_instances_screen_assets[0][0][14] = tempMatrix;
            worldMatrix_instances_screen_assets[0][0][14].M41 = (float)somemaxposleftbottom.X;
            worldMatrix_instances_screen_assets[0][0][14].M42 = (float)somemaxposleftbottom.Y;
            worldMatrix_instances_screen_assets[0][0][14].M43 = (float)somemaxposleftbottom.Z;

            somemaxposleftbottom = cameraPos + (direction_feet_right * (-1.0f / somevalx)); //9
            somemaxposleftbottom = somemaxposleftbottom - (direction_feet_up * (-1.0f / somevaly)); //16

            worldMatrix_instances_screen_assets[0][0][15] = tempMatrix;
            ...
            worldMatrix_instances_screen_assets[0][0][16] = tempMatrix;
            ...
            //Console.WriteLine("M11:" + projMatrix.M11); //1.357995
            //someposleftTop = cameraPos + (direction_feet_right * (positionOfMousereducedx)); //9
            //someposleftTop = someposleftTop + (direction_feet_up * (positionOfMousereducedy)); //16
            ...
            /*
        var ddd = (vert00 - vert22).Length();
        widthLength = (vert22 - vert00).Length();
        heightLength = (vert11 - vert00).Length();
        float rrr = (someposleftTop - vert00).Length();
        var RRR = (someposleftTop - vert22).Length();
        var xcirccirccc = ((ddd * ddd) - (rrr * rrr) + (RRR * RRR)) / (2 * ddd);
        var ddd1 = xcirccirccc;
        var ddd2 = ddd - xcirccirccc;*/
            ...
            /*_screenDirMatrix_correct_pos[0][0][0] = _screenDirMatrix[0][0][0];
            _screenDirMatrix_correct_pos[0][0][1] = _screenDirMatrix[0][0][1];
            _screenDirMatrix_correct_pos[0][0][2] = _screenDirMatrix[0][0][2];
            _screenDirMatrix_correct_pos[0][0][3] = _screenDirMatrix[0][0][3];*/
            ...
            */
            ...
            worldMatrix_instances_screen_assets[0][0][13].M41 = (float)somemaxposleftbottom.X;
            worldMatrix_instances_screen_assets[0][0][13].M42 = (float)somemaxposleftbottom.Y;
            worldMatrix_instances_screen_assets[0][0][13].M43 = (float)pointOnScreenn.Z;
            ...
            worldMatrix_instances_screen_assets[0][0][14].M41 = (float)somemaxposleftbottom.X;
            worldMatrix_instances_screen_assets[0][0][14].M42 = (float)somemaxposleftbottom.Y;
            worldMatrix_instances_screen_assets[0][0][14].M43 = (float)pointOnScreenn.Z;
            ...
            worldMatrix_instances_screen_assets[0][0][15].M41 = (float)somemaxposleftbottom.X;
            worldMatrix_instances_screen_assets[0][0][15].M42 = (float)somemaxposleftbottom.Y;
            worldMatrix_instances_screen_assets[0][0][15].M43 = (float)pointOnScreenn.Z;
            ...
            worldMatrix_instances_screen_assets[0][0][16].M41 = (float)somemaxposleftbottom.X;
            worldMatrix_instances_screen_assets[0][0][16].M42 = (float)somemaxposleftbottom.Y;
            worldMatrix_instances_screen_assets[0][0][16].M43 = (float)pointOnScreenn.Z;

            */
            /*somevalx = 0.5625f; //1.125f
            somevaly = 1.0f; //2.0f

            someposleftTop = cameraPos + (direction_feet_right * (positionOfMousereducedx / somevalx)); //9
            someposleftTop = someposleftTop + (direction_feet_up * (positionOfMousereducedy / somevaly)); //16
            someposleftTop = someposleftTop + (direction_feet_forward * 1000f); //16



            ddd = (vert00 - vert22).Length();
            widthLength = (vert22 - vert00).Length();
            heightLength = (vert11 - vert00).Length();
            rrr = (someposleftTop - vert00).Length();
            RRR = (someposleftTop - vert22).Length();
            xcirccirccc = ((ddd * ddd) - (rrr * rrr) + (RRR * RRR)) / (2 * ddd);
            ddd1 = xcirccirccc;
            ddd2 = ddd - xcirccirccc;
            ...
            */
            ...
            /* //float bbb = (float)Math.Sqrt((rrr * rrr) - (ddd2 * ddd2));
             currentPosWidth = (widthLength / 2) - ddd1; // 
             //currentPosWidth = dd1; // 
             //currentPosHeight = bbb;// ((heightLength/2) - bbb);
             //currentPosHeight = bbb - (heightLength / 2);

             //Console.WriteLine("x:" + currentPosWidth + " y:" + currentPosHeight);
             var percentXRight = currentPosWidth / widthLength;
             var percentYRight = currentPosHeight / heightLength;
            */
            ...
            //Console.WriteLine("x:" + percentXRight + " y:" + percentYRight);
            //Console.WriteLine("x:" + percentXRight + " y:" + percentYRight);
            /*worldMatrix_instances_screen_assets[0][0][7] = tempMatrix;
            worldMatrix_instances_screen_assets[0][0][7].M41 = (float)currentPosWidth;
            worldMatrix_instances_screen_assets[0][0][7].M42 = (float)cameraPos.Y;
            worldMatrix_instances_screen_assets[0][0][7].M43 = pointOnScreenn.Z;
            ...
            */
            ...
            /*
            Vector3 backcampos = cameraPos - (direction_feet_forward * 1000f);
            Vector3 dirfrombackcamtopoint = someposleftTop - backcampos;
            dirfrombackcamtopoint.Normalize();

            var raymouse = new Ray(backcampos, dirfrombackcamtopoint);
            Vector3 mouseintersectsscreenvec;
            var mouseintersectsscreen = raymouse.Intersects(ref planer, out mouseintersectsscreenvec);

            worldMatrix_instances_screen_assets[0][0][17] = tempMatrix;
            //worldMatrix_instances_screen_assets[0][0][5] = Matrix.Identity;
            worldMatrix_instances_screen_assets[0][0][17].M41 = (float)mouseintersectsscreenvec.X;
            worldMatrix_instances_screen_assets[0][0][17].M42 = (float)mouseintersectsscreenvec.Y;
            worldMatrix_instances_screen_assets[0][0][17].M43 = (float)mouseintersectsscreenvec.Z;
            */
            ...
            worldMatrix_instances_screen_assets[0][0][17] = tempmat;
            //worldMatrix_instances_screen_assets[0][0][5] = Matrix.Identity;
            worldMatrix_instances_screen_assets[0][0][17].M41 = (float)mouseintersectsscreenvec.X;
            worldMatrix_instances_screen_assets[0][0][17].M42 = (float)mouseintersectsscreenvec.Y;
            worldMatrix_instances_screen_assets[0][0][17].M43 = (float)mouseintersectsscreenvec.Z;
            */
            ...
            //float adjacent = (pointOnScreenn - someposleftTop).Length();
            //float hyp = RRR;
            //float angleOfA = (float)Math.Acos(adjacent / hyp);
            //Console.WriteLine("arad:" + angleOfA + " adeg:" + sc_maths.RadianToDegree(angleOfA));
            ...
            //float sidea = (hyp * hyp) - (adjacent * adjacent);


            //Console.WriteLine(sidea);
            //Console.WriteLine("arad:" + angleresult + " adeg:" + sc_maths.RadianToDegree(angleresult));
            ...
            //worldMatrix_instances_screen_assets[0][0][6].M43 = (float)pointOnScreenn.Z;
            worldMatrix_instances_screen_assets[0][0][17].M42 = (float)mouseintersectsscreenvec.Y;
            worldMatrix_instances_screen_assets[0][0][17].M43 = (float)pointOnScreenn.Z;*/
            ...
            //float adjacent = (someposleftTop - vert00).Length();
            ...
            //var offsetx = (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInWidth * 8 * somevoxelvirtualdesktopglobals.planeSize * 1);
            //var offsety = (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight * 8 * somevoxelvirtualdesktopglobals.planeSize * 1);
            //Console.WriteLine("s0:" + ddd + " s1:" + offsetx);
            ...
            /*
            Vector3 projectedcursor = new Vector3(worldMatrix_instances_screen_assets[0][0][6].M41, worldMatrix_instances_screen_assets[0][0][6].M42, worldMatrix_instances_screen_assets[0][0][6].M43);

            Vector3 directiontocursor = projectedcursor - someposleftTop;
            directiontocursor.Normalize();
            */
            //var raymouse = new Ray(someposleftTop, directiontocursor);
            //Vector3 mouseintersectsscreenvec;
            //var mouseintersectsscreen = raymouse.Intersects(ref planer, out mouseintersectsscreenvec);


            //Vector3 somedir = cursoronscreenproj - cursoronscreen;
            //somedir.Normalize();

            /*Vector3 backcampos = cameraPos - (direction_feet_forward * 1000);

            var somerotvecup = sc_maths.rotatevecxaxis(directiontocursor.X, directiontocursor.Y, directiontocursor.Z, 90);

            Vector3 crossprod;
            Vector3.Cross(ref directiontocursor, ref somerotvecup, out crossprod);
            var rotdir = sc_maths.makeRotationDir(directiontocursor, somerotvecup);
            Quaternion somequ;
            Quaternion.RotationMatrix(ref rotdir, out somequ);
            Matrix rotmatrix;
            Matrix.RotationQuaternion(ref somequ, out rotmatrix);
            ...
            var raymouse = new Ray(backcampos, directiontocursor);
            Vector3 mouseintersectsscreenvec;
            var mouseintersectsscreen = raymouse.Intersects(ref planer, out mouseintersectsscreenvec);


            worldMatrix_instances_screen_assets[0][0][12] = rotmatrix;
            worldMatrix_instances_screen_assets[0][0][12].M41 = mouseintersectsscreenvec.X;
            worldMatrix_instances_screen_assets[0][0][12].M42 = mouseintersectsscreenvec.Y;
            worldMatrix_instances_screen_assets[0][0][12].M43 = cameraPos.Z;
            */
            //Console.WriteLine(ratioofhowsmall);
            ...
            /*Vector3 bottomrightvertprojected = new Vector3(worldMatrix_instances_screen_assets[0][0][10].M41, worldMatrix_instances_screen_assets[0][0][10].M42, worldMatrix_instances_screen_assets[0][0][10].M43);
            Vector3 projectedcursor = new Vector3(worldMatrix_instances_screen_assets[0][0][6].M41, worldMatrix_instances_screen_assets[0][0][6].M42, worldMatrix_instances_screen_assets[0][0][6].M43);

            Vector3 directiontocursor = projectedcursor - bottomrightvertprojected;

            Vector3 bottomleftvert = new Vector3(worldMatrix_instances_screen_assets[0][0][8].M41, worldMatrix_instances_screen_assets[0][0][8].M42, worldMatrix_instances_screen_assets[0][0][8].M43);
            Vector3 dirleftrightvert = bottomleftvert - bottomrightvertprojected;
            float lengthprojview = dirleftrightvert.Length();
            */
            ...
            /*Vector3 cursoronscreenproj = new Vector3(worldMatrix_instances_screen_assets[0][0][6].M41, worldMatrix_instances_screen_assets[0][0][6].M42, worldMatrix_instances_screen_assets[0][0][6].M43);
            Vector3 cursoronscreen = new Vector3(someposleftTop.X, someposleftTop.Y, someposleftTop.Z);

            Vector3 somedir = cursoronscreenproj - cursoronscreen;
            somedir.Normalize();

            var somerotvecup = sc_maths.rotatevecxaxis(somedir.X, somedir.Y, somedir.Z, 90);

            Vector3 crossprod;
            Vector3.Cross(ref somedir, ref somerotvecup, out crossprod);
            var rotdir = sc_maths.makeRotationDir(somedir, somerotvecup);
            Quaternion somequ;
            Quaternion.RotationMatrix(ref rotdir, out somequ);
            Matrix rotmatrix;
            Matrix.RotationQuaternion(ref somequ, out rotmatrix);
            ...
            //var raymouse = new Ray(somedir, someraydir);
            //Vector3 mouseintersectsscreenvec;
            //var mouseintersectsscreen = raymouse.Intersects(ref planer, out mouseintersectsscreenvec);

            worldMatrix_instances_screen_assets[0][0][12] = rotmatrix;
            worldMatrix_instances_screen_assets[0][0][12].M41 = someposleftTop.X;
            worldMatrix_instances_screen_assets[0][0][12].M42 = someposleftTop.Y;
            worldMatrix_instances_screen_assets[0][0][12].M43 = cameraPos.Z;*/

            //Console.WriteLine("x:" + mouseintersectsscreenvec.X + " y:" + mouseintersectsscreenvec.Y);


            //Console.WriteLine(lengthprojview);





            //var solvingfora = (1 / ddd) * Math.Sqrt((4 * (ddd * ddd) * (RRR * RRR)) - (((ddd * ddd) - (rrr * rrr) + (RRR * RRR)) * ((ddd * ddd) - (rrr * rrr) + (RRR * RRR))));

            //Console.WriteLine(solvingfora/2);




            /*//Console.WriteLine("M11:" + projMatrix.M11); //1.357995
            someposleftTop = cameraPos + (direction_feet_right * (positionOfMousereducedx / (float)(solvingfora / 2))); //9
            someposleftTop = someposleftTop + (direction_feet_up * (positionOfMousereducedy)); //16
            ...
            /*var ddd = (vert00 - someposleftTop).Length();
            widthLength = (vert22 - vert00).Length();
            heightLength = (vert11 - vert00).Length();
            float rrr = (someposleftTop - vert00).Length();
            var RRR = (someposleftTop - vert22).Length();
            ...
            /*var somerotvecup = sc_maths.rotatevecxaxis(someraydir.X, someraydir.Y, someraydir.Z, 90);

            Vector3 crossprod;
            Vector3.Cross(ref someraydir, ref somerotvecup, out crossprod);
            var rotdir = sc_maths.makeRotationDir(someraydir, somerotvecup);
            Quaternion somequ;
            Quaternion.RotationMatrix(ref rotdir, out somequ);
            Matrix rotmatrix;
            Matrix.RotationQuaternion(ref somequ, out rotmatrix);
            Console.WriteLine("x:" + mouseintersectsscreenvec.X + " y:" + mouseintersectsscreenvec.Y);
            worldMatrix_instances_screen_assets[0][0][7] = tempMatrix;
            worldMatrix_instances_screen_assets[0][0][7].M41 = mouseintersectsscreenvec.X;
            worldMatrix_instances_screen_assets[0][0][7].M42 = mouseintersectsscreenvec.Y;
            worldMatrix_instances_screen_assets[0][0][7].M43 = pointOnScreenn.Z;*/
            ...
            //Matrix inverseViewMatrix = Matrix.Invert(camViewMatrix);
            //Vector3 someposinverse = new Vector3(inverseViewMatrix.M41, inverseViewMatrix.M42, inverseViewMatrix.M43);
            //Console.WriteLine("x:" + cameraPos.X + " y:" + cameraPos.Y);

            /*worldMatrix_instances_screen_assets[0][0][7] = tempMatrix;
            worldMatrix_instances_screen_assets[0][0][7].M41 = someposleftTop.X;
            worldMatrix_instances_screen_assets[0][0][7].M42 = someposleftTop.Y;
            worldMatrix_instances_screen_assets[0][0][7].M43 = pointOnScreenn.Z * (-direction_feet_forward.Z * 1.5f);
            */


            /*
            Vector3 someposinfront = someposleftTop - (direction_feet_forward * (1));
            //var somedist = (someposinfront - cameraPos).Length();
            Vector3 dirtopointinfront = someposinfront - someposleftTop;
            dirtopointinfront.Normalize();



            var raymouse = new Ray(cameraPos, dirtopointinfront);
            Vector3 mouseintersectsscreenvec;
            var mouseintersectsscreen = raymouse.Intersects(ref planer, out mouseintersectsscreenvec);
            ...
            //Console.WriteLine("m11:" + projMatrix.M11 + " m22:" + projMatrix.M22);

            //positionOfMousereducedx /= projMatrix.M11;
            //positionOfMousereducedy /= projMatrix.M22;

            //positionOfMousereducedx /= (9 / 6);
            //positionOfMousereducedy /= (16 / 6);
            ...
            // Now transform the ray origin and the ray direction from view space to world space.
            var rayOrigin = Vector3.TransformCoordinate(origin, inversedWorldMatrix);
            var rayDirection = Vector3.TransformNormal(direction, inversedWorldMatrix);

            // Normalize the ray direction.
            rayDirection = Vector3.Normalize(rayDirection);
            //Vector3 backcampos = cameraPos - (direction_feet_forward * 1);
            

            var raymouse = new Ray(origin, direction);
            Vector3 mouseintersectsscreenvec;
            var mouseintersectsscreen = raymouse.Intersects(ref planer, out mouseintersectsscreenvec);
            ...
            worldMatrix_instances_screen_assets[0][0][7].M41 = mouseintersectsscreenvec.X;
            worldMatrix_instances_screen_assets[0][0][7].M42 = mouseintersectsscreenvec.Y;
            worldMatrix_instances_screen_assets[0][0][7].M43 = cameraPos.Z;
            */

            /*
            Vector3 backcampos = cameraPos - (direction_feet_forward * 1);
            Vector3 someraydir = someposleftTop - cameraPos;
            someraydir.Normalize();

            var raymouse = new Ray(backcampos, someraydir);
            Vector3 mouseintersectsscreenvec;
            var mouseintersectsscreen = raymouse.Intersects(ref planer, out mouseintersectsscreenvec);

            /*someposleftTop = cameraPos + (direction_feet_right * (positionOfMousereducedx)/9); //9
            someposleftTop = someposleftTop + (direction_feet_up * (positionOfMousereducedy)/16); //16
            ...
            someraydir.Normalize();
            Vector3 crossprod;
            Vector3.Cross(ref someraydir, ref Vector3.Up, out crossprod);
            var rotdir = sc_maths.makeRotationDir(someraydir, direction_feet_up);
            Quaternion somequ;
            Quaternion.RotationMatrix(ref rotdir, out somequ);
            Matrix rotmatrix;
            Matrix.RotationQuaternion(ref somequ, out rotmatrix);
            ...
            Vector3 mouseintersectsscreenvec;
            var mouseintersectsscreen = raymouse.Intersects(ref planer, out mouseintersectsscreenvec);
            worldMatrix_instances_screen_assets[0][0][7] = rotmatrix;
            worldMatrix_instances_screen_assets[0][0][7].M41 = mouseintersectsscreenvec.X;
            worldMatrix_instances_screen_assets[0][0][7].M42 = mouseintersectsscreenvec.Y;
            worldMatrix_instances_screen_assets[0][0][7].M43 = pointOnScreenn.Z;
            */
            ...
            heightLength = (vert11 - vert00).Length();
            float rrr = (someposleftTop - vert00).Length();
            var RRR = (someposleftTop - vert11).Length();
            var xcirccirccc = ((ddd * ddd) - (rrr * rrr) + (RRR * RRR)) / (2 * ddd);
            var ddd1 = xcirccirccc;
            var ddd2 = ddd - xcirccirccc;
            //r is with d2
            ...
            currentPosWidth = (widthLength / 2) - ddd1; // 
            //currentPosWidth = dd1; // 
            currentPosHeight = ((heightLength/2) - bbb);
            //currentPosHeight = bbb;

            //Console.WriteLine("x:" + rrr + " y:" + RRR);

            //var someposx = (((float)currentPosWidth * (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInWidth * 8 * somevoxelvirtualdesktopglobals.planeSize * 1)) / (1920));
            //var someposy = (((float)currentPosHeight * (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight * 8 * somevoxelvirtualdesktopglobals.planeSize * 1)) / (1080));

            //Console.WriteLine("x:" + someposx + " y:" + someposy);
            Console.WriteLine("x:" + Math.Abs(currentPosWidth) + " y:" + Math.Abs(currentPosHeight));

            worldMatrix_instances_screen_assets[0][0][7] = tempmat;
            worldMatrix_instances_screen_assets[0][0][7].M41 = (float)Math.Abs(currentPosWidth);
            worldMatrix_instances_screen_assets[0][0][7].M42 = (float)Math.Abs(currentPosHeight);
            worldMatrix_instances_screen_assets[0][0][7].M43 = pointOnScreenn.Z;
            */
            ...
            var raymouse = new Ray(rayOrigin, rayDirection);
            Vector3 mouseintersectsscreenvec;
            var mouseintersectsscreen = raymouse.Intersects(ref planer, out mouseintersectsscreenvec);
            ...
            worldMatrix_instances_screen_assets[0][0][7] = tempmat;
            worldMatrix_instances_screen_assets[0][0][7].M41 = (float)mouseintersectsscreenvec.X;
            worldMatrix_instances_screen_assets[0][0][7].M42 = (float)mouseintersectsscreenvec.Y;
            worldMatrix_instances_screen_assets[0][0][7].M43 = pointOnScreenn.Z;
            ...
            */
            ...
            Vector3 someposleftbottom = cameraPos - (direction_feet_right * (1 / 16));
            someposleftbottom = someposleftbottom - (direction_feet_up * (1 / 9));

            Vector3 someraydir = someposleftTop - someposleftbottom;
            someraydir.Normalize();

            Vector3 crossprod;
            Vector3.Cross(ref someraydir, ref , out crossprod);
            ...
            worldMatrix_instances_screen_assets[0][0][2] = rotmatrix;
            worldMatrix_instances_screen_assets[0][0][2].M41 = mouseintersectsscreenvec.X;
            worldMatrix_instances_screen_assets[0][0][2].M42 = mouseintersectsscreenvec.Y;
            worldMatrix_instances_screen_assets[0][0][2].M43 = pointOnScreenn.Z;*/





            //var ppositionOfMousereducedx = ((mousex * (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInWidth * 8 * somevoxelvirtualdesktopglobals.planeSize * sofscrpersp)) / (1920));
            //var ppositionOfMousereducedy = ((mousey * (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight * 8 * somevoxelvirtualdesktopglobals.planeSize * sofscrpersp)) / (1080));
            //ppositionOfMousereducedy = (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight * 8 * somevoxelvirtualdesktopglobals.planeSize * sofscrpersp) - ppositionOfMousereducedy;
            ...
            worldMatrix_instances_screen_assets[0][0][2] = tempMatrix;
            worldMatrix_instances_screen_assets[0][0][2].M41 = mouseintersectsscreenvec.X;
            worldMatrix_instances_screen_assets[0][0][2].M42 = mouseintersectsscreenvec.Y;
            worldMatrix_instances_screen_assets[0][0][2].M43 = pointOnScreenn.Z;*/
            ...
            //Vector3 someposinfront = someposleftTop + (direction_feet_forward * (0.15f));
            ...
            //cameraPos = cameraPos - (direction_feet_forward * distfromscreen);
            //Vector3 dirfrontcam = someposinfront - cameraPos;
            //dirfrontcam.Normalize();


            //Console.WriteLine(somedist); //4.33
            ...
            cameraPos = cameraPos - (direction_feet_forward * 4.333333f); //4.33333f

            Vector3 dirtomouseinfront = someposleftbottom - cameraPos;
            dirtomouseinfront.Normalize();

            var raymouse = new Ray(cameraPos, dirtomouseinfront);
            Vector3 mouseintersectsscreenvec;
            var mouseintersectsscreen = raymouse.Intersects(ref planer, out mouseintersectsscreenvec);
            ...
            /*
            worldMatrix_instances_screen_assets[0][0][2] = tempmat;
            worldMatrix_instances_screen_assets[0][0][2].M41 = someposleftbottom.X;
            worldMatrix_instances_screen_assets[0][0][2].M42 = someposleftbottom.Y;
            worldMatrix_instances_screen_assets[0][0][2].M43 = someposleftbottom.Z;

            Vector3 dirtomouseinfront = someposinfront - someposleftbottom;
            dirtomouseinfront.Normalize();

            var raymouse = new Ray(someposleftbottom, dirtomouseinfront);
            Vector3 mouseintersectsscreenvec;
            var mouseintersectsscreen = raymouse.Intersects(ref planer, out mouseintersectsscreenvec);

            worldMatrix_instances_screen_assets[0][0][1] = tempMatrix;
            //worldMatrix_instances_screen_assets[0][0][5] = Matrix.Identity;
            worldMatrix_instances_screen_assets[0][0][1].M41 = (float)mouseintersectsscreenvec.X;
            worldMatrix_instances_screen_assets[0][0][1].M42 = (float)mouseintersectsscreenvec.Y;
            worldMatrix_instances_screen_assets[0][0][1].M43 = (float)pointOnScreenn.Z;
            */
            ...
            // Calculate the direction of the picking ray in view space.
            Vector3 direction = new Vector3();
            direction.X = (someposleftTop.X * inverseViewMatrix.M11) + (someposleftTop.Y * inverseViewMatrix.M21) + inverseViewMatrix.M31;
            direction.Y = (someposleftTop.X * inverseViewMatrix.M12) + (someposleftTop.Y * inverseViewMatrix.M22) + inverseViewMatrix.M32;
            direction.Z = (someposleftTop.X * inverseViewMatrix.M23) + (someposleftTop.Y * inverseViewMatrix.M23) + inverseViewMatrix.M33;
            ...
            /*
            Vector3 pointinfrontof = someposleftTop + (rayDirection);
            Vector3 raydir = pointinfrontof - cameraPos ;
            raydir.Normalize();
            
            //var raymouse = new Ray(positionofmouseonscreen, direction_feet_forward);
            var raymouse = new Ray(someposleftTop, rayDirection);
            Vector3 mouseintersectsscreenvec;
            var mouseintersectsscreen = raymouse.Intersects(ref planer, out mouseintersectsscreenvec);


            var rotdir = sc_maths.makeRotationDir(rayDirection, Vector3.Up);
            ...
            */
            ...
            /*
            worldMatrix_instances_screen_assets[0][0][5] = Matrix.Identity;
            worldMatrix_instances_screen_assets[0][0][5].M41 = (float)mouseintersectsscreenvec.X;
            worldMatrix_instances_screen_assets[0][0][5].M42 = (float)mouseintersectsscreenvec.Y;
            worldMatrix_instances_screen_assets[0][0][5].M43 = (float)mouseintersectsscreenvec.Z;
            */
            ...
            /*
            Vector3 someposleftTop = cameraPos - (direction_feet_right * (1 / 16));
            someposleftTop = someposleftTop - (direction_feet_up * (1 / 9));

            worldMatrix_instances_screen_assets[0][0][1] = tempmat;
            worldMatrix_instances_screen_assets[0][0][1].M41 = someposleftTop.X;
            worldMatrix_instances_screen_assets[0][0][1].M42 = someposleftTop.Y;
            worldMatrix_instances_screen_assets[0][0][1].M43 = someposleftTop.Z;

            someposleftTop = cameraPos - (direction_feet_right * (1 / 16));
            someposleftTop = someposleftTop + (direction_feet_up * (1 / 9));

            worldMatrix_instances_screen_assets[0][0][2] = tempmat;
            worldMatrix_instances_screen_assets[0][0][2].M41 = someposleftTop.X;
            worldMatrix_instances_screen_assets[0][0][2].M42 = someposleftTop.Y;
            worldMatrix_instances_screen_assets[0][0][2].M43 = someposleftTop.Z;

            someposleftTop = cameraPos + (direction_feet_right * (1 / 16));
            someposleftTop = someposleftTop - (direction_feet_up * (1 / 9));

            worldMatrix_instances_screen_assets[0][0][3] = tempmat;
            worldMatrix_instances_screen_assets[0][0][3].M41 = someposleftTop.X;
            worldMatrix_instances_screen_assets[0][0][3].M42 = someposleftTop.Y;
            worldMatrix_instances_screen_assets[0][0][3].M43 = someposleftTop.Z;

            someposleftTop = cameraPos + (direction_feet_right * (1 / 16));
            someposleftTop = someposleftTop + (direction_feet_up * (1 / 9));

            worldMatrix_instances_screen_assets[0][0][4] = tempmat;
            worldMatrix_instances_screen_assets[0][0][4].M41 = someposleftTop.X;
            worldMatrix_instances_screen_assets[0][0][4].M42 = someposleftTop.Y;
            worldMatrix_instances_screen_assets[0][0][4].M43 = someposleftTop.Z;*/
            ...
            /*
            float pointX = ((0.96f * (float)mousex) / (float)sccs.scgraphics.scdirectx.D3D.SurfaceWidth) - 0.48f;
            float pointY = (((1.0f * (float)mousey) / (float)sccs.scgraphics.scdirectx.D3D.SurfaceHeight) - 0.5f) * -0.5f;

            //Console.WriteLine("x:" + pointX + " y:" + pointY);

            worldMatrix_instances_screen_assets[0][0][5] = Matrix.Identity;
            worldMatrix_instances_screen_assets[0][0][5].M41 = (float)pointX;
            worldMatrix_instances_screen_assets[0][0][5].M42 = (float)pointY;
            worldMatrix_instances_screen_assets[0][0][5].M43 = (float)cameraPos.Z;*/
            ...
            positionOfMousereducedx /= 1;
            positionOfMousereducedy /= 1;

            var offsetx = ((1920 / 2) * (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInWidth * 8 * somevoxelvirtualdesktopglobals.planeSize * sofscrpersp)) / (1920);
            var offsety = ((1080 / 2) * (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight * 8 * somevoxelvirtualdesktopglobals.planeSize * sofscrpersp)) / (1080);

            offsetx /= 1;
            offsety /= 1;

            Vector3 cameraPosOnScreenLeftx = cameraPos - (direction_feet_right * (1 * offsetx));
            cameraPosOnScreenLeftx = cameraPosOnScreenLeftx - (direction_feet_up * (1 * offsety));
            cameraPosOnScreenLeftx = cameraPosOnScreenLeftx + (direction_feet_right * (positionOfMousereducedx));
            cameraPosOnScreenLeftx = cameraPosOnScreenLeftx + (direction_feet_up * (positionOfMousereducedy));
            //cameraPosOnScreenLeftx.Z = cameraPos.Z;
            raycam = new Ray(cameraPosOnScreenLeftx, directionoriginscreenf);
            //Vector3 camintersectsscreenvec;
            ...
            //worldMatrix_instances_screen_assets[0][0][5] = somevoxelvirtualdesktop[0].currentWorldMatrix;
            worldMatrix_instances_screen_assets[0][0][5] = Matrix.Identity;
            worldMatrix_instances_screen_assets[0][0][5].M41 = (float)camintersectsscreenvec.X;
            worldMatrix_instances_screen_assets[0][0][5].M42 = (float)camintersectsscreenvec.Y;
            worldMatrix_instances_screen_assets[0][0][5].M43 = (float)camintersectsscreenvec.Z;
            */
            /*
            var offsetx = ((1920 / 2) * (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInWidth * 8 * somevoxelvirtualdesktopglobals.planeSize * sofscrpersp)) / (1920);
            var offsety = ((1080 / 2) * (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight * 8 * somevoxelvirtualdesktopglobals.planeSize * sofscrpersp)) / (1080);
            ...
            //worldMatrix_instances_screen_assets[0][0][5] = somevoxelvirtualdesktop[0].currentWorldMatrix;
            worldMatrix_instances_screen_assets[0][0][5] = Matrix.Identity;
            worldMatrix_instances_screen_assets[0][0][5].M41 = (float)cameraPosOnScreenLeftx.X;
            worldMatrix_instances_screen_assets[0][0][5].M42 = (float)cameraPosOnScreenLeftx.Y;
            worldMatrix_instances_screen_assets[0][0][5].M43 = (float)cameraPosOnScreenLeftx.Z;
            */
            //var thed = (positionOfScreen - pointerofcamonscreen).Length();
            //var theR = (vert00 - )
            //var ther = posoffsety;
            ...
            /*
            var positionOfMousereducedx = ((1.0f * (float)mousex) / (float)sccs.scgraphics.scdirectx.D3D.SurfaceWidth) - 1.0f;
            var positionOfMousereducedy = (((1.0f * (float)mousey) / (float)sccs.scgraphics.scdirectx.D3D.SurfaceHeight) - 1.0f) * -1.0f;
            */

            //var positionOfMousereducedx = mousex / (float)sccs.scgraphics.scdirectx.D3D.SurfaceWidth;
            //var positionOfMousereducedy = mousey / (float)sccs.scgraphics.scdirectx.D3D.SurfaceHeight;

            /*var positionOfMousereducedx = ((mousex * (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInWidth * 8 * somevoxelvirtualdesktopglobals.planeSize)) / (1920));
            var positionOfMousereducedy = ((mousey * (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight * 8 * somevoxelvirtualdesktopglobals.planeSize)) / (1080));
            positionOfMousereducedy = (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight * 8 * somevoxelvirtualdesktopglobals.planeSize) - positionOfMousereducedy;
            
            var offsetx = ((1920 / 2) * (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInWidth * 8 * somevoxelvirtualdesktopglobals.planeSize)) / (1920);
            var offsety = ((1080 / 2) * (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight * 8 * somevoxelvirtualdesktopglobals.planeSize)) / (1080);
            */
            ...
            Vector3 cameraPosOnScreenLeftx = cameraPos - (direction_feet_right * (1 * 0.5f * 0.5f * 0.96f));
            cameraPosOnScreenLeftx = cameraPosOnScreenLeftx - (direction_feet_up * (1 * 0.5f * 0.5f * 0.54f));
            cameraPosOnScreenLeftx = cameraPosOnScreenLeftx + (direction_feet_right * (positionOfMousereducedx * 0.5f * 0.96f));
            cameraPosOnScreenLeftx = cameraPosOnScreenLeftx + (direction_feet_up * (positionOfMousereducedy * 0.5f * 0.54f));
            //cameraPosOnScreenLeftx.Z = cameraPos.Z;
            raycam = new Ray(cameraPosOnScreenLeftx, directionoriginscreenf);
            //Vector3 camintersectsscreenvec;
            camintersectsscreen = raycam.Intersects(ref planer, out camintersectsscreenvec);
            ...
            //Console.WriteLine("x: " + positionOfMousereducedx + " y: " + positionOfMousereducedy);
            ...
            raycam = new Ray(cameraPos, direction);
            //Vector3 camintersectsscreenvec;
            camintersectsscreen = raycam.Intersects(ref planer, out camintersectsscreenvec);
            //Vector3 offsetmouseposz = camintersectsscreenvec;*/
            ...
            //Vector3 cameraPosOnScreenLeftx = cameraPos - (direction_feet_right * ((somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInWidth * 8 * somevoxelvirtualdesktopglobals.planeSize) * 0.5f));
            //cameraPosOnScreenLeftx = cameraPosOnScreenLeftx - (direction_feet_up * ((somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight * 8 * somevoxelvirtualdesktopglobals.planeSize) * 0.5f));
            //Vector3 cameraPosOnScreenLeftx = cameraPos + (direction_feet_right * pointX);
            //cameraPosOnScreenLeftx = cameraPosOnScreenLeftx + (direction_feet_up * (pointY));
            ...
            //positionOfMousereducedx = mousex / (float)sccs.scgraphics.scdirectx.D3D.SurfaceWidth;
            //positionOfMousereducedy = mousey / (float)sccs.scgraphics.scdirectx.D3D.SurfaceHeight;
            ...
            //Vector3 cameraPosOnScreenLeftx = cameraPos - (direction_feet_right * 1 );
            //cameraPosOnScreenLeftx = cameraPosOnScreenLeftx - (direction_feet_up * 1 );

            /*Vector3 cameraPosOnScreenLeftx = cameraPos + (direction_feet_right * (positionOfMousereducedx*0.5f));
            cameraPosOnScreenLeftx = cameraPosOnScreenLeftx + (direction_feet_up * (positionOfMousereducedy * 0.5f));


            raycam = new Ray(cameraPosOnScreenLeftx, direction_feet_forward);
            //Vector3 camintersectsscreenvec;
            camintersectsscreen = raycam.Intersects(ref planer, out camintersectsscreenvec);
            //Vector3 offsetmouseposz = camintersectsscreenvec;
            ...
            raycam = new Ray(origin, direction);
            camintersectsscreen = raycam.Intersects(ref planer, out camintersectsscreenvec);


            Vector3 cameraPosOnScreenLeftx = origin - (directionoriginscreenr * 1 * 0.5f);
            cameraPosOnScreenLeftx = cameraPosOnScreenLeftx - (directionoriginscreenu * 1 * 0.5f);

            cameraPosOnScreenLeftx = cameraPosOnScreenLeftx + (directionoriginscreenr * positionOfMousereducedx);
            cameraPosOnScreenLeftx = cameraPosOnScreenLeftx + (directionoriginscreenu * positionOfMousereducedy);
            ...
            //positionOfMousereducedx = positionOfMousereducedx;
            //positionOfMousereducedy = positionOfMousereducedy;
            ...
            */
            ...
            //worldMatrix_instances_screen_assets[0][0][5] = somevoxelvirtualdesktop[0].currentWorldMatrix;
            /*worldMatrix_instances_screen_assets[0][0][5] = tempmat;
            worldMatrix_instances_screen_assets[0][0][5].M41 = (float)cameraPosOnScreenLeftx.X;
            worldMatrix_instances_screen_assets[0][0][5].M42 = (float)cameraPosOnScreenLeftx.Y;
            worldMatrix_instances_screen_assets[0][0][5].M43 = (float)cameraPosOnScreenLeftx.Z;
            */
            ...
            */
            ...
            widthLength = (vert22 - vert00).Length();
            heightLength = (vert11 - vert00).Length();
            float rrr = (cameraPosOnScreenLeftx - vert00).Length();
            var RRR = (cameraPosOnScreenLeftx - vert22).Length();
            var xcirccirccc = ((ddd * ddd) - (rrr * rrr) + (RRR * RRR)) / (2 * ddd);
            var ddd1 = xcirccirccc;
            var ddd2 = ddd - xcirccirccc;
            ...
            //currentPosWidth = dd1; // 
            //currentPosHeight = ((heightLength/2) - bb);
            currentPosHeight = bbb - (heightLength);

            Vector3 originmouse = cameraPosOnScreenLeftx;

            Vector3 somevec = new Vector3((float)currentPosWidth, (float)currentPosHeight, originmouse.Z);




            raycam = new Ray(somevec, direction_feet_forward);
            //Vector3 camintersectsscreenvec;
            camintersectsscreen = raycam.Intersects(ref planer, out camintersectsscreenvec);
            //Vector3 offsetmouseposz = camintersectsscreenvec;
            ...
            */
            /*
            worldMatrix_instances_screen_assets[0][0][5] = somevoxelvirtualdesktop[0].currentWorldMatrix;
            worldMatrix_instances_screen_assets[0][0][5].M41 = (float)currentPosWidth;
            worldMatrix_instances_screen_assets[0][0][5].M42 = (float)currentPosHeight;
            worldMatrix_instances_screen_assets[0][0][5].M43 = (float)camintersectsscreenvec.Z;
            */
            ...
            */
            ...
            direction.Z = (positionOfMousereducedx * inverseViewMatrix.M23) + (positionOfMousereducedy * inverseViewMatrix.M23) + inverseViewMatrix.M33;
            */
            /*Vector3 cameraPosOnScreenLeftx = Vector3.Zero;

            float somevalx = positionOfMousereducedx;
            float somevaly = positionOfMousereducedy;
            float someoffset = 0;

            //cameraPosOnScreenLeftx = cameraPos + (direction_feet_right * positionOfMousereducedx);
            var offsetx = ((1920 / 2) * (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInWidth * 8 * somevoxelvirtualdesktopglobals.planeSize)) / (1920);
            var offsety = ((1080 / 2) * (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight * 8 * somevoxelvirtualdesktopglobals.planeSize)) / (1080);

            if (somevalx >= offsetx)
            {
                positionOfMousereducedx = positionOfMousereducedx - offsetx;
                cameraPosOnScreenLeftx = cameraPosOnScreenLeftx + (directionoriginscreenr * positionOfMousereducedx);

                //Console.WriteLine("x: " + positionOfMousereducedx + " y: " + positionOfMousereducedy);
                cameraPosOnScreenLeftx = cameraPosOnScreenLeftx + (directionoriginscreenu * positionOfMousereducedy);

                if (positionOfMousereducedy <= offsety)
                { 



                    //positionOfMousereducedy = positionOfMousereducedy - offsety;
                    //cameraPosOnScreenLeftx = cameraPosOnScreenLeftx - (directionoriginscreenu * ((somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight * 8 * somevoxelvirtualdesktopglobals.planeSize) * 0.5f));
                    //cameraPosOnScreenLeftx = cameraPosOnScreenLeftx + (directionoriginscreenu *  (-offsety + positionOfMousereducedy));
                    //positionOfMousereducedy = ((somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight * 8 * somevoxelvirtualdesktopglobals.planeSize) - positionOfMousereducedy);
            ...
            else
            {
                ...
                {
                    cameraPosOnScreenLeftx = cameraPos - (direction_feet_right * ((somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInWidth * 8 * somevoxelvirtualdesktopglobals.planeSize) * 0.5f));
                    cameraPosOnScreenLeftx = cameraPosOnScreenLeftx - (direction_feet_up * ((somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight * 8 * somevoxelvirtualdesktopglobals.planeSize) * 0.5f));
                    cameraPosOnScreenLeftx = cameraPosOnScreenLeftx + (direction_feet_right * positionOfMousereducedx);
                    cameraPosOnScreenLeftx = cameraPosOnScreenLeftx + (direction_feet_up * positionOfMousereducedy);
                }
            ...
            float bbb = (float)Math.Sqrt((rrr * rrr) - (ddd2 * ddd2));
            currentPosWidth = (widthLength) - ddd1; // 
            //currentPosWidth = dd1; // 
            //currentPosHeight = ((heightLength/2) - bb);
            currentPosHeight = bbb - (heightLength);
            ...
            //cameraPosOnScreenLeftx = cameraPosOnScreenLeftx + (direction_feet_forward * 0.5f);
            worldMatrix_instances_screen_assets[0][0][5] = somevoxelvirtualdesktop[0].currentWorldMatrix;
            worldMatrix_instances_screen_assets[0][0][5].M41 = (float)currentPosWidth;
            worldMatrix_instances_screen_assets[0][0][5].M42 = (float)currentPosHeight;
            worldMatrix_instances_screen_assets[0][0][5].M43 = (float)cameraPosOnScreenLeftx.Z;*/
            ...
            /*
            worldMatrix_instances_screen_assets[0][0][0] = somevoxelvirtualdesktop[0].currentWorldMatrix;
            worldMatrix_instances_screen_assets[0][0][0].M41 = pointOnScreenn.X;
            worldMatrix_instances_screen_assets[0][0][0].M42 = pointOnScreenn.Y;
            worldMatrix_instances_screen_assets[0][0][0].M43 = pointOnScreenn.Z;
            ...
            //Console.WriteLine("x: " + cameraPosOnScreenLeftx.X + " y: " + cameraPosOnScreenLeftx.Y + " z: " + cameraPosOnScreenLeftx.Z + " zpos " + pointOnScreenn);
            //Console.WriteLine("x: " + positionOfMousereducedx + " y: " + positionOfMousereducedy + " zpos " + pointOnScreenn);





            //pointerofcamonscreen.Z = cameraPos.Z;
            //var cameraPosOnScreenLeftx = cameraPos - (direction_feet_right * (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInWidth * 8 * somevoxelvirtualdesktopglobals.planeSize) * 0.5f);
            //cameraPosOnScreenLeftx = cameraPosOnScreenLeftx - (direction_feet_up * (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight * 8 * somevoxelvirtualdesktopglobals.planeSize) * 0.5f);



            //var mousecampos = cameraPosOnScreenLeftx + (direction_feet_right * positionOfMousereducedx);
            //mousecampos = mousecampos + (direction_feet_up * positionOfMousereducedy);
            //mousecampos = mousecampos + (direction_feet_forward * positionOfMousereducedy);


            /*
            dd = (vert22 - vert00).Length();
            widthLength = (vert22 - vert00).Length();
            heightLength = (vert11 - vert00).Length();
            rr = (mousecampos - vert00).Length();
            RR = (mousecampos - vert22).Length();
            xcirccircc = ((dd * dd) - (rr * rr) + (RR * RR)) / (2 * dd);
            dd1 = xcirccircc;
            dd2 = dd - xcirccircc;

            bb = (float)Math.Sqrt((rr * rr) - (dd2 * dd2));
            currentPosWidth = (widthLength / 2) - dd1; // 
            //currentPosWidth = dd1; // 
            //currentPosHeight = ((heightLength/2) - bb);
            currentPosHeight = bb - (heightLength / 2);
            ...
            //mousecampos.Y = pointOnScreenn.Y;
            //mousecampos.Z = pointOnScreenn.Z;

            /*var mousecampos = cameraPosOnScreenLeftx + (direction_feet_right * positionOfMousereducedx);
            mousecampos = mousecampos + (direction_feet_up * positionOfMousereducedy);
            mousecampos = mousecampos + (direction_feet_forward * diffz);*/



            // raycam = new Ray(mousecampos, direction_feet_forward);
            //Vector3 camintersectsscreenvec;
            // camintersectsscreen = raycam.Intersects(ref planer, out camintersectsscreenvec);
            //Vector3 offsetmouseposz = camintersectsscreenvec;
            ...
            //pointOnScreenn = new Vector3(camintersectsscreenvec.X, camintersectsscreenvec.Y, camintersectsscreenvec.Z);


            /*dd = (vert22 - vert00).Length();
            widthLength = (vert22 - vert00).Length();
            heightLength = (vert11 - vert00).Length();
            rr = (pointOnScreenn - vert00).Length();
            RR = (pointOnScreenn - vert22).Length();
            xcirccircc = ((dd * dd) - (rr * rr) + (RR * RR)) / (2 * dd);
            dd1 = xcirccircc;
            dd2 = dd - xcirccircc;
            ...
            /*
            float diffz = pointerofcamonscreen.Z - cameraPos.Z;
            ...
            pointerofcamonscreen.Z = cameraPos.Z;
            var cameraPosOnScreenLeftx = pointerofcamonscreen - (direction_feet_right * (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInWidth * 8 * somevoxelvirtualdesktopglobals.planeSize) * 0.5f);
            cameraPosOnScreenLeftx = cameraPosOnScreenLeftx - (direction_feet_up * (somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight * 8 * somevoxelvirtualdesktopglobals.planeSize) * 0.5f);
            ...
            float rrr = (mousecampos - vert00).Length();
            var RRR = (mousecampos - vert22).Length();
            var xcirccirccc = ((dd * dd) - (rrr * rrr) + (RRR * RRR)) / (2 * dd);
            var ddd1 = xcirccirccc;
            var ddd2 = dd - xcirccirccc;

            float bbb = (float)Math.Sqrt((rrr * rrr) - (ddd2 * ddd2));
            var currentPosWidthm = ddd1; // 
            //currentPosWidth = dd1; // 
            //currentPosHeight = ((heightLength/2) - bb);
            //var currentPosHeightm = bbb;


            worldMatrix_instances_screen_assets[0][0][5] = somevoxelvirtualdesktop[0].currentWorldMatrix;
            worldMatrix_instances_screen_assets[0][0][5].M41 = (float)currentPosWidthm;*/
            //worldMatrix_instances_screen_assets[0][0][5].M42 = (float)currentPosHeightm;
            //worldMatrix_instances_screen_assets[0][0][5].M43 = (float)mousecampos.Z;


            /*worldMatrix_instances_screen_assets[0][0][5] = somevoxelvirtualdesktop[0].currentWorldMatrix;
            worldMatrix_instances_screen_assets[0][0][5].M41 = (float)mousecampos.X;
            worldMatrix_instances_screen_assets[0][0][5].M42 = (float)mousecampos.Y;
            worldMatrix_instances_screen_assets[0][0][5].M43 = (float)mousecampos.Z;
            */


            //mousecampos.Z = cameraPos.Z;
            //mousecampos = mousecampos + (direction_feet_up * positionOfMousereducedy);
            //mousecampos.Z = cameraPos.Z;

            //var offsetofmousexfromscreenleftx = cameraPosOnScreenLeftx.X + positionOfMousereducedx;
            //Vector3 positionofmouseonscreen = cameraPosOnScreenLeftx;
            //positionofmouseonscreen.X = offsetofmousexfromscreenleftx;

            /*var raymouse = new Ray(mousecampos, direction_feet_forward);
            Vector3 mouseintersectsscreenvec;
            var mouseintersectsscreen = raymouse.Intersects(ref planer, out mouseintersectsscreenvec);


            var diffx = (mouseintersectsscreenvec.X - mousecampos.X) + positionOfMousereducedx;


            mouseintersectsscreenvec.X = diffx;
            */
            /*
            Vector3 rayori;
            Vector3 raydir;
            ...
            */
            ...
            /*Matrix camrotmat = sccs.scgraphics.scupdate.Camera.rotationMatrix;
            centerPosRight = new Vector3(mousecampos.X, mousecampos.Y, mousecampos.Z);

            //camrotmat.M41 = mousecampos.X;
            Quaternion.RotationMatrix(ref camrotmat, out _rightTouchQuat);
            rayDirRighter = sc_maths._getDirection(Vector3.ForwardRH, _rightTouchQuat);
            ...
            */
            ...
            //Vector3 someVirtualPointOnScreenX = (cameraPos ) + (direction_feet_right * ((somepoint.X * (240 * 8 * 0.005f)) / (1920)));
            //Vector3 someVirtualPointOnScreenY = cameraPos + (direction_feet_up * ((somepoint.Y * (135 * 8 * 0.005f)) / (1080)));
            ...
            currentScreenPos -= newDirUp;
            Matrix resulter0 = tempMatrix;
            resulter0.M41 = _screenDirMatrix[0][0][0].M41;// currentScreenPos.X;
            resulter0.M42 = _screenDirMatrix[0][0][0].M42;// currentScreenPos.Y;
            resulter0.M43 = _screenDirMatrix[0][0][0].M43;// currentScreenPos.Z;
            _screenDirMatrix_correct_pos[0][0][0] = resulter0;
            ...
            currentScreenPos += newDirUp;
            resulter0 = tempMatrix;
            resulter0.M41 = _screenDirMatrix[0][0][1].M41;// currentScreenPos.X;
            resulter0.M42 = _screenDirMatrix[0][0][1].M42;// currentScreenPos.Y;
            resulter0.M43 = _screenDirMatrix[0][0][1].M43;// currentScreenPos.Z;
            _screenDirMatrix_correct_pos[0][0][1] = resulter0;
            ...
            currentScreenPos -= newDirUp;
            resulter0 = tempMatrix;
            resulter0.M41 = _screenDirMatrix[0][0][2].M41;// currentScreenPos.X;
            resulter0.M42 = _screenDirMatrix[0][0][2].M42;// currentScreenPos.Y;
            resulter0.M43 = _screenDirMatrix[0][0][2].M43;// currentScreenPos.Z;
            _screenDirMatrix_correct_pos[0][0][2] = resulter0;
            ...
            currentScreenPos += newDirUp;
            resulter0 = tempMatrix;
            resulter0.M41 = _screenDirMatrix[0][0][3].M41;// currentScreenPos.X;
            resulter0.M42 = _screenDirMatrix[0][0][3].M42;// currentScreenPos.Y;
            resulter0.M43 = _screenDirMatrix[0][0][3].M43;// currentScreenPos.Z;
            _screenDirMatrix_correct_pos[0][0][3] = resulter0;
            */


            //mousecampos.Z = mouseintersectsscreenvec.Z;
            ...
            */
            ...
            //camrotmat.M41 = pointOnScreenn.X;
            //camrotmat.M42 = pointOnScreenn.Y;
            //camrotmat.M43 = pointOnScreenn.Z;
            ...
            //var someval0 = (pointOnScreenn - vert00);
            //var someval1 = (pointOnScreenn - vert11);
            ...
            /*
            worldMatrix_instances_screen_assets[0][0][0].M41 = (float)mouseintersectsscreenvec.X;
            worldMatrix_instances_screen_assets[0][0][0].M42 = (float)mouseintersectsscreenvec.Y;
            worldMatrix_instances_screen_assets[0][0][0].M43 = (float)mouseintersectsscreenvec.Z;*/

            //worldMatrix_instances_screen_assets[0][0][0].M43 = pointOnScreenn.Z;
            //worldMatrix_instances_screen_assets[0][0][0].M43 = pointOnScreenn.Z + (direction_feet_forward.Z);
            ...
            /*
            if (mouseintersectsscreen)
            {
                Vector3 directionmousetoscreenpos = positionOfScreen - mouseintersectsscreenvec;
                float directionmousetoscreenposf = positionOfScreen.X - mouseintersectsscreenvec.X;
                float mag = directionmousetoscreenpos.Length();

                Console.WriteLine("true " + " mouse " + mouseintersectsscreenvec + " mag " + mag + " mouse " + mousecampos + " XRight " + percentXRight + " YRight " + percentYRight);
            }
            else
            {
                Vector3 directionmousetoscreenpos = positionOfScreen - mouseintersectsscreenvec;
                float directionmousetoscreenposf = positionOfScreen.X - mouseintersectsscreenvec.X;
                float mag = directionmousetoscreenpos.Length();
                Console.WriteLine("false " + " mouse " + mouseintersectsscreenvec + " mag " + mag + " mouse " + mousecampos + " XRight " + percentXRight + " YRight " + percentYRight);
            }*/
                                                                                    ...
                                                                                    if (somebytearray != null && somebytearray.Length > 0 && Program.exitedprogram == -1)
                                                                                    {
                                                                                        ...
                                                                                        else if (somevoxelvirtualdesktopglobals.tinyChunkWidth == 8)
                                                                                        {
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M11 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M12 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M13 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M14 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M21 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M22 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M23 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M24 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M31 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M32 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M33 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M34 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M41 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M42 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M43 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M44 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M11 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M12 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M13 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M14 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M21 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M22 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M23 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M24 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M31 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M32 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M33 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M34 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M41 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M42 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M43 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M44 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M11 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M12 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M13 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M14 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M21 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M22 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M23 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M24 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M31 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M32 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M33 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M34 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M41 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M42 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M43 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M44 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M11 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M12 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M13 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M14 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M21 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M22 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M23 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M24 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M31 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M32 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M33 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M34 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M41 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M42 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M43 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
                                                                                            ...
                                                                                            if (bytePoser >= 0 && bytePoser < somebytearray.Length)
                                                                                            {
                                                                                                try
                                                                                                {
                                                                                                    somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M44 = somebytearray[bytePoser] * somemultiplier;
                                                                                                }
                                                                                                catch (Exception ex)
                                                                                                {
                                                                                                    //Program.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somebytearray.Length + " " + ex.ToString(), "scmsg", 0);
