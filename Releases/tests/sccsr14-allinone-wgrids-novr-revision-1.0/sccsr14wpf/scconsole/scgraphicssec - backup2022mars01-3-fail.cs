            ...
            if (watchforgetmouseclick.Elapsed.Milliseconds > 10)
            {
                ...
                if (Program.keynmouseinput._MouseState.Buttons[0])
                {
                    ...
                    if (mousebuttonframecounter == 0)
                    {
                        ...
                        inputs = new INPUT[] { inputmousehover };
                        SendInput((uint)inputs.Length, inputs, Marshal.SizeOf(typeof(INPUT)));
                        ...
                        //PostMessage(Program.vewindowsfoundedz, WM_LBUTTONDOWN, 0, lparm);
                        //PostMessage(Program.vewindowsfoundedz, WM_LBUTTONUP, 0, lparm);
                        //SendMessage((int)Program.testGetWindowThreadProcessId, WM_LBUTTONDOWN, 0, lparm);
                        //SendMessage((int)Program.testGetWindowThreadProcessId, WM_LBUTTONUP, 0, lparm);
                        ...
                        */
                        ...
                        //ClickOnPoint(Program.vewindowsfoundedz, new Point(positionmouseinvx, positionmouseinvy), positionmouseinvx, positionmouseinvy);
                        //const uint WM_LBUTTONDOWN = 0x0201;
                        //const uint WM_LBUTTONUP = 0x0202;
                        //SetCursorPos((int)mbefposx, (int)mbefposy);
                    ...
                    else if (mousebuttonframecounter == 1)
                    {
                        ...
                        //SendMessage((int)Program.testGetWindowThreadProcessId, KEY_SPACE, 0, lparm);
                        //mouse_event(MOUSEEVENTF_MOVE | MOUSEEVENTF_ABSOLUTE, absoluteMoveX, absoluteMoveY, 0, 0);
                        //mouse_event(MOUSEEVENTF_MOVE | MOUSEEVENTF_ABSOLUTE, absoluteMoveX, absoluteMoveY, 0, 0);
                        ...
                        //Program.keyboardsim.KeyDown(WindowsInput.Native.VirtualKeyCode.SPACE);
                    ...
                    else if (mousebuttonframecounter == 2)
                    {
                        ...
                        //Program.mousesim.LeftButtonUp();
                        //Program.keynmouseinput._MouseState.Buttons[0]
                        //Program.keynmouseinput._Mouse.LeftButtonUp();
