                ...
                if (canworkphysics == 1)
                {
                    ...
                    if (updatethreadupdateswtc == 0)
                    {
                        ...
                        */
                        ...
                        _thread_looper:
                            ...
                            if (someintegerlockingstruct[0].someintegerlocking == 2)
                            {
                                Console.WriteLine("t1 working");
                                someintegerlockingstruct[0].someintegerlocking = 3;
                            }
                            ...
                            if (someintegerlockingstruct[0].someintegerlocking == 3)
                            {
                                Console.WriteLine("t1 locking");
                                somereseteventt0.Reset();
                                somereseteventt1.WaitOne();
                                //somereseteventt1.Set();
                                someintegerlockingstruct[0].someintegerlocking = 0;
                            }
                            //GC.Collect();
                    ...
                    if (screencaptureframe._texture2DFinal != null)
                    {
                        try
                        {
                            ...
                            screencaptureframe.ShaderResource = shaderRes;
