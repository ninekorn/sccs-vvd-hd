    ...
    public class scgraphicssec //: sccs.scgraphics.scupdate//SC_Intermediate_Update
    {
        ...
        public scmessageobjectjitter[][] _sc_create_world_objects(scmessageobjectjitter[][] _sc_jitter_tasks)
        {
                                    ...
                                    for (int xxx = 0; xxx < somevoxelvirtualdesktopw; xxx++)
                                    {
                                        for (int yyy = 0; yyy < somevoxelvirtualdesktoph; yyy++)
                                        {
                                            for (int zzz = 0; zzz < somevoxelvirtualdesktopd; zzz++)
                                            {
                                                ...
                                                somevoxelvirtualdesktop[somevoxelindex].currentWorldMatrix = somematrixroter;
            ...
            */
            ...
            Vector3 positionOfScreen = new Vector3(somevoxelvirtualdesktop[0].worldmatofobj.M41, somevoxelvirtualdesktop[0].worldmatofobj.M42, somevoxelvirtualdesktop[0].worldmatofobj.M43);
        ...
        public unsafe void oculuscontrolsNRecordSoundNMousePointer()
        {
            ...
            var planer = new Plane(new Vector3(somevoxelvirtualdesktop[0].worldmatofobj.M41, somevoxelvirtualdesktop[0].worldmatofobj.M42, somevoxelvirtualdesktop[0].worldmatofobj.M43), screenNormal);
            ...
            */
            ...
            if (watchforgetmousepos.Elapsed.Milliseconds > 20)
            {
            ...
            var positionOfMousereducedx = ((somepoint.X * (240 * 8 * 0.005f)) / (1920));
            var positionOfMousereducedy = ((somepoint.X * (135 * 8 * 0.005f)) / (1080));

            var cameraPosOnScreenLeftx = cameraPos - (direction_feet_right * (240 * 8 * 0.005f) * 0.5f);
            ...
            if (mouseintersectsscreen)
            {
                ...
                float mag = directionmousetoscreenpos.LengthSquared();

                Console.WriteLine("true " + cameraPosOnScreenLeftx.X + " mag " + mag + " x " + directionmousetoscreenposf + " mouse " + mouseintersectsscreenvec + " campos " + cameraPos);
            }
            else
            {
                Vector3 directionmousetoscreenpos = positionOfScreen - mouseintersectsscreenvec;
                float directionmousetoscreenposf = positionOfScreen.X - mouseintersectsscreenvec.X;
                float mag = directionmousetoscreenpos.LengthSquared();
                Console.WriteLine("false " + directionmousetoscreenposf + " mag " + mag);
            }
