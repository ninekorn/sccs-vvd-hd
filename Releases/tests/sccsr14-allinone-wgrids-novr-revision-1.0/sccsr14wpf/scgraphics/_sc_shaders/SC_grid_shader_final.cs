...
{
    public class SC_grid_shader_final                 // 228 lines
    {
        ...
        public SCCoreSystems.SC_Graphics.SC_grid.DLightBuffer[] _DLightBuffer;

        public bool Initialize(Device device, IntPtr windowsHandler, SharpDX.Direct3D11.Buffer ConstantLightBuffer, SCCoreSystems.SC_Graphics.SC_grid.DLightBuffer[] DLightBuffer)
        {
        ...
        public bool Render(DeviceContext deviceContext, int VertexCount, int InstanceCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture, SC_grid.DLightBuffer[] _DLightBuffer_, SC_grid _cuber)
        {
