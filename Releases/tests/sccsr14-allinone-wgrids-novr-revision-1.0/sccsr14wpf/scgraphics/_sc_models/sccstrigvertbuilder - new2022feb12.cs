...
{
    public class sccstrigvertbuilder
    {
        //public byte[] map;
        private int[] map;
        private int block;
        ...
        public void Regenerate(Vector4 currentPosition, int voxeltype)
        {
            ...
            for (z = 0; z <= tinyChunkDepth; z++)
            {

                DrawFrontFace(x, y, z, currentPosition, block, voxeltype);

                //int currentIndex = x + (tinyChunkWidth * (y + (tinyChunkHeight * z)));

                //int currentIndex = 0 + (tinyChunkWidth * (0 + (tinyChunkHeight * 4)));

                /*//int z = 0;
                if (x == 0 && y == 0 || x == 0 && y == tinyChunkHeight - 1 || x == tinyChunkWidth - 1 && y == 0 || x == tinyChunkWidth - 1 && y == tinyChunkHeight - 1) // && y == 0 || y == tinyChunkHeight - 1 && z == 0 || z == tinyChunkDepth - 1
                {
                    DrawFrontFace(x, y, z, currentPosition, block, voxeltype);
                }*/
            }
            ...
            for (x = 0; x <= tinyChunkWidth; x++)
            {

                DrawRightFace(x, y, z, currentPosition, block, voxeltype);
            ...
            for (y = 0; y <= tinyChunkHeight; y++)
            {

                DrawTopFace(x, y, z, currentPosition, block, voxeltype);
        ...
        public void DrawRightFace(int x, int y, int z, Vector4 currentPosition, int block, int voxeltype)
        {
            Vector4 start = new Vector4((x * planeSize) - (1 * planeSize), y * planeSize, z * planeSize, 1);
            //Vector4 start = new Vector4(x * planeSize, (y * planeSize), z * planeSize, 1);
            Vector4 offset1, offset2;

            //forward = new Vector4(0, 0, tinyChunkDepth, 1);
            //back = new Vector4(0, 0, -tinyChunkDepth, 1);


            forward = new Vector4(0, 0, tinyChunkDepth, 1);
            back = new Vector4(0, 0, -tinyChunkDepth, 1);
            right = new Vector4(1, 0, 0, 1);
            left = new Vector4(-1, 0, 0, 1);
            up = new Vector4(0, tinyChunkHeight, 0, 1);
            down = new Vector4(0, -tinyChunkHeight, 0, 1);

            /*
            forward = new Vector4(0, 0, tinyChunkDepth, 1);
            back = new Vector4(0, 0, -tinyChunkDepth, 1);
            right = new Vector4(tinyChunkWidth, 0, 0, 1);
            left = new Vector4(-tinyChunkWidth, 0, 0, 1);
            up = new Vector4(0, tinyChunkHeight, 0, 1);
            down = new Vector4(0, -tinyChunkHeight, 0, 1);*/
        ...
        public void DrawTopFace(int x, int y, int z, Vector4 currentPosition, int block, int voxeltype)
        {
            Vector4 start = new Vector4(x * planeSize, (y * planeSize) - (1 * planeSize), z * planeSize, 1);
        ...
        public void DrawFrontFace(int x, int y, int z, Vector4 currentPosition, int block, int voxeltype)
        {
            //Vector4 start = new Vector4(x * planeSize, y * planeSize, (z * planeSize) - (1 * planeSize), 1);
            Vector4 start = new Vector4(x * planeSize, y * planeSize, z * planeSize, 1);
            Vector4 offset1, offset2;
            ...
            forward = new Vector4(0, 0, 1, 1);
            back = new Vector4(0, 0, -1, 1);
            right = new Vector4(tinyChunkWidth, 0, 0, 1);
            left = new Vector4(-tinyChunkWidth, 0, 0, 1);
            up = new Vector4(0, tinyChunkHeight, 0, 1);
            down = new Vector4(0, -tinyChunkHeight, 0, 1);
