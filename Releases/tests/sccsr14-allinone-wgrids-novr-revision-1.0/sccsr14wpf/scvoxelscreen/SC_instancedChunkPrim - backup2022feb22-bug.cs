    ...
    public class SC_instancedChunkPrim
    {
        ...
        public void createChunk(sccs.scgraphics.scdirectx D3D, float surfaceWidth, float surfaceHeight, Vector3 lightpos, Vector3 dirLight, Vector3 somechunkpriminstancepos_, int chunkindex_, int _addtoworld, float _mass, World _the_world, bool _is_static, sccs.scgraphics.scdirectx.BodyTag _tag, int numberofmainobjectx, int numberofmainobjecty, int numberofmainobjectz, int numberOfObjectInWidth_, int numberOfObjectInHeight_, int numberOfObjectInDepth_, int numberOfInstancesPerObjectInWidth_, int numberOfInstancesPerObjectInHeight_, int numberOfInstancesPerObjectInDepth_, int tinyChunkWidth_, int tinyChunkHeight_, int tinyChunkDepth_, float planeSize_, int shaderswtch, float offsetinstance, int fullface_, int usegeometryshader_, int somechunkkeyboardpriminstanceindex_, int voxeltype_, Matrix worldmatofobj_, int typeofbytemapobject_, int mainix, int mainiy, int mainiz)
        {
            try
            {
                ...
                {
                    vsFileNameByteArray = sccsr14forms.Properties.Resources.sccsvertbindchunkVS;//textureTrigChunkVSMOD
                    psFileNameByteArray = sccsr14forms.Properties.Resources.sccsvertbindchunkPS;
                    //gsFileName = sccs.Properties.Resources.HLSLchunkkeyboard;
                    gsFileName = sccsr14forms.Properties.Resources.HLSL;
                }
                else if (shaderswtch == 1 && Program._useOculusRift == 1)
                {
                    vsFileNameByteArray = sccsr14forms.Properties.Resources.textureTrigChunkVS;//textureTrigChunkVSMOD
                    psFileNameByteArray = sccsr14forms.Properties.Resources.textureTrigChunkPS;
                    gsFileName = sccsr14forms.Properties.Resources.HLSL;
                }
                else if (shaderswtch == 2 && Program._useOculusRift == 1)
                {
                    vsFileNameByteArray = sccsr14forms.Properties.Resources.sccsvertbindchunkheightmapVS;//textureTrigChunkVSMOD
                    psFileNameByteArray = sccsr14forms.Properties.Resources.sccsvertbindchunkheightmapPS;
                    gsFileName = sccsr14forms.Properties.Resources.HLSL;
                }
                else if (shaderswtch == 3 && Program._useOculusRift == 1)
                {
                    vsFileNameByteArray = sccsr14forms.Properties.Resources.sccsvertbindchunkheightmapVSeight;//textureTrigChunkVSMOD
                    psFileNameByteArray = sccsr14forms.Properties.Resources.sccsvertbindchunkheightmapPSeight;
                    gsFileName = sccsr14forms.Properties.Resources.HLSL;
                }
                else if (shaderswtch == 0 && Program._useOculusRift == 0)
                {
                    vsFileNameByteArray = sccsr14forms.Properties.Resources.sccsvertbindchunkVSdx;//textureTrigChunkVSMOD
                    psFileNameByteArray = sccsr14forms.Properties.Resources.sccsvertbindchunkPSdx;
                    //gsFileName = sccs.Properties.Resources.HLSLchunkkeyboard;
                    gsFileName = sccsr14forms.Properties.Resources.HLSL;
                }
                else if (shaderswtch == 1 && Program._useOculusRift == 0)
                {
                    vsFileNameByteArray = sccsr14forms.Properties.Resources.textureTrigChunkVSdx; //textureTrigChunkVSMOD
                    psFileNameByteArray = sccsr14forms.Properties.Resources.textureTrigChunkPSdx;
                    gsFileName = sccsr14forms.Properties.Resources.HLSL;
                }
                else if (shaderswtch == 2 && Program._useOculusRift == 0)
                {
                    vsFileNameByteArray = sccsr14forms.Properties.Resources.sccsvertbindchunkheightmapVSdx; //textureTrigChunkVSMOD
                    psFileNameByteArray = sccsr14forms.Properties.Resources.sccsvertbindchunkheightmapPSdx;
                    gsFileName = sccsr14forms.Properties.Resources.HLSL;
                }
                else if (shaderswtch == 3 && Program._useOculusRift == 0)
                {
                    vsFileNameByteArray = sccsr14forms.Properties.Resources.sccsvertbindchunkheightmapVSeightdx; //textureTrigChunkVSMOD
                    psFileNameByteArray = sccsr14forms.Properties.Resources.sccsvertbindchunkheightmapPSeightdx;
                    gsFileName = sccsr14forms.Properties.Resources.HLSL;
                }


                var hsFileName = sccsr14forms.Properties.Resources.colorhull; //textureTrigChunkVSMOD
                var dsFileName = sccsr14forms.Properties.Resources.colordom;
