...
namespace sccs
{
    public class SC_instancedChunk_shader_final
    {
        ...
        public SC_instancedChunk_shader_final(SharpDX.Direct3D11.Device _device)
        {
            ...
            //MainWindow.MessageBox((IntPtr)0, "" + somepath, "scmsg", 0);
       ...
       public ShaderResourceView shaderResourceView2D;
        ...
        public SC_instancedChunkPrim.chunkData Renderer(SC_instancedChunkPrim.chunkData chunkdat, int indexBuilt, ShaderResourceView shaderResourceView2D_,int voxeltype_) //async
        {
            ...
            device.ImmediateContext.InputAssembler.SetVertexBuffers(8, new[]
           {
            ...
            if (scgraphics.scgraphicssec.activatevrheightmapfeature == 1 && scgraphics.scgraphicssec.somevoxelvirtualdesktopglobals.tinyChunkWidth == 8 || scgraphics.scgraphicssec.activatevrheightmapfeature == 1 && scgraphics.scgraphicssec.somevoxelvirtualdesktopglobals.tinyChunkWidth == 16 ||
                scgraphics.scgraphicssec.activatevrheightmapfeature == 0 && scgraphics.scgraphicssec.somevoxelvirtualdesktopglobals.tinyChunkWidth == 8 || scgraphics.scgraphicssec.activatevrheightmapfeature == 0 && scgraphics.scgraphicssec.somevoxelvirtualdesktopglobals.tinyChunkWidth == 16)
            {
