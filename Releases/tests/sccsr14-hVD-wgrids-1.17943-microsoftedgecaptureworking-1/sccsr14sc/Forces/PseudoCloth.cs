...
namespace Jitter.Forces
{
    public class PseudoCloth
    {
        ...
        public PseudoCloth(World world, sccs.scgraphics.scdirectx D3D, IntPtr windowsHandle, int sizeX, int sizeY, float scale, Matrix matter) //World world, 
        {
            this.world = world;
            ...
            for (int x = 0; x < sizeX; x++)
            {
                for (int y = 0; y < sizeX; y++)
                {
                    ...
                    bodies[x + y * sizeY].Tag = sccs.sc_console.SC_console_directx.BodyTag.pseudoCloth;
