                ...
                if (checkBox1.Checked)
                {
                    ...
                    */
                    ...
                    if (altcapturedwindowname.Contains("microsoft") && altcapturedwindowname.Contains("edge"))
                    {
                        ...
                        screenWidth = 800;// Program.GetSystemMetrics(0);
                        screenHeight = 600;// Program.GetSystemMetrics(1);



                        Program.RECT rectmicrosoftedge = new Program.RECT();
                        Program.GetWindowRect(Program.vewindowsfoundedz, ref rectmicrosoftedge);
                            ...
                            rectmicrosoftedge.Right == Program.GetSystemMetrics(0) && rectmicrosoftedge.Bottom == Program.GetSystemMetrics(1))
                        {
                            ...
                            if (wasf11pressedbynativeonedge == 1)
                            {
                                var iswinmax = sccsr14sc.Form1.IsWindowMaximized(Program.vewindowsfoundedz);
                                ...
                                var istopmost = sccsr14sc.Form1.IsWindowTopMost(Program.vewindowsfoundedz);

                                //sccsr14sc.Form1.MessageBox((IntPtr)0, "0istopmost:" + istopmost, "sccsmsg", 0);
                                ...
                                //Program.MessageBox((IntPtr)0, "window is maximized wasf11pressedbynativeonedge == 1", "sccs", 0);

                                wasf11pressedbynativeonedge = 0;
                            }
                            else if (wasf11pressedbynativeonedge == 2)
                            {
                                var iswinmax = sccsr14sc.Form1.IsWindowMaximized(Program.vewindowsfoundedz);
                                ...
                                //sccsr14sc.Form1.MessageBox((IntPtr)0, "1istopmost:" + istopmost, "sccsmsg", 0);
                                ...
                                // Program.MessageBox((IntPtr)0, "window is maximized wasf11pressedbynativeonedge == 2", "sccs", 0);
                                wasf11pressedbynativeonedge = 0;
                            }


                            //Program.MessageBox((IntPtr)0, "window is maximized", "sccs", 0);

                        }
                        else
                        {
                            //window is maximized or fullscreen
                            //Program.MessageBox((IntPtr)0, "window is not maximized 2", "sccs", 0);


                            /*var istopmost = sccsr14sc.Form1.IsWindowTopMost(Program.vewindowsfoundedz);

                            sccsr14sc.Form1.MessageBox((IntPtr)0, "2istopmost:" + istopmost, "sccsmsg", 0);
                        ...
                        /*UnSetFocus(Program.vewindowsfoundedz, "");
                    ...
                    else if (altcapturedwindowname.Contains("void") && altcapturedwindowname.Contains("expanse"))
                    {
                        ...
                        //sccs.Program.MessageBox((IntPtr)0, "altcapturedwindowname:" + altcapturedwindowname, "scmsg", 0);
                    ...
                    if (checkBox3_CheckedChangedint == 0)
                    {
                        ...
                        if (altcapturedwindowname.Contains("microsoft") && altcapturedwindowname.Contains("edge"))
                        {
                                ...
                                rectmicrosoftedge.Right == Program.GetSystemMetrics(0) && rectmicrosoftedge.Bottom == Program.GetSystemMetrics(1))
                            {
                                ...
                                //if (wasf11pressedbynativeonedge == 0)
                                {
                                    var iswinmax = sccsr14sc.Form1.IsWindowMaximized(Program.vewindowsfoundedz);
