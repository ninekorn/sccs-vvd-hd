...
namespace SCCoreSystems.SC_Graphics
{
    public class sc_spectrum : ITransform, IComponent
    {
        ...
        public SCCoreSystems.SC_Graphics.sc_spectrum.DInstanceData[] instancesDataRIGHT { get; set; }
        public SCCoreSystems.SC_Graphics.sc_spectrum.DInstanceData[] instancesDataUP { get; set; }
