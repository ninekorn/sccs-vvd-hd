...
namespace sccs
{
    public class sccstrigvertbuilderscreenreduced
    {
        //public byte[] map;
        private int[] map;
        private int block;
                ...
                if (indexBytes < totalBytes)
                {
                    ...
                    */
                    ...
                    if (IsTransparent(xi, yi - 1, zi))
                    {
                        ...
                        {
                            SC_instancedChunk someChunk = (SC_instancedChunk)componentParent.getChunk(somevalueforBottomx, somevalueforBottomy, somevalueforBottomz);
                    ...
                    if (IsTransparent(xi - 1, yi, zi))
                    {
                        ...
                        {
                            SC_instancedChunk someChunk = (SC_instancedChunk)componentParent.getChunk(somevalueforLeftx, somevalueforLefty, somevalueforLeftz);
                    ...
                    if (IsTransparent(xi, yi, zi - 1))
                    {
                        ...
                        {
                            SC_instancedChunk someChunk = (SC_instancedChunk)componentParent.getChunk(somevalueforBackx, somevalueforBacky, somevalueforBackz);
                    ...
                    if (IsTransparent(xi, yi + 1, zi))
                    {
                        ...
                        if (componentParent.getChunk(somevalueforTopx, somevalueforTopy, somevalueforTopz) != null)
                        {
                            ...
                            SC_instancedChunk someChunk = (SC_instancedChunk)componentParent.getChunk(somevalueforTopx, somevalueforTopy, somevalueforTopz);
                    ...
                    if (IsTransparent(xi + 1, yi, zi))
                    {
                        ...
                        if (componentParent.getChunk(somevalueforRightx, somevalueforRighty, somevalueforRightz) != null)
                        {
                            ...
                            SC_instancedChunk someChunk = (SC_instancedChunk)componentParent.getChunk(somevalueforRightx, somevalueforRighty, somevalueforRightz);
                    ...
                    if (IsTransparent(xi, yi, zi + 1))
                    {
                        ...
                        if (componentParent.getChunk(somevalueforFrontx, somevalueforFronty, somevalueforFrontz) != null)
                        {
                            ...
                            SC_instancedChunk someChunk = (SC_instancedChunk)componentParent.getChunk(somevalueforFrontx, somevalueforFronty, somevalueforFrontz);
        ...
        public void setAdjacentChunks(Vector3 pos, int indexx, int indexy, int indexz)
        {
            ...
            if (indexx == 0)
            {
                ...
                {
                    SC_instancedChunk adjacentChunk = (SC_instancedChunk)componentParent.getChunk((int)pos.X - useonlyunitOneForNeighboorIndexPlease, (int)pos.Y, (int)pos.Z);
            ...
            if (indexy == 0)
            {
                ...
                {
                    SC_instancedChunk adjacentChunk = (SC_instancedChunk)componentParent.getChunk((int)pos.X, (int)pos.Y - useonlyunitOneForNeighboorIndexPlease, (int)pos.Z);
                    if (adjacentChunk.map != null)
                    {
            ...
            if (indexz == 0)
            {
                ...
                {
                    SC_instancedChunk adjacentChunk = (SC_instancedChunk)componentParent.getChunk((int)pos.X, (int)pos.Y, (int)pos.Z - useonlyunitOneForNeighboorIndexPlease);
                    if (adjacentChunk.map != null)
                    {
            ...
            if (indexx == 0 && indexy == 0 && indexz > 0 && indexz < depth - 1)
            {
                ...
                {
                    SC_instancedChunk adjacentChunk = (SC_instancedChunk)componentParent.getChunk((int)pos.X - useonlyunitOneForNeighboorIndexPlease, (int)pos.Y - useonlyunitOneForNeighboorIndexPlease, (int)pos.Z);
                    if (adjacentChunk.map != null)
                    {
            ...
            if (indexx == 0 && indexy == 0 && indexz == 0)
            {
                ...
                {
                    SC_instancedChunk adjacentChunk = (SC_instancedChunk)componentParent.getChunk((int)pos.X, (int)pos.Y - useonlyunitOneForNeighboorIndexPlease, (int)pos.Z - useonlyunitOneForNeighboorIndexPlease);
                    if (adjacentChunk.map != null)
                    {
                ...
                {
                    SC_instancedChunk adjacentChunk = (SC_instancedChunk)componentParent.getChunk((int)pos.X - useonlyunitOneForNeighboorIndexPlease, (int)pos.Y, (int)pos.Z - useonlyunitOneForNeighboorIndexPlease);
                    if (adjacentChunk.map != null)
                    {
                ...
                {
                    SC_instancedChunk adjacentChunk = (SC_instancedChunk)componentParent.getChunk((int)pos.X - useonlyunitOneForNeighboorIndexPlease, (int)pos.Y - useonlyunitOneForNeighboorIndexPlease, (int)pos.Z - useonlyunitOneForNeighboorIndexPlease);
                    if (adjacentChunk.map != null)
                    {
