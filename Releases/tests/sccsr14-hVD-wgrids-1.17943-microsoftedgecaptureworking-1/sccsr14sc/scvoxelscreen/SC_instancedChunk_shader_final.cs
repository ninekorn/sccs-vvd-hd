...
using static sccs.SC_instancedChunkPrim;
...
namespace sccs
{
    public class SC_instancedChunk_shader_final: IDisposable
    {
        ...
        public SC_instancedChunkPrim.chunkData Renderer(SC_instancedChunkPrim.chunkData chunkdat, int indexBuilt, ShaderResourceView shaderResourceView2D_,int voxeltype_) //async
        {
            ...
            device.ImmediateContext.MapSubresource(chunkdat.ConstantTransparentBuffer, MapMode.WriteDiscard, SharpDX.Direct3D11.MapFlags.None, out mappedResource);
            ...
            device.ImmediateContext.UnmapSubresource(chunkdat.ConstantTransparentBuffer, 0);
            // Set the position of the constant buffer in the vertex shader.
            var bufferPositionNumber = 0;
            // Finally set the constant buffer in the vertex shader with the updated values.
            device.ImmediateContext.PixelShader.SetConstantBuffer(bufferPositionNumber, chunkdat.ConstantTransparentBuffer);
