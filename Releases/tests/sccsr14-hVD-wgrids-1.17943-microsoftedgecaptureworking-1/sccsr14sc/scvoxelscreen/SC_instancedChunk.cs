...
namespace sccs
{
    public class SC_instancedChunk
    {
        ...
        private void ShutdownBuffers()
        {
            ...
            if (arrayofzeromeshinstances != null)
            {
                for (int i = 0; i < arrayofzeromeshinstances.Length; i++)
                {
                    if (arrayofzeromeshinstances[i] != null)
                    {
                        //arrayofzeromeshinstances[i].Dispose();
                        arrayofzeromeshinstances[i] = null;
                    }
                }
            }
                ...
                for (int y = 0; y < numberOfInstancesPerObjectInHeight; y++)
                {
                    for (int z = 0; z < numberOfInstancesPerObjectInDepth; z++)
                    {
                        ...
                        */
                        ...
                        _tempMatrix.M41 = position.X;// somechunk[chunkinstindex].somechunkpos.X;
                        _tempMatrix.M42 = position.Y;// somechunk[chunkinstindex].somechunkpos.Y;
                        _tempMatrix.M43 = position.Z;// somechunk[chunkinstindex].somechunkpos.Z;
