...
namespace sccs.sccore
{
    public class scconsolecore : scicomponent
    {
        ...
        public scconsolecore(scmessageobject.scmessageobject[] tester, int hideornot)
        {
        ...
        public void _createConsole(scmessageobject.scmessageobject[] tester, int hideornot)
        {
