...
namespace sccs
{
    public class SC_AI //: MonoBehaviour
    {
        public struct data_input
        {
            ...
            public int CompassTypeSwitch;
        }

        public int inputsNumber = 10; // 3 minimum i think
        ...
        public int angleSwitch = 0;

        public void UpdatePerceptron(data_input _data_input)
        {
            //swtchwaypointtype = _data_input.CompassTypeSwitch;
            ...
            if ((int)currentQuarterRoundedAngle < saveCurrentWeightForTheCurrentAngleInsideOfUnitsOf360.Length)
            {
                ...
                if (swtchwaypointtype == 0)//roll
                {
                    Vector3 dirprimertonorthpoletransform = new Vector3(northpoletransform.X, northpoletransform.Y, northpoletransform.Z) - new Vector3(compasspivot.X, compasspivot.Y, compasspivot.Z);
                    //dirprimertonorthpoletransform *= -1;

                    float dotres = 0;

                    Vector3.Dot(ref _data_input.dronePosDirUp, ref dirprimertonorthpoletransform, out dotres);
                    _dotGoal = dotres;
                    /*if (dotres < 0.99f)
                    {
                        answer = 1;
                    ...
                    //Console.WriteLine(_dotGoal);
                    /*float dotres = 0;

                    Vector3.Dot(ref _data_input.dronePosDirForward,ref _data_input.dronePosDirRight, out dotres);
                    ...
                    Vector2 dirprimertonorthpoletransform = new Vector2(northpoletransform.Y,-northpoletransform.X) - new Vector2(compasspivot.X, compasspivot.Y);
                    dirprimertonorthpoletransform.Normalize();

                    _dotGoal = sc_maths.Dot(dirbulletprimerright.X, dirbulletprimerright.Y, -dirprimertonorthpoletransform.Y, dirprimertonorthpoletransform.X);
                ...
                else if (swtchwaypointtype == 1)//yaw
                {
                    ...
                    Vector3.Dot(ref _data_input.dronePosDirRight, ref dirprimertonorthpoletransform, out dotres);
                    _dotGoal = dotres;
                    ...
                    /*if (_dotGoal >= 0 && _dotGoal < 0.50f || _dotGoal > -0.50f && _dotGoal < 0) // 0.001f
                    {
                        answer = 1;
                    }
                    else// if (_dotGoal > -0.50f && _dotGoal < 0) //-0.001f
                ...
                else if (swtchwaypointtype == 2)//pitch
                {
                    Vector3 dirprimertonorthpoletransform = new Vector3(northpoletransform.X, northpoletransform.Y, northpoletransform.Z) - new Vector3(compasspivot.X, compasspivot.Y, compasspivot.Z);
                    dirprimertonorthpoletransform *= -1;
                    ...
                    Vector2 dirprimertonorthpoletransform = new Vector2(northpoletransform.Z, -northpoletransform.Y) - new Vector2(compasspivot.Z, -compasspivot.Y);
                    dirprimertonorthpoletransform.Normalize();

                    _dotGoal = sc_maths.Dot(dirbulletprimerright.Y, -dirbulletprimerright.X, dirprimertonorthpoletransform.X, dirprimertonorthpoletransform.Y);
                    ...
                    /*if (_dotGoal >= -0.50f && _dotGoal < 0.50f) // 0.001f
                    {
                        answer = 1;
                    }
                    else if (_dotGoal < -0.50f || _dotGoal > 0.50f) //-0.001f
                    {
                        answer = -1;
                    }*/
                    /*if (_dotGoal >= 0 && _dotGoal < 0.50f) // 0.001f
                ...
                //Console.WriteLine("dot: " + _dotGoal);
                ...
                try
                {
                    ...
                    int someangleindex = (int)currentQuarterRoundedAngle;
                    if (someangleindex >= 0 && someangleindex < saveCurrentWeightForTheCurrentAngleInsideOfUnitsOf360.Length)
                    {
                        var somearray = perc.GetWeights();

                        if (somearray != null)
                        {
                            saveCurrentWeightForTheCurrentAngleInsideOfUnitsOf360[someangleindex] = somearray;
                            //Console.WriteLine(someangleindex);
