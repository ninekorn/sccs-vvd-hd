...
namespace SCCoreSystems
{
    public class SC_AI//: MonoBehaviour
    {
        ...
        public sccsaiguess(Transform compassOriginPos, Vector3 northpoleOrBullseyePos, float waitforsecondsswtch_, float waitforseconds_)
        {
                        ...
                        for (int i = 0; i < training.Length; i++)
                        {
                            ...
                            if (perc != null)
                            {
                                if (training[i] != null)
                                {
                                    ...
                                    {
                                        Debug.Log("null training inputs");
                                    }
                                }
                                else
                                {
                                    Debug.Log("null training " + i);
                                }
                            }
                            else
                            {
