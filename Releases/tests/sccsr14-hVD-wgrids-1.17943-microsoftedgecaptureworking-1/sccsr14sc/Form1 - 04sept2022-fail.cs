            ...
            */
            ...
            if (Program.exitedprogram == 1)
            {
                ...
                */
                ...
                string altcapturedwindowname = Program.capturedwindowname.ToLower();
                ...
                if (altcapturedwindowname.Contains("microsoft") && altcapturedwindowname.Contains("edge"))
                {
                    ...
                    if (altcapturedwindowname.Contains(" - microsoft? edge")) //altaltcapturedwindowname == "microsoft? edge")//altcapturedwindowname.Contains("microsoft? edge"))
                    {
                        ...
                        */
                        ...
                        int iHandle = sccsr14sc.Form1.FindWindow(null, Program.capturedwindowname);// "VoidExpanse");
                        ...
                        */
                        ...
                        Program.SetWindowPos(Program.vewindowsfoundedz, (IntPtr)Program.SpecialWindowHandles.HWND_TOPMOST, 0, 0, screenWidth, screenHeight, (uint)Program.SetWindowPosFlags.SWP_SHOWWINDOW); //SetWindowPosFlags.SWP_SHOWWINDOW
                ...
                else if (altcapturedwindowname.Contains("gnu") && altcapturedwindowname.Contains("image") && altcapturedwindowname.Contains("manipulation") && altcapturedwindowname.Contains("program"))
                {
                    ...
                    if (altcapturedwindowname.Contains("gnu image manipulation program"))
                    {
                        ...
                        *///MIT-LICENSE-RichardBrass-BorderlessFullscreen
                        ...
                        var sult = Program.SetWindowLongPtr(Program.vewindowsfoundedz, Program.GWL_STYLE, (UIntPtr)(Program.WindowStyles.WS_CAPTION | Program.WindowStyles.WS_POPUPWINDOW | Program.WindowStyles.WS_BORDER | Program.WindowStyles.WS_MINIMIZEBOX | Program.WindowStyles.WS_MAXIMIZEBOX));//| (UIntPtr)Program.WindowStyles.WS_MAXIMIZEBOX | (UIntPtr)Program.WindowStyles.WS_MINIMIZEBOX);
                        //var sult = Program.SetWindowLongPtr(Program.vewindowsfoundedz, Program.GWL_STYLE, (UIntPtr)(Program.WindowStyles.WS_OVERLAPPED));//| (UIntPtr)Program.WindowStyles.WS_MAXIMIZEBOX | (UIntPtr)Program.WindowStyles.WS_MINIMIZEBOX);
                        ...
                        */
                        ...
                        Program.SetWindowPos(Program.vewindowsfoundedz, (IntPtr)Program.SpecialWindowHandles.HWND_NOTOPMOST, 0, 0, Rectsccs.Left, 600, Program.SWP_SHOWWINDOW);
                        //MIT-LICENSE-RichardBrass-BorderlessFullscreen
                        //MIT-LICENSE-RichardBrass-BorderlessFullscreen
                        //MIT-LICENSE-RichardBrass-BorderlessFullscreen

                        sult = Program.SetWindowLongPtr(Program.vewindowsfoundedz, Program.GWL_STYLE, (UIntPtr)Program.WindowStyles.WS_BORDER);
                ...
                else
                {
                    ...
                    Program.SetWindowPos(Program.vewindowsfoundedz, (IntPtr)Program.SpecialWindowHandles.HWND_TOPMOST, 0, 0, 800, screenHeight, (uint)Program.SetWindowPosFlags.SWP_SHOWWINDOW); //SetWindowPosFlags.SWP_SHOWWINDOW
                    */
                    ...
                    */
                    ...
                    /*var sult = Program.SetWindowLongPtr(Program.vewindowsfoundedz, Program.GWL_STYLE, (UIntPtr)(Program.WindowStyles.WS_CAPTION | Program.WindowStyles.WS_POPUPWINDOW| Program.WindowStyles.WS_MAXIMIZEBOX | Program.WindowStyles.WS_MINIMIZEBOX));//| (UIntPtr)Program.WindowStyles.WS_MAXIMIZEBOX | (UIntPtr)Program.WindowStyles.WS_MINIMIZEBOX);
                    ...
                    */
                    ...
                    Program.SetWindowPos(Program.vewindowsfoundedz, (IntPtr)Program.SpecialWindowHandles.HWND_NOTOPMOST, 0, 0, screenWidth, screenHeight, Program.SWP_SHOWWINDOW);
                    ...
                    */
                    ...
                    //Program.SetWindowPos(Program.vewindowsfoundedz, (IntPtr)Program.SpecialWindowHandles.HWND_TOPMOST, 0, 0, screenWidth, screenHeight, Program.SWP_SHOWWINDOW);
                    ...
                    param.ShowCmd = Program.ShowWindowCommands.Normal; //SW_SHOWNORMAL
                    param.NormalPosition = Rectsccs;// new RECT(0, 0, 500, 500);
                    Program.SetWindowPlacement(Program.vewindowsfoundedz, ref param);
