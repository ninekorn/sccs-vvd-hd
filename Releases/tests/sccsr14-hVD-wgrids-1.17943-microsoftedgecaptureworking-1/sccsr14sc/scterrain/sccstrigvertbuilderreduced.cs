...
namespace sccs
{
    public class sccstrigvertbuilderreduced
    {
        ...
        public void Regenerate()
        {
            ...
            int iterateface = 0;
            for (iterateface = 0; iterateface < 6; iterateface++)
            {
        ...
        public void CreateChunkFaces() //int iterateface
        {
                ...
                if (t < total)
                {
                    ...
                    if (index < total)
                    {
                        ...
                        if (_block == 1)
                        {
                            ...
                            if (swtchzints == 0)
                            {
                                CalculateintsForFaces(); // iterateface
                            }
        ...
        void CalculateintsForFaces() //int iterateface
        {
            if (tints < totalints)
            {
                posxints = (xxints);
                ...
                if (indexints < totalints)
                {
                    ...
                    */
                    ...
                    else if (iterateface == 3)
                    {

                        

                    }
                    else if (iterateface == 4)
                    {
                ...
                //if (IsTransparent(temptopfacexi, temptopfaceyi + 1, temptopfacezi))
                {
                    ...
                    if (getChunkVertexint(oneVertIndexX, oneVertIndexY, oneVertIndexZ) == 0)
                    {
                        vertexlist.Add(new SC_VR_Chunk.DVertex()
                        {
                            ...
                            color = new Vector4(xit, yit, zit, facetype),
