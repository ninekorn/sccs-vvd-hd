...
namespace sccs
{
    public class SC_instancedChunk_shader_final: IDisposable
    {
        ...
        public SC_instancedChunkPrim.chunkData Renderer(SC_instancedChunkPrim.chunkData chunkdat, int indexBuilt, ShaderResourceView shaderResourceView2D_,int voxeltype_) //async
        {
            ...
            device.ImmediateContext.InputAssembler.SetVertexBuffers(8, new[]
           {
            ...
            if (scgraphicssec.currentscgraphicssec.activatevrheightmapfeature == 1 && scgraphicssec.somevoxelvirtualdesktopglobals.tinyChunkWidth == 8 || scgraphicssec.currentscgraphicssec.activatevrheightmapfeature == 1 && scgraphicssec.somevoxelvirtualdesktopglobals.tinyChunkWidth == 16 ||
                scgraphicssec.currentscgraphicssec.activatevrheightmapfeature == 0 && scgraphicssec.somevoxelvirtualdesktopglobals.tinyChunkWidth == 8 || scgraphicssec.currentscgraphicssec.activatevrheightmapfeature == 0 && scgraphicssec.somevoxelvirtualdesktopglobals.tinyChunkWidth == 16)
            {
                ...
                */
                ...
                if (chunkdat.pixelmovedbufferregiona == 1 && sccsvvdhd.Form1.currentform.checkdirtyrgbchunkoptionvalue == 1 || sccsvvdhd.Form1.currentform.checkdirtyrgbchunkoptionvalue == 0)
                {
                    //TOREADD 
                    //TOREADD 
                    device.ImmediateContext.MapSubresource(chunkdat.instancesmatrixbuffer, MapMode.WriteDiscard, SharpDX.Direct3D11.MapFlags.None, out mappedResourceLight);
                ...
                if (chunkdat.pixelmovedbufferregionb == 1 && sccsvvdhd.Form1.currentform.checkdirtyrgbchunkoptionvalue == 1 || sccsvvdhd.Form1.currentform.checkdirtyrgbchunkoptionvalue == 0)
                {
                    //TOREADD 
                    //TOREADD 
                    device.ImmediateContext.MapSubresource(chunkdat.instancesmatrixbufferb, MapMode.WriteDiscard, SharpDX.Direct3D11.MapFlags.None, out mappedResourceLight);
                ...
                if (chunkdat.pixelmovedbufferregionc == 1 && sccsvvdhd.Form1.currentform.checkdirtyrgbchunkoptionvalue == 1 || sccsvvdhd.Form1.currentform.checkdirtyrgbchunkoptionvalue == 0)
                {
                    //TOREADD 
                    //TOREADD 
                    device.ImmediateContext.MapSubresource(chunkdat.instancesmatrixbufferc, MapMode.WriteDiscard, SharpDX.Direct3D11.MapFlags.None, out mappedResourceLight);
                ...
                if (chunkdat.pixelmovedbufferregiond == 1 && sccsvvdhd.Form1.currentform.checkdirtyrgbchunkoptionvalue == 1 || sccsvvdhd.Form1.currentform.checkdirtyrgbchunkoptionvalue == 0)
                {
                    //TOREADD 
                    //TOREADD 
                    device.ImmediateContext.MapSubresource(chunkdat.instancesmatrixbufferd, MapMode.WriteDiscard, SharpDX.Direct3D11.MapFlags.None, out mappedResourceLight);
            ...
            /*
            if (scgraphicssec.currentscgraphicssec.activatevrheightmapfeature == 1 && scgraphicssec.somevoxelvirtualdesktopglobals.tinyChunkWidth == 4)
            {
                //TOREADD 
                //TOREADD 
                device.ImmediateContext.MapSubresource(chunkdat.instancesmatrixbuffer, MapMode.WriteDiscard, SharpDX.Direct3D11.MapFlags.None, out mappedResourceLight);
