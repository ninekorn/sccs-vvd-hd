...
static const float3 worldbackward = float3(0,0,-1);
static const float3 worldright = float3(1,0,0);
static const float3 worldleft = float3(-1,0,0);
static const float3 worldup = float3(0,1,0);
static const float3 worlddown = float3(0,-1,0);
...
PixelInputType TextureVertexShader(VertexInputType input)
{
	...
	//forwardDir = worldforward;//float3(input.instanceRadRot.x, input.instanceRadRot.y, input.instanceRadRot.z);
	//rightDir = worldright;//float3(input.instanceRadRotRIGHT.x, input.instanceRadRotRIGHT.y, input.instanceRadRotRIGHT.z);;//cross(world_up,float3(input.instanceRadRot.x, input.instanceRadRot.y, input.instanceRadRot.z));//float3(input.instanceRadRot.x, input.instanceRadRot.y, input.instanceRadRot.z); //world_forward;//
	//upDir = worldup;//float3(input.instanceRadRotUP.x, input.instanceRadRotUP.y, input.instanceRadRotUP.z);
