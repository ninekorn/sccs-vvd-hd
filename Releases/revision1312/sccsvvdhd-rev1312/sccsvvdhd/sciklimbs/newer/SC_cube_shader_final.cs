...
namespace sccs
{
    public class SC_cube_shader_final                 // 228 lines
    {
        ...
        public sccs.SC_cube.DLightBuffer[] _DLightBuffer;

        public bool Initialize(Device device, IntPtr windowsHandler, SharpDX.Direct3D11.Buffer ConstantLightBuffer, sccs.SC_cube.DLightBuffer[] DLightBuffer, int shadertype)
        {
