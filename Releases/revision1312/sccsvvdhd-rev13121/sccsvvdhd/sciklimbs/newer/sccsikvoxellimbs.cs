...
using scmessageobjectjitter = sccs.scmessageobject.scmessageobject;
using Jitter;

using Ab3d.OculusWrap;

//using sccs.scgraphics.scdirectx = sccsvvdhd.scsccs.scgraphics.scdirectx;
//using updateSec = sccsvvdhd.updateSec;
...
namespace sccs
{
    public class sccsikvoxellimbs : IDisposable
    {
        ...
        public sccsikvoxellimbs() //scgraphicssec updateprim_
        {
        ...
        public sccs.scmessageobject.scmessageobjectjitter[][] createikbody(sccs.scmessageobject.scmessageobjectjitter[][] _sc_jitter_tasks, int tempMultiInstancePhysicsTotal, Vector3 ikarmpivotinitposition, sccsikvoxellimbs parentobject_, Matrix worldmatofobj_, int human_inst_rig_x, int human_inst_rig_y, int human_inst_rig_z, int grabtargetitem_, Matrix finalrotationmatrix)
        {
            ...
            //_hasinit0 = _player_pelvis.Initialize(_sccs.scgraphics.scdirectx.D3D, _sccs.scgraphics.scdirectx.D3D.SurfaceWidth, _sccs.scgraphics.scdirectx.D3D.SurfaceHeight, _size_screen, 1, 1, 0.125f, 0.05f, 0.065f, new Vector4(r, g, b, a), instX, instY, instZ, Hwnd, initialmatrix, 9, offsetPosX, offsetPosY, offsetPosZ, vertOffsetX, vertOffsetY, vertOffsetZ); //, "terrainGrassDirt.bmp" //0.00035f
            //_hasinit0 = _player_pelvis[0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight, 1, 1, 1, 0.125f, 0.05f, 0.065f, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Hwnd, initialmatrix, 2, offsetPosX, offsetPosY, offsetPosZ, World, sccs.scgraphics.scdirectx.BodyTag.PlayerPelvis, _static, 1, _mass, 0, 0, 0); //, "terrainGrassDirt.bmp" //0.00035f
            //float voxel_general_size =  voxeliknewsize;
            //voxel_type = 0;
            ...
            //_player_pelvis[0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight, 1, 1, 1, 0.125f, 0.05f, 0.065f, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Hwnd, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, World, _mass, false, sccs.scgraphics.scdirectx.BodyTag.PlayerPelvis, 10, 10, 10, 10, 10, 10, 4, 3, 20, 19, 20, 19, 0.0025f, Vector3.Zero, 300); //, "terrainGrassDirt.bmp" //0.00035f
            _player_pelvis[0][0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight,
                0, 1, 1, 1, sizelowerax, sizeloweray, sizeloweraz,
                new Vector4(r, g, b, a), _inst_p_pelvis_x, _inst_p_pelvis_y, _inst_p_pelvis_z,
                Program.consoleHandle, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static, sccs.scgraphics.scdirectx.BodyTag.PlayerPelvis,
                minx, miny, minz, diagmaxx, diagmaxy, diagmaxz, diagminx, diagminy, diagminz, chunkwidthl, chunkwidthr, chunkheightl, chunkheightr, chunkdepthl, chunkdepthr,
            ...
            //_hasinit0 = _player_torso.Initialize(_sccs.scgraphics.scdirectx.D3D, _sccs.scgraphics.scdirectx.D3D.SurfaceWidth, _sccs.scgraphics.scdirectx.D3D.SurfaceHeight, _size_screen, 1, 1, 0.125f, 0.175f, 0.065f, new Vector4(r, g, b, a), instX, instY, instZ, Hwnd, initialmatrix, 0, offsetPosX, offsetPosY, offsetPosZ, vertOffsetX, vertOffsetY, vertOffsetZ); //, "terrainGrassDirt.bmp" //0.00035f                                                                                                                                                                                                                                                                                        //_hasinit0 = _player_torso.Initialize(_sccs.scgraphics.scdirectx.D3D, _sccs.scgraphics.scdirectx.D3D.SurfaceWidth, _sccs.scgraphics.scdirectx.D3D.SurfaceHeight, _size_screen, 1, 1, 0.075f, 0.075f, 0.075f, new Vector4(r, g, b, a), instX, instY, instZ, Hwnd, initialmatrix, 0, offsetPosX, offsetPosY, offsetPosZ, vertOffsetX, vertOffsetY, vertOffsetZ); //, "terrainGrassDirt.bmp" //0.00035f
            //_player_torso[0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight, 1, 1, 1, 0.125f, 0.175f, 0.065f, new Vector4(r, g, b, a), _inst_p_torso_x, _inst_p_torso_y, _inst_p_torso_z, Hwnd, initialmatrix, 2, offsetPosX, offsetPosY, offsetPosZ, World, sccs.scgraphics.scdirectx.BodyTag.PlayerTorso, _static, 1, _mass, 0, 0, 0); //, "terrainGrassDirt.bmp" //0.00035f
            ...
            _player_torso[0][0].Initialize(
                sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight,
            ...
            _SC_modL_head_BUFFER[0] = new sccs.sc_voxel.DLightBuffer()
            {
            ...
            _SC_modL_torso_BUFFER[0] = new sccs.sc_voxel.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            _SC_modL_pelvis_BUFFER[0] = new sccs.sc_voxel.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            //Console.WriteLine("finished creating parts of ikrig");
        ...
        public sccs.scmessageobject.scmessageobjectjitter[][] setikbodytargetnlimbspositionsNrotations(sccs.scmessageobject.scmessageobjectjitter[][] _sc_jitter_tasks, Matrix viewMatrix, Matrix projectionMatrix, Vector3 OFFSETPOS, Matrix originRot, Matrix rotatingMatrix, Matrix hmdrotMatrix, Matrix hmd_matrix, Matrix rotatingMatrixForPelvis, Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Posef handPoseRight, Posef handPoseLeft, Matrix oriProjectionMatrix, sc_voxel mainarmparentmeshobject, Vector3 lightpos_, Vector3 dirLight_, Matrix finalRotationMatrix_, sc_voxel mainarmparentmeshobjectmain, Matrix hmd_matrix_current, Matrix extramatrix, Matrix hmdmatrixcurrentforpelvis)
        {
            ...
            /////HUMAN RIG////// 
            ////////////////////
            for (int _iterator = 0; _iterator < 1; _iterator++) // _player_torso[0][0]._arrayOfInstances.Length
            {
                ...
                Matrix finalRotationMatrix = finalRotationMatrix_ * somerotationmatrix;// originRot * rotatingMatrix * rotatingMatrixForPelvis * hmdrotMatrix;
        ...
        public sccs.scmessageobject.scmessageobjectjitter[][] ikbodyrender(sccs.scmessageobject.scmessageobjectjitter[][] _sc_jitter_tasks, Matrix viewMatrix, Matrix projectionMatrix, Vector3 OFFSETPOS, Matrix originRot, Matrix rotatingMatrix, Matrix hmdrotMatrix, Matrix hmd_matrix, Matrix rotatingMatrixForPelvis, Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Posef handPoseRight, Posef handPoseLeft, Matrix oriProjectionMatrix)
        {
            ...
            _cuber001.altinstancecount = _cuber001.InstanceCount;
            _cuber001.Render(sccs.scgraphics.scdirectx.D3D.Device.ImmediateContext);
            scupdate._shaderManager._rend_torso(sccs.scgraphics.scdirectx.D3D.Device.ImmediateContext, _cuber001.IndexCount, _cuber001.InstanceCount, _cuber001._POSITION, viewMatrix, projectionMatrix, null, _SC_modL_torso_BUFFER, _cuber001);
            _cuber001 = _player_pelvis[0][0];
            _cuber001.altinstancecount = _cuber001.InstanceCount;

            _cuber001.Render(sccs.scgraphics.scdirectx.D3D.Device.ImmediateContext);
            scupdate._shaderManager._rend_pelvis(sccs.scgraphics.scdirectx.D3D.Device.ImmediateContext, _cuber001.IndexCount, _cuber001.InstanceCount, _cuber001._POSITION, viewMatrix, projectionMatrix, null, _SC_modL_pelvis_BUFFER, _cuber001);

            //Console.WriteLine("frame arrives here");
            //_player_head[0][0].Render(sccs.scgraphics.scdirectx.D3D.Device.ImmediateContext);
            //updatePrim._shaderManager._rend_torso(sccs.scgraphics.scdirectx.D3D.Device.ImmediateContext, _player_head[0][0].IndexCount, _player_head[0][0].InstanceCount, _player_head[0][0]._POSITION, viewMatrix, projectionMatrix, null, _SC_modL_torso_BUFFER, _player_head[0][0]);

            return _sc_jitter_tasks;
        }

        public sccs.scmessageobject.scmessageobjectjitter[][] writeikbodytobuffer(sccs.scmessageobject.scmessageobjectjitter[][] _sc_jitter_tasks, Matrix viewMatrix, Matrix projectionMatrix, Vector3 OFFSETPOS, Matrix originRot, Matrix rotatingMatrix, Matrix hmdrotMatrix, Matrix hmd_matrix, Matrix rotatingMatrixForPelvis, Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Posef handPoseRight, Posef handPoseLeft, Matrix oriProjectionMatrix)
        {
        ...
        public sccs.scmessageobject.scmessageobjectjitter[][] createikarm(sccs.scmessageobject.scmessageobjectjitter[][] _sc_jitter_tasks, int tempMultiInstancePhysicsTotal, Vector3 ikarmpivotinitposition, sccsikvoxellimbs parentobject_, int somechunkpriminstanceikarmvoxelindex, int human_inst_limbs_x, int human_inst_limbs_y, int human_inst_limbs_z, int grabtargetitem_, int typeoflimb, sccsikvoxellimbs ikvoxellimb, Matrix finalrotationmatrix)
        {
            ...
            //_hasinit0 = _player_rght_shldr.Initialize(_sccs.scgraphics.scdirectx.D3D, _sccs.scgraphics.scdirectx.D3D.SurfaceWidth, _sccs.scgraphics.scdirectx.D3D.SurfaceHeight, _size_screen, 1, 1, 0.05f, 0.05f, 0.05f, new Vector4(r, g, b, a), instX, instY, instZ, Hwnd, initialmatrix, 9, offsetPosX, offsetPosY, offsetPosZ, vertOffsetX, vertOffsetY, vertOffsetZ); //, "terrainGrassDirt.bmp" //0.00035f
            //_hasinit0 = _player_rght_shldr[0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight, 1, 1, 1, 0.05f, 0.05f, 0.05f, new Vector4(r, g, b, a), _inst_p_r_shoulder_x, _inst_p_r_shoulder_y, _inst_p_r_shoulder_z, Hwnd, initialmatrix, 2, offsetPosX, offsetPosY, offsetPosZ, World, sccs.scgraphics.scdirectx.BodyTag.PlayerShoulderRight, _static, 1, _mass, 0, 0, 0); //, "terrainGrassDirt.bmp" //0.00035f
            float _mass = 100;
            //voxel_general_size =  voxeliknewsize;
            //voxel_type = 0;
            _type_of_cube = 2;
            ...
            //_player_rght_shldr[0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight, 1, 1, 1, 0.05f, 0.05f, 0.05f, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Hwnd, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, World, _mass, false, sccs.scgraphics.scdirectx.BodyTag.PlayerShoulderRight, 10, 10, 10, 10, 10, 10, 4, 3, 20, 19, 20, 19, 0.0025f, Vector3.Zero, 300); //, "terrainGrassDirt.bmp" //0.00035f
            //_player_rght_shldr[0][0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight, 0, 1, 1, 1, 0.05f, 0.05f, 0.05f, new Vector4(r, g, b, a), _inst_p_r_shoulder_x, _inst_p_r_shoulder_y, _inst_p_r_shoulder_z, Program.consoleHandle, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static, sccs.scgraphics.scdirectx.BodyTag.PlayerShoulderRight, 9, 9, 9, 9, 9, 9, 9, 9, 9, 20, 19, 20, 19, 20, 19, voxel_general_size, new Vector3(0, 0, 0), 17, vertoffsetx, vertoffsety, vertoffsetz, _addToWorld, voxel_type); //, "terrainGrassDirt.bmp" //0.00035f
            _player_rght_shldr[0][0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight,
                ...
                initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static, sccs.scgraphics.scdirectx.BodyTag.PlayerShoulderRight,
            ...
            //_hasinit0 = _player_rght_upper_arm.Initialize(_sccs.scgraphics.scdirectx.D3D, _sccs.scgraphics.scdirectx.D3D.SurfaceWidth, _sccs.scgraphics.scdirectx.D3D.SurfaceHeight, _size_screen, 1, 1, 0.035f, 0.10550f, 0.035f, new Vector4(r, g, b, a), instX, instY, instZ, Hwnd, initialmatrix, 0, offsetPosX, offsetPosY, offsetPosZ, vertOffsetX, vertOffsetY, vertOffsetZ); //, "terrainGrassDirt.bmp" //0.00035f
            //_hasinit0 = _player_rght_upper_arm[0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight, 1, 1, 1, 0.035f, 0.10550f, 0.035f, new Vector4(r, g, b, a), _inst_p_r_upperarm_x, _inst_p_r_upperarm_y, _inst_p_r_upperarm_z, Hwnd, initialmatrix, 2, offsetPosX, offsetPosY, offsetPosZ, World, sccs.scgraphics.scdirectx.BodyTag.PlayerUpperArmRight, _static, 1, _mass, 0, 0, 0); //, "terrainGrassDirt.bmp" //0.00035f
            //voxel_general_size =  voxeliknewsize;
            //voxel_type = 0;
            //13, 12, 40, 39, 13, 12,
            ...
            //_player_rght_upper_arm[0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight, 1, 1, 1, 0.05f, 0.05f, 0.05f, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Hwnd, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, World, _mass, false, sccs.scgraphics.scdirectx.BodyTag.PlayerUpperArmRight, 10, 10, 10, 10, 10, 10, 4, 3, 20, 19, 20, 19, 0.0025f, Vector3.Zero, 300); //, "terrainGrassDirt.bmp" //0.00035f
            _player_rght_upper_arm[0][0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight, 0, 1, 1, 1, sizelowerax, sizeloweray, sizeloweraz, new Vector4(r, g, b, a),
            ...
            */
            ...
            //_player_rght_upper_arm[0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight, 1, 1, 1, 0.05f, 0.05f, 0.05f, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Hwnd, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, World, _mass, false, sccs.scgraphics.scdirectx.BodyTag.PlayerUpperArmRight, 10, 10, 10, 10, 10, 10, 4, 3, 20, 19, 20, 19, 0.0025f, Vector3.Zero, 300); //, "terrainGrassDirt.bmp" //0.00035f
            _player_rght_lower_arm[0][0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight, 0, 1, 1, 1, sizelowerax, sizeloweray, sizeloweraz, new Vector4(r, g, b, a),
            _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Program.consoleHandle, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static,
            ...
            //_hasinit0 = _player_rght_elbow_target.Initialize(_sccs.scgraphics.scdirectx.D3D, _sccs.scgraphics.scdirectx.D3D.SurfaceWidth, _sccs.scgraphics.scdirectx.D3D.SurfaceHeight, _size_screen, 1, 1, 0.075f, 0.075f, 0.075f, new Vector4(r, g, b, a), instX, instY, instZ, Hwnd, initialmatrix, 0, offsetPosX, offsetPosY, offsetPosZ, vertOffsetX, vertOffsetY, vertOffsetZ); //, "terrainGrassDirt.bmp" //0.00035f
            //_hasinit0 = _player_rght_elbow_target[0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight, 1, 1, 1, 0.075f, 0.075f, 0.075f, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Hwnd, initialmatrix, 2, offsetPosX, offsetPosY, offsetPosZ, World, sccs.scgraphics.scdirectx.BodyTag.PlayerRightElbowTarget, _static, 1, _mass, 0, 0, 0); //, "terrainGrassDirt.bmp" //0.00035f
            //voxel_general_size =  voxeliknewsize;
            //voxel_type = 0;
            _type_of_cube = 2;
            _player_rght_elbow_target[0][0] = new sc_voxel();
            _player_rght_elbow_target[0][0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight,
                ...
                initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static, sccs.scgraphics.scdirectx.BodyTag.PlayerRightElbowTarget,
                      minx, miny, minz, diagmaxx, diagmaxy, diagmaxz, diagminx, diagminy, diagminz, chunkwidthl, chunkwidthr, chunkheightl, chunkheightr, chunkdepthl, chunkdepthr, 
            ...
            _player_rght_elbow_target_two[0][0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight, 0, 1, 1, 1, sizelowerax, sizeloweray, sizeloweraz,
            ...
            _player_rght_elbow_target_three[0][0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight, 0, 1, 1, 1, sizelowerax, sizeloweray, sizeloweraz, 
                new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Program.consoleHandle, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, 
                _thejitter_world, _mass, is_static, sccs.scgraphics.scdirectx.BodyTag.PlayerRightElbowTargettwo,
                minx, miny, minz, diagmaxx, diagmaxy, diagmaxz, diagminx, diagminy, diagminz, chunkwidthl, chunkwidthr, chunkheightl, chunkheightr, chunkdepthl, chunkdepthr,
            ...
            _player_rght_hnd[0][0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight,
                0, 1, 1, 1, sizelowerax, sizeloweray, sizeloweraz, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Program.consoleHandle,
                initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static, sccs.scgraphics.scdirectx.BodyTag.PlayerHandRight,
            ...
            _SC_modL_rght_shldr_BUFFER[0] = new sccs.sc_voxel.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            _SC_modL_rght_elbow_target_BUFFER[0] = new sccs.sc_voxel.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            _SC_modL_rght_elbow_target_two_BUFFER[0] = new sccs.sc_voxel.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            _SC_modL_rght_upper_arm_BUFFER[0] = new sccs.sc_voxel.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
                ...
                lightPosition = lightpos,
                padding1 = 100
            }; _SC_modL_rght_lower_arm_BUFFER[0] = new sccs.sc_voxel.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            _SC_modL_rght_hnd_BUFFER[0] = new sccs.sc_voxel.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            _SC_modL_r_hand_grab_BUFFER[0] = new sccs.sc_voxel.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
        ...
        public sccs.scmessageobject.scmessageobjectjitter[][] createikfingers(sccs.scmessageobject.scmessageobjectjitter[][] _sc_jitter_tasks, int tempMultiInstancePhysicsTotal, Vector3 ikarmpivotinitposition, sccsikvoxellimbs parentobject_, int somechunkpriminstanceikarmvoxelindex, int human_inst_limbs_x, int human_inst_limbs_y, int human_inst_limbs_z, int grabtargetitem_, int typeoflimb, sccsikvoxellimbs ikvoxellimb, int somechunkpriminstanceikfingervoxelindex)
        {
            ...
            //_player_rght_upper_arm[0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight, 1, 1, 1, 0.05f, 0.05f, 0.05f, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Hwnd, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, World, _mass, false, sccs.scgraphics.scdirectx.BodyTag.PlayerUpperArmRight, 10, 10, 10, 10, 10, 10, 4, 3, 20, 19, 20, 19, 0.0025f, Vector3.Zero, 300); //, "terrainGrassDirt.bmp" //0.00035f
            _player_rght_upper_arm[0][0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight,
                0, 1, 1, 1, sizelowerax, sizeloweray, sizeloweraz, new Vector4(r, g, b, a),
            _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Program.consoleHandle, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static,
            sccs.scgraphics.scdirectx.BodyTag.PlayerUpperArmRight,
            //9, 9, 9, 14, 14, 14, 14, 14, 14, 13, 12, 40, 39, 13, 12,
            ...
            */
            ...
            //_hasinit0 = _player_lft_lower_arm.Initialize(_sccs.scgraphics.scdirectx.D3D, _sccs.scgraphics.scdirectx.D3D.SurfaceWidth, _sccs.scgraphics.scdirectx.D3D.SurfaceHeight, _size_screen, 1, 1, 0.035f, 0.08250f, 0.035f, new Vector4(r, g, b, a), instX, instY, instZ, Hwnd, initialmatrix, 0, offsetPosX, offsetPosY, offsetPosZ, vertOffsetX, vertOffsetY, vertOffsetZ); //, "terrainGrassDirt.bmp" //0.00035f
            //_hasinit0 = _player_lft_lower_arm[0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight, 1, 1, 1, 0.035f, 0.08250f, 0.035f, new Vector4(r, g, b, a), _inst_p_l_lowerarm_x, _inst_p_l_lowerarm_y, _inst_p_l_lowerarm_z, Hwnd, initialmatrix, 2, offsetPosX, offsetPosY, offsetPosZ, World, sccs.scgraphics.scdirectx.BodyTag.PlayerLowerArmLeft, _static, 1, _mass, 0, 0, 0); //, "terrainGrassDirt.bmp" //0.00035f
            //voxel_general_size =  voxeliknewsize;
            //voxel_type = 0;
            _type_of_cube = 2;
            ...
            _player_rght_elbow_target[0][0] = new sc_voxel();
            _player_rght_elbow_target[0][0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight, 0, 1, 1, 1,
            ...
            _type_of_cube = 2;
            _player_rght_elbow_target_two[0][0] = new sc_voxel();
            _player_rght_elbow_target_two[0][0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight, 0, 1, 1, 1,
                 sizelowerax, sizeloweray, sizeloweraz, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Program.consoleHandle,
            ...
            _type_of_cube = 2;
            _player_rght_elbow_target_three[0][0] = new sc_voxel();
            _player_rght_elbow_target_three[0][0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight,
                0, 1, 1, 1, sizelowerax, sizeloweray, sizeloweraz, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Program.consoleHandle,
                initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static, sccs.scgraphics.scdirectx.BodyTag.PlayerRightElbowTargettwo,
               minx, miny, minz, diagmaxx, diagmaxy, diagmaxz, diagminx, diagminy, diagminz, chunkwidthl, chunkwidthr, chunkheightl, chunkheightr, chunkdepthl, chunkdepthr,
            ...
            if (grabtargetitem == 0)
            {
                ...
                */
                ...
                distance = 10;
                _player_r_hand_grab[0][0] = new sc_voxel();
                _player_r_hand_grab[0][0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight, 0, 1, 1, 1, 0.05f, 0.05f, 0.05f, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Program.consoleHandle, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static, sccs.scgraphics.scdirectx.BodyTag.PlayerRightHandGrabTarget, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, voxel_general_size, new Vector3(0, 0, -0.1f), distance, vertoffsetx, vertoffsety, vertoffsetz, _addToWorld, voxel_type); //, "terrainGrassDirt.bmp" //0.00035f
                //_player_r_hand_grab[0][0].Initialize(sccs.scgraphics.scdirectx.D3D, sccs.scgraphics.scdirectx.D3D.SurfaceWidth, sccs.scgraphics.scdirectx.D3D.SurfaceHeight, 0, 1, 1, 1, 0.0125f, 0.035f, 0.055f, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Program.consoleHandle, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static, sccs.scgraphics.scdirectx.BodyTag.PlayerRightHandGrabTarget, 3, 3, 3, 3, 3, 3, 3, 3, 3, 4, 3, 65, 64, 40, 39, voxel_general_size, new Vector3(0, 0, -0.1f), distance, vertoffsetx, vertoffsety, vertoffsetz, _addToWorld, voxel_type); //, "terrainGrassDirt.bmp" //0.00035f
                worldMatrix_instances_r_hand_grab[0][0] = new Matrix[_inst_p_r_hand_x * _inst_p_r_hand_y * _inst_p_r_hand_z];
                for (int i = 0; i < worldMatrix_instances_r_hand_grab[0][0].Length; i++)
                {
        ...
        public sccs.scmessageobject.scmessageobjectjitter[][] setiktargetnlimbspositionsNrotations(sccs.scmessageobject.scmessageobjectjitter[][] _sc_jitter_tasks, Matrix viewMatrix, Matrix projectionMatrix, Vector3 OFFSETPOS, Matrix originRot, Matrix rotatingMatrix, Matrix hmdrotMatrix, Matrix hmd_matrix, Matrix rotatingMatrixForPelvis, Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Posef handPoseRight, Posef handPoseLeft, Matrix oriProjectionMatrix, sc_voxel mainarmparentmeshobject, Vector3 lightpos_, Vector3 dirLight_, Matrix finalRotationMatrix_, sc_voxel mainarmparentmeshobjectmain, sccsikvoxellimbs ikvoxelbody, int somechunkpriminstanceikarmvoxelindex, Matrix hmd_matrix_current, Matrix extramatrix, Vector3[] directionvectoroffsets_, Vector3 targetfootleft, Vector3 targetfootright, int typeoflimb)
        {
            ...
            /////HUMAN RIG////// 
            ////////////////////
            for (int _iterator = 0; _iterator < 1; _iterator++) // //_player_rght_hnd[0][0]._arrayOfInstances.Length
            {
                ...
                if (somechunkpriminstanceikarmvoxelindex == 0)
                {
                    ...
                    var somematrighttouch = _rightTouchMatrix;
                    somematrighttouch.M41 = handPoseRight.Position.X + MOVINGPOINTER.X;
                    somematrighttouch.M42 = handPoseRight.Position.Y + MOVINGPOINTER.Y;
                    somematrighttouch.M43 = handPoseRight.Position.Z + MOVINGPOINTER.Z;

                    diffNormPosX = (MOVINGPOINTER.X) - somematrighttouch.M41;
                    diffNormPosY = (MOVINGPOINTER.Y) - somematrighttouch.M42;
                    diffNormPosZ = (MOVINGPOINTER.Z) - somematrighttouch.M43;
                    ...
                    //somematrighttouch.Invert();

                    matrixerer = somematrighttouch * somematrix;
                ...
                else if (somechunkpriminstanceikarmvoxelindex == 3)
                {
                    ...
                    var somematlefttouch = _leftTouchMatrix;
                    somematlefttouch.M41 = handPoseLeft.Position.X + MOVINGPOINTER.X;
                    somematlefttouch.M42 = handPoseLeft.Position.Y + MOVINGPOINTER.Y;
                    somematlefttouch.M43 = handPoseLeft.Position.Z + MOVINGPOINTER.Z;

                    diffNormPosX = (MOVINGPOINTER.X) - somematlefttouch.M41;
                    diffNormPosY = (MOVINGPOINTER.Y) - somematlefttouch.M42;
                    diffNormPosZ = (MOVINGPOINTER.Z) - somematlefttouch.M43;
                ...
                float someplanesizediv = 1 / sccs.scgraphicssec.currentscgraphicssec.planesizetilesforik;

                int someposdiffx = (int)(((float)Math.Floor(OFFSETPOS.X * someplanesizediv) / someplanesizediv) / (sccs.scgraphicssec.currentscgraphicssec.planesizetilesforik));
                int someposdiffy = (int)(((float)Math.Floor(OFFSETPOS.Y * someplanesizediv) / someplanesizediv) / (sccs.scgraphicssec.currentscgraphicssec.planesizetilesforik));
                int someposdiffz = (int)(((float)Math.Floor(OFFSETPOS.Z * someplanesizediv) / someplanesizediv) / (sccs.scgraphicssec.currentscgraphicssec.planesizetilesforik));
            ...
            for (int _iterator = 0; _iterator < 1; _iterator++) // //_player_rght_hnd[0][0]._arrayOfInstances.Length
            {
                ...
                */
                ...
                else if (somechunkpriminstanceikarmvoxelindex == 1)
                {
                    ...
                    /*if (sccsvvdhd.updateSec.typeofsensortouchL != 9999999)
                    {
                        if (somechunkpriminstanceikfingervoxelindex != 3)
                        {
                            //Vector3 tempVect = Vector3.Zero;
                            if (sccsvvdhd.updateSec.handTriggerLeft[0] > 0.00000001f)
                            {
                                somevec0 = (somevec0) + (-dirshoulderup0 * ((lengthOfHandheight * sccsvvdhd.updateSec.handTriggerLeft[0] * 0.5f)));
                            }
                            else
                            {
                            ...
                            if (sccsvvdhd.updateSec.handTriggerLeft[0] > 0.00000001f) ///when over 0.52f
                            {
                                somevec0 = (somevec0) + (dirshoulderforward0 * ((lengthOfHandheight * (1 - sccsvvdhd.updateSec.handTriggerLeft[0]) * 0.5f)));
                            }
                            else
                            {
                                somevec0 = (somevec0) + (dirshoulderforward0 * ((lengthOfHandheight * 0.5f * 1.0923f)));
                ...
                else if (somechunkpriminstanceikarmvoxelindex == 2)
                {
                    ...
                    /*
                    if (sccsvvdhd.updateSec.typeofsensortouchR != 9999999)
                    {
                        if (somechunkpriminstanceikfingervoxelindex != 1)
                        {
                            //Vector3 tempVect = Vector3.Zero;
                            if (sccsvvdhd.updateSec.handTriggerRight[1] > 0.00000001f)
                            {
                                somevec0 = (somevec0) + (-dirshoulderup0 * ((lengthOfHandheight * sccsvvdhd.updateSec.handTriggerRight[1] * 0.5f)));
                            }
                            else
                            {
                                somevec0 = (somevec0) + (-dirshoulderup0 * ((lengthOfHandheight * 0.05f * 1.0923f)));
                            ...
                            if (sccsvvdhd.updateSec.handTriggerRight[1] > 0.00000001f) ///when over 0.52f
                            {
                                somevec0 = (somevec0) + (dirshoulderforward0 * ((lengthOfHandheight * (1 - sccsvvdhd.updateSec.handTriggerRight[1]) * 0.5f)));
                            }
                            else
                            {
                                somevec0 = (somevec0) + (dirshoulderforward0 * ((lengthOfHandheight * 0.5f * 1.0923f)));
        ...
        public sccs.scmessageobject.scmessageobjectjitter[][] ikarmrender(sccs.scmessageobject.scmessageobjectjitter[][] _sc_jitter_tasks, Matrix viewMatrix, Matrix projectionMatrix, Vector3 OFFSETPOS, Matrix originRot, Matrix rotatingMatrix, Matrix hmdrotMatrix, Matrix hmd_matrix, Matrix rotatingMatrixForPelvis, Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Posef handPoseRight, Posef handPoseLeft, Matrix oriProjectionMatrix)
        {

            var _cuber001 = _player_rght_shldr[0][0];
            _cuber001.altinstancecount = _cuber001.InstanceCount;
            _cuber001.Render(sccs.scgraphics.scdirectx.D3D.Device.ImmediateContext);
            scupdate._shaderManager._rend_rgt_hnd(sccs.scgraphics.scdirectx.D3D.Device.ImmediateContext, _cuber001.IndexCount, _cuber001.InstanceCount, _cuber001._POSITION, viewMatrix, projectionMatrix, null, _SC_modL_rght_hnd_BUFFER, _cuber001);
            
            _cuber001 = _player_rght_shldr[0][0];
            _cuber001.altinstancecount = _cuber001.InstanceCount;
            _cuber001.Render(sccs.scgraphics.scdirectx.D3D.Device.ImmediateContext);
            scupdate._shaderManager._rend_rgt_shldr(sccs.scgraphics.scdirectx.D3D.Device.ImmediateContext, _cuber001.IndexCount, _cuber001.InstanceCount, _cuber001._POSITION, viewMatrix, projectionMatrix, null, _SC_modL_rght_shldr_BUFFER, _cuber001);
            
            _cuber001 = _player_rght_lower_arm[0][0];
            _cuber001.altinstancecount = _cuber001.InstanceCount;
            _cuber001.Render(sccs.scgraphics.scdirectx.D3D.Device.ImmediateContext);
            scupdate._shaderManager._rend_rgt_lower_arm(sccs.scgraphics.scdirectx.D3D.Device.ImmediateContext, _cuber001.IndexCount, _cuber001.InstanceCount, _cuber001._POSITION, viewMatrix, projectionMatrix, null, _SC_modL_rght_lower_arm_BUFFER, _cuber001);
            
            
            _cuber001 = _player_rght_upper_arm[0][0];
            _cuber001.altinstancecount = _cuber001.InstanceCount;
            _cuber001.Render(sccs.scgraphics.scdirectx.D3D.Device.ImmediateContext);
            scupdate._shaderManager._rend_rgt_upper_arm(sccs.scgraphics.scdirectx.D3D.Device.ImmediateContext, _cuber001.IndexCount, _cuber001.InstanceCount, _cuber001._POSITION, viewMatrix, projectionMatrix, null, _SC_modL_rght_upper_arm_BUFFER, _cuber001);
            //IK TARGETS UPPER BODY.


            /*
            var _cuber01 = _player_rght_elbow_target[0][0];
            _cuber01.Render(sccs.scgraphics.scdirectx.D3D.Device.ImmediateContext);
            updatePrim._shaderManager._rend_rgt_elbow_targ(sccs.scgraphics.scdirectx.D3D.Device.ImmediateContext, _cuber01.IndexCount, _cuber01.InstanceCount, _cuber01._POSITION, viewMatrix, projectionMatrix, null, _SC_modL_rght_hnd_BUFFER, _cuber01);

            _cuber01 = _player_rght_elbow_target_two[0][0];
            _cuber01.Render(sccs.scgraphics.scdirectx.D3D.Device.ImmediateContext);
            updatePrim._shaderManager._rend_rgt_elbow_targ_two(sccs.scgraphics.scdirectx.D3D.Device.ImmediateContext, _cuber01.IndexCount, _cuber01.InstanceCount, _cuber01._POSITION, viewMatrix, projectionMatrix, null, _SC_modL_rght_hnd_BUFFER, _cuber01);
            _cuber01 = _player_r_hand_grab[0][0];
            _cuber01.Render(sccs.scgraphics.scdirectx.D3D.Device.ImmediateContext);
            updatePrim._shaderManager._rend_rgt_hnd(sccs.scgraphics.scdirectx.D3D.Device.ImmediateContext, _cuber01.IndexCount, _cuber01.InstanceCount, _cuber01._POSITION, viewMatrix, projectionMatrix, null, _SC_modL_r_hand_grab_BUFFER, _cuber01);
        ...
        public sccs.scmessageobject.scmessageobjectjitter[][] ikfingerrender(sccs.scmessageobject.scmessageobjectjitter[][] _sc_jitter_tasks, Matrix viewMatrix, Matrix projectionMatrix, Vector3 OFFSETPOS, Matrix originRot, Matrix rotatingMatrix, Matrix hmdrotMatrix, Matrix hmd_matrix, Matrix rotatingMatrixForPelvis, Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Posef handPoseRight, Posef handPoseLeft, Matrix oriProjectionMatrix)
        {

            _player_rght_hnd[0][0].Render(sccs.scgraphics.scdirectx.D3D.Device.ImmediateContext);
            scupdate._shaderManager._rend_rgt_hnd(sccs.scgraphics.scdirectx.D3D.Device.ImmediateContext, _player_rght_hnd[0][0].IndexCount, _player_rght_hnd[0][0].InstanceCount, _player_rght_hnd[0][0]._POSITION, viewMatrix, projectionMatrix, null, _SC_modL_rght_hnd_BUFFER, _player_rght_hnd[0][0]);
            var _cuber001 = _player_rght_shldr[0][0];
            _cuber001.altinstancecount = _cuber001.InstanceCount;
        ...
        public sccs.scmessageobject.scmessageobjectjitter[][] writeikarmtobuffer(sccs.scmessageobject.scmessageobjectjitter[][] _sc_jitter_tasks, Matrix viewMatrix, Matrix projectionMatrix, Vector3 OFFSETPOS, Matrix originRot, Matrix rotatingMatrix, Matrix hmdrotMatrix, Matrix hmd_matrix, Matrix rotatingMatrixForPelvis, Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Posef handPoseRight, Posef handPoseLeft, Matrix oriProjectionMatrix)
        {
        ...
        public sccs.scmessageobject.scmessageobjectjitter[][] writeikfingertobuffer(sccs.scmessageobject.scmessageobjectjitter[][] _sc_jitter_tasks, Matrix viewMatrix, Matrix projectionMatrix, Vector3 OFFSETPOS, Matrix originRot, Matrix rotatingMatrix, Matrix hmdrotMatrix, Matrix hmd_matrix, Matrix rotatingMatrixForPelvis, Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Posef handPoseRight, Posef handPoseLeft, Matrix oriProjectionMatrix)
        {
