...
{ 
	...
	facetype = int(trunc(input.color.w));

	//int isfrontfacelinkedvertex = int(round(input.color.w - round(input.color.w)));
	int isfrontfacelinkedvertex = int(trunc(round((input.color.w - round(input.color.w)) * 10.0f)));
