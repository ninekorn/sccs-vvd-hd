...
namespace sccs
{
    public class SC_cube : ITransform, IComponent
    {
        ...
        public int alternateinstancescount = 0;
        public int indexofshader;
        ...
        public SC_cube.DInstanceData[] instancesDataRIGHT { get; set; }
        public SC_cube.DInstanceData[] instancesDataUP { get; set; }
        ...
        public SC_cube() { }
        public scdirectx.BodyTag _tag;
        public bool Initialize(scdirectx D3D, int width, int height, float tileSize, int divX, int divY, float _sizeX, float _sizeY, float _sizeZ, Vector4 color, int instX, int instY, int instZ, IntPtr windowsHandle, Matrix matroxer, int isTerrain, float offsetPosX, float offsetPosY, float offsetPosZ, World the_world, scdirectx.BodyTag tag, bool is_static, int addtoworld, float mass, float vertoffsetx, float vertoffsety, float vertoffsetz)
        {
        ...
        private bool InitializeBuffer(scdirectx D3D, float _sizeX, float _sizeY, float _sizeZ, float tileSize, int instX, int instY, int instZ, IntPtr windowsHandle, Matrix matroxer, int type_of_cube, float offsetPosX, float offsetPosY, float offsetPosZ, float vertoffsetx, float vertoffsety, float vertoffsetz)
        {
            try
            {
                int tessellation = 3;
                ...
                if (type_of_cube == 0 || type_of_cube == 2 || type_of_cube == 3 || type_of_cube == 4 || type_of_cube == 5)
                {
                    ...
                    new DVertex() //12
                    {
                     ...
                     new DVertex()
                     {
                         position = new Vector3((-1+vertoffsetx)*_sizeX, (-1+vertoffsety)*_sizeY, (1+vertoffsetz)*_sizeZ) , //bottom left
                         texture = new Vector2(0, -1),
                         color = _color,
                     ...
                     new DVertex()
                     {
                         position = new Vector3((1+vertoffsetx)*_sizeX, (-1+vertoffsety)*_sizeY, (1+vertoffsetz)*_sizeZ) , //bottom right
                         texture = new Vector2(1, -1),
                         color = _color,
                         normal = new Vector3(0, 1, 0),
                     },
                     new DVertex()
                     {
                         position = new Vector3((1+vertoffsetx)*_sizeX, (1+vertoffsety)*_sizeY,(1+vertoffsetz)*_sizeZ) , //top right
                         texture = new Vector2(1, 0),
                         color = _color,
                         normal = new Vector3(0, 1, 0),
                     },
                     ...
                     new DVertex()
                     {
                         position = new Vector3((-1+vertoffsetx)*_sizeX, (1+vertoffsety)*_sizeY, (1+vertoffsetz)*_sizeZ) , //top left
                         texture = new Vector2(0, 0),
                         color = _color,
                         normal = new Vector3(0, 1, 0),
                     },
                ...
                alternateinstancescount = instances.Length;
        ...
        private void ShutDownBuffers()
        {
            ...
            if (InstanceRotationBuffer != null)
            {
            ...
            if (InstanceRotationMatrixBuffer != null)
            {
