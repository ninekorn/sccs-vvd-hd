            ...
            for (int _iterator = 0; _iterator < _human_inst_rig_x * _human_inst_rig_y * _human_inst_rig_z; _iterator++) // //_player_rght_hnd[0][0]._arrayOfInstances.Length
            {
                ...
                if (somechunkpriminstanceikarmvoxelindex == 0)
                {
                    ...
                    */
                    ...
                    var originposshoulder = new Vector3(_player_rght_shldr[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M41, _player_rght_shldr[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M42, _player_rght_shldr[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M43);
                    //var originposshoulder = new Vector3(_player_rght_hnd[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M41, _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M42, _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M43);
                    ...
                    Vector3 thehandpos = new Vector3(_player_r_hand_grab[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_r_hand_grab[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_r_hand_grab[0][0]._arrayOfInstances[_iterator].current_pos.M43);

                    var posshoulder = thehandpos + (dirtorsou * ikvoxelbody._player_torso[0][0]._total_torso_height * 0.5f);
                    posshoulder = posshoulder + (dirtorsor * diffNormPosX);
                    ...
                    var somematlefttouch = _player_r_hand_grab[0][0]._arrayOfInstances[_iterator].current_pos; //_leftTouchMatrix;
                    ...
                    /*
                    var finalhandmatrix = somematlefttouch;
                    Quaternion.RotationMatrix(ref shouldermatrix, out otherQuat);
                    direction_head_forward = sc_maths._getDirection(Vector3.ForwardRH, otherQuat);
                    direction_head_right = sc_maths._getDirection(Vector3.Right, otherQuat);
                    direction_head_up = sc_maths._getDirection(Vector3.Up, otherQuat);
                    Matrix thefinalhandmatrix = Matrix.LookAtLH(somehandposleft, somehandposleft + direction_head_forward, direction_head_up);
                    thefinalhandmatrix.Invert();*/

                    /*
                    var lowerarmmatrixrot = _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator].current_pos;
                    var shouldermatrix = _player_rght_shldr[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION;
                    ...
                    */
                    ...
                    /*var somematrighttouch = somematlefttouch;
                    somematrighttouch.M41 = somehandposleft.X + MOVINGPOINTER.X;
                    somematrighttouch.M42 = somehandposleft.Y + MOVINGPOINTER.Y;
                    somematrighttouch.M43 = somehandposleft.Z + MOVINGPOINTER.Z;
                    ...
                    matrixerer.M41 = somehandposleft.X;
                    matrixerer.M42 = somehandposleft.Y;
                    matrixerer.M43 = somehandposleft.Z;
                    matrixerer.M44 = 1;*/
                ...
                else if (somechunkpriminstanceikarmvoxelindex == 3)
                {
                    ...
                    var thegrabmatrix = _player_r_hand_grab[0][0]._arrayOfInstances[_iterator].current_pos; //_leftTouchMatrix;
                    //var thehandmatrix = _player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos; //_leftTouchMatrix;

                    //var finalhandmatrix = somematlefttouch;
                    Quaternion.RotationMatrix(ref thegrabmatrix, out otherQuat);
                    direction_head_forward = sc_maths._getDirection(Vector3.ForwardRH, otherQuat);
                    direction_head_right = sc_maths._getDirection(Vector3.Right, otherQuat);
                    direction_head_up = sc_maths._getDirection(Vector3.Up, otherQuat);
                    Matrix thefinalhandmatrix = Matrix.LookAtLH(somehandposleft, somehandposleft + direction_head_forward, direction_head_up);
                    ...
                    matrixerer = thefinalhandmatrix * finalRotationMatrix;// * somematrix;
                    matrixerer.M41 = MOVINGPOINTER.X;
                    matrixerer.M42 = MOVINGPOINTER.Y;
                    matrixerer.M43 = MOVINGPOINTER.Z;
                    matrixerer.M44 = 1;
