...
I cannot find the proper icon in order to be able to display to people the number of clones of my earlier repositories, so sometimes i take screenshots but not all of the time. Sometimes i streamed my github insight/traffic page instead. Down below are screenshots of different repositories holding my development on my homemade projects and the online traffic that my releases/revisions generated.
