...
namespace Win32.Shared
{
    public class DxWindow : IDisposable
    {
        ...
        public void Show()
        {
            using RenderForm form = new RenderForm(_title);
            ...
            var swapChainDescription = new SwapChainDescription
            {
                ...
                IsWindowed = true,
                ModeDescription = new ModeDescription(form.Width, form.Height, new Rational(60, 1), Format.B8G8R8A8_UNorm),
            ...
            var path = @"C:\Users\steve\Documents\GitHub\sccs\releases\sccsr13rm - 8x8x8-paddingfixed\sccsr14forms\mikasc\Shader.fx";
            ...
            device.ImmediateContext.Rasterizer.SetViewport(0, 0, form.Width, form.Height);
            ...
            RenderLoop.Run(form, () =>
            {
                ...
                if (isResized)
                {
                    ...
                    swapChain1.ResizeBuffers(swapChainDescription.BufferCount, form.Width, form.Height, Format.Unknown, SwapChainFlags.None);
