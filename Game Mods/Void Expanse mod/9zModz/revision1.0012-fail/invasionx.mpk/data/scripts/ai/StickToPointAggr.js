/*
 ...
 Desc:
 Npc sticks to one point, which is specified in tags (stick_coords_x, stick_coords_y)
...
function Decision(args)
{
    ...
    {
        var coord_x = npc.GetTag(SHIP_ID, "stick_coords_x");
        var coord_y = npc.GetTag(SHIP_ID, "stick_coords_y");
        npc.StickToPoint(SHIP_ID, coord_x, coord_y, stickradius);
    }
