...
include(SC_AI_Drone_Combat_cc_Rout_For_4.js);
include(SC_AI_Drone_Combat_cc_Rout_For_FWP_4.js);
include(SC_AI_Drone_Combat_Sta_aRep_4.js);
...
var SC_AI_Drone_Combat_cc_Core_4 =
{
...
function AICoreComputeObjective(currentObjective, addFriendSwitch) {
    ...
    switch (currentObjective.name) {
        case "get_in_formation":
            {
                SC_AI_Drone_Combat_cc_Rout_For_4.AIRoutineInit(currentObjective, addFriendSwitch);
                break;
            }
        case "station_vicinity":
            {            
                ...
                {              
                    ...
                    {                  
                        var aRepStatus = SC_AI_Drone_Combat_Sta_aRep_4.AIaRep(currentObjective, globIndex);
...
else
{
    ...
    {
        //var currentFormationWaypoint = SC_AI_Drone_Combat_cc_Rout_For_FWP_4.npcGWFP(currentObjective);
