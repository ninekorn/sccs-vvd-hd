...
include(SC_AI_Drone_Mining_Rout_For_SFWP_3.js);
include(SC_AI_Drone_Mining_Rout_Com_FndTarg_3.js);
include(SC_AI_Drone_Mining_InventoryChecks_3.js);

var tempLceData = null;
var dataToReturn = null;

var SC_AI_Drone_Mining_Rout_Com_3 =
{
    AICombatRoutine: function (cData, ceData)
    {  
		if(cData.objt.command == 0)
		{
			cData = SC_AI_Drone_Mining_Rout_For_SFWP_3.npcStayInFormation(cData);
		}
		else if(cData.objt.command == 11)
		{
			tempLceData = SC_AI_Drone_Mining_Rout_Com_FndTarg_3.npcFindTarget(cData);
			cData = tempLceData;
		}
...
function AIDepositMineralsInsidePlayersCargo(cData)
{
	...
	var isPlayerInventoryFull = SC_AI_Drone_Mining_InventoryChecks_3.AIIsPlayerCargoFull(cData.objt.pid);
