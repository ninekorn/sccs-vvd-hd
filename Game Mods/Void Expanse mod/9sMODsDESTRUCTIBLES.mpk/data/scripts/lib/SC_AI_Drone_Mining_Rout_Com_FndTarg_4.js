...
include(SC_AI_Drone_Mining_Rout_For_SFWPP_4.js);

var listOfAsteroids = [];
var lastListOfAsteroids = [];
var test;

var SC_AI_Drone_Mining_Rout_Com_FndTarg_4 =
{
    ...
    {		
		...
		if(cData.lLSwtc == 0)
		{
			var isNpcInventoryFull = SC_AI_Drone_Mining_InventoryChecks_4.AICheckStateOfInventory(cData.objt.nid);
		...
		else if(cData.lLSwtc == 2)
		{
			...
			if(distToAst <= 6)
			{
				...
				if(cData.mSwtc != 9)
				{	
					cData = SC_AI_Drone_Mining_Rout_For_SFWPP_4.npcPathfindToWaypoint(cData);
				}
				else
				{
