...
var SC_AI_Drone_Combat_cc_Rout_For_SFWPP_5 =
{
    npcPathfindToWaypoint: function (cData) //cData.nData, cData.pData, cData.objt, cData.cFWP,cData.cFWPD
    {
        ...
        //console.PrintError("form:" + cData.objt.formation + "/nid:" + cData.objt.nid + "/cFWPD:" + waypointDist + "/mSwtc:" + cData.mSwtc + "/pfc: " + cData.pfc + "/forceRetracePath:" + forceUseRetracePathSwtc); // + " SC_AI_Drone_Combat_cc_Rout_For_SFWPP_5.js "
        ...
        if (cData.mSwtc == 1) {
            ...
            {
                //---//////console.PrintError("this pathfind start has the same SC_AI_Drone_Combat_cc_Rout_For_SFWPP_5.js");
            }
            ...
            var pathData = SC_PathFindInitGrid_Data_cc_5_merge.npcGetGridDataMerged(gridWorldSize, nodeRadius, 0, cData, null, 0);
            //cData.dog.gridOffset = pathData.gridOffset;
            cData.dog.grid = pathData.grid;
            cData.dog.openSet = pathData.openSet;
            //cData.dog.closedSet = pathData.closedSet; //NOT USED ANYMORE. DOUBLE CHECK BEFORE REMOVING COMPLETELY
        ...
        if (cData.mSwtc == 3) {
            ...
            if (FramePathfindIteratedCounter > FramePathfindIteratedCounterMax) {
                ...
                for (var i = 0; i < pathfindIterations; i++) {
                    ...
                    pathData = SC_PathFind_cc_5.npcPathFind(gridWorldSize, nodeRadius, cData, forceUseRetracePathSwtc);
...
/*//---//////console.PrintError("sSwtc == 3  SC_AI_Drone_Combat_cc_Rout_For_SFWPP_5.js");
...
if (currentWaypoint.x === lastCurrentWaypoint.x && currentWaypoint.y === lastCurrentWaypoint.y && cData.cFWPD < minimumDistance) //original minimumDistance //but it bugs at some point... why? let's search
{
            ...
            if (cData.dog.path != null)
            {
                ...
                else //if (cData.dog.path.length <= 0)
                {
                    ...
                    if (pathData.fSwtch == 1) {
                        //---//////console.PrintError("00fSwtch == 1 // SC_AI_Drone_Combat_cc_Rout_For_SFWPP_5.js");
                    }
                    else if (pathData.fSwtch == 0) {
                        //---//////console.PrintError("00fSwtch == 0 // SC_AI_Drone_Combat_cc_Rout_For_SFWPP_5.js");
                    }
    ...
    else //currentWaypoint.x === lastCurrentWaypoint.x && currentWaypoint.y === lastCurrentWaypoint.y && cData.cFWPD > minimumDistance
    {
        ...
        if (cData.cFWPD > minimumDistance) //original minimumDistance
        {
            ...
            if (pathData.fSwtch == 1)
            {
                //---//////console.PrintError("11fSwtch == 1 // SC_AI_Drone_Combat_cc_Rout_For_SFWPP_5.js");
            }
            else if (pathData.fSwtch == 0)
            {
                //---//////console.PrintError("11fSwtch == 0 // SC_AI_Drone_Combat_cc_Rout_For_SFWPP_5.js");
            }
            //cData.dog.gridOffset = pathData.gridOffset;
            cData.dog.grid = pathData.grid;
            cData.dog.openSet = pathData.openSet;
    ...
    ////---//////console.PrintError("npcGetGridData");
    //var pathData = SC_PathFindInitGrid_Data_cc_5_merge.npcGetGridData(gridWorldSize, nodeRadius, 0, cData, null);
    //cData.dog.gridOffset = pathData.gridOffset;
    //cData.dog.grid = pathData.grid;
    //cData.dog.openSet = pathData.openSet;
    //cData.dog.closedSet = pathData.closedSet;
...
//---//////console.PrintError("rotationDOTFB " + rotationDOTFB + " rotationDOTRL " + rotationDOTRL + " rotationDOTVELO " + rotationDOTVELO  + " SC_AI_Drone_Combat_cc_Rout_For_SFWPP_5.js");
...
else
{
    ...
    if (distToNodeTwo > 0.25)
    {
        ...
        //---//////console.PrintError("distToNodeTwo " + distToNodeTwo + " SC_AI_Drone_Combat_cc_Rout_For_SFWPP_5.js");
        //npc.StickToPoint(cData.objt.nid, newOffsetWaypointPos.x, newOffsetWaypointPos.y, 0);

        if (rotationDOTFB >= 0.99)
        {
            //---//////console.PrintError("rotationDOTFB >= 0.99 " + " SC_AI_Drone_Combat_cc_Rout_For_SFWPP_5.js");
            ////npc.Unstick(cData.objt.nid);
            //npc.GoForward(cData.objt.nid);
            //npc.StickToPoint(cData.objt.nid, newOffsetWaypointPos.x, newOffsetWaypointPos.y, 0);
            npc.FaceCoord(cData.objt.nid, newOffsetWaypointPos.x, newOffsetWaypointPos.y);
        ...
        //---//////console.PrintError("cData.dog.path.shift(); distToNodeTwo <= 0.1 " + " SC_AI_Drone_Combat_cc_Rout_For_SFWPP_5.js");
        ////npc.Unstick(cData.objt.nid);
        ////npc.Unstick(cData.objt.nid);
        cData.dog.path.shift();
        //////npc.InstantStop(cData.objt.nid);
