...
include(SC_AI_Drone_Combat_cc_Rout_For_FWP_3.js);
include(SC_AI_Drone_Combat_cc_Rout_Com_3.js);
include(SC_AI_Drone_Combat_cc_Reset_Speed_3.js);
include(SC_AI_Drone_Combat_cc_Friendlies_3.js);

include(SC_Perceptron.js);
include(SC_AI_Drone_Combat_cc_Rout_For_Prot_3.js);
...
var SC_AI_Drone_Combat_cc_Rout_For_3 =
{
    AIRoutineInit: function (currentObjective, addFriendSwitch) {
        arrayOfFriendlies = SC_AI_Drone_Combat_cc_Friendlies_3.AIAddFriendlies(currentObjective, addFriendSwitch);
        ...
        if (cData.length >= currentObjective.droneIndex && ceData.length >= currentObjective.droneIndex && cData[currentObjective.droneIndex] != null && ceData[currentObjective.droneIndex] != null)
        {
            ...
            if (currentObjective.speedSwitch == 1) {
                if (nData != null && pData != null) {
                    ...
                    currentFormationWaypoint = SC_AI_Drone_Combat_cc_Rout_For_FWP_3.npcGWFP(currentObjective, 5);
                    ...
                    if (cData[currentObjective.droneIndex].swtchForPathfind == 1 && activateThisFramePathfindCounter > activateThisFramePathfindCounterMax) // || cData[currentObjective.droneIndex].swtchForPathfind == 0
                    {
                        ...
                        //REPLACING THE FORMATION WAYPOINT WITH THE PATHFIND WAYPOINT SECTION. TO REVIEW .
                        //REPLACING THE FORMATION WAYPOINT WITH THE PATHFIND WAYPOINT SECTION. TO REVIEW .
                        cData[currentObjective.droneIndex] = SC_AI_Drone_Combat_cc_Rout_For_SFWPP_3.npcPathfindToWaypoint(cData[currentObjective.droneIndex]);
                        ...
                        //FROM THE SCRIPT SC_AI_Drone_Combat_cc_Rout_For_SFWPP_3.js
                        //FROM THE SCRIPT SC_AI_Drone_Combat_cc_Rout_For_SFWPP_3.js
                        var offSetDist = 6.5;
                        ...
                        //{
                            ...
                            dataToReturn = SC_AI_Drone_Combat_cc_Rout_Com_3.AICombatRoutine(cData[currentObjective.droneIndex], ceData[currentObjective.droneIndex]);
                                                    ...
                                                    if (isLeftOrRight > 0) {
                                                        if (pushToTheLEFT[currentObjective.droneIndex] == 1) {
                                                            if (leftPushCounter[currentObjective.droneIndex] >= dotToGoalRLLEFT) {
                                                                SC_AI_Drone_Combat_cc_Rout_For_Prot_3.AIMoveProtocol(cData, currentObjective, 2, 0, currentFormationWaypoint, _currentWaypointPathDirection);
                                                                //SC_AI_Drone_Combat_cc_Rout_For_Prot_3.AIMoveProtocol(cData, currentObjective, 2, 0, currentFormationWaypoint, _currentWaypointPathDirection);
                                            ...
                                            if (isLeftOrRight > 0) {
                                                if (pushBACK[currentObjective.droneIndex] == 1) {
                                                    if (backPushCounter[currentObjective.droneIndex] >= dotToGoalRLBACK) {
                                                        SC_AI_Drone_Combat_cc_Rout_For_Prot_3.AIMoveProtocol(cData, currentObjective, 1, 0, currentFormationWaypoint, _currentWaypointPathDirection);
                                                        //SC_AI_Drone_Combat_cc_Rout_For_Prot_3.AIMoveProtocol(cData, currentObjective, 1, 0, currentFormationWaypoint, _currentWaypointPathDirection);
                            ...
                            if (activateThisFramePathfindCounterTWO > activateThisFramePathfindCounterTWOMax) {
                                ...
                                if (alignedDirectionWithPlayerDirectionRIGHTDOT <= -0.05 || alignedDirectionWithPlayerDirectionRIGHTDOT >= 0.05) {
                                    SC_AI_Drone_Combat_cc_Rout_For_Prot_3.AIMoveProtocol(cData, currentObjective, 0, 0, currentFormationWaypoint, _currentWaypointPathDirection);
                                }
                    ...
                    else //cData[currentObjective.droneIndex].swtchForPathfind == 0 or else
                    {
                        ...
                        /*if (cData[currentObjective.droneIndex].objt.command == 0 && ceData.ts == -1) {
                            cData[currentObjective.droneIndex].mSwtc = 1;
                            cData[currentObjective.droneIndex] = SC_AI_Drone_Combat_cc_Rout_For_SFWP_3.npcStayInFormation(cData[currentObjective.droneIndex]);
                        }
            ...
            {
                SC_AI_Drone_Combat_cc_Reset_Speed_3.AICombatResetSpeed(currentObjective);
            }
