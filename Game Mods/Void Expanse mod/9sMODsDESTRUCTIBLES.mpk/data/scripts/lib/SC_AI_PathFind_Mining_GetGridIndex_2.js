using(console);
include(SC_AI_PathFind_Mining_GetGridWorldPos_2.js);

var SC_AI_PathFind_Mining_GetGridIndex_2 =
{
    getNewGridIndex: function (initialPos, seekerPos, gridWorldSize, sid) 
    {
        var gridData = SC_AI_PathFind_Mining_GetGridWorldPos_2.getGridWorldPosition(initialPos, seekerPos, gridWorldSize, sid);
