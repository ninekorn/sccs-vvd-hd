...
include(SC_AI_Drone_Combat_Sta_aRep_5.js);
...
var SC_AI_Drone_Combat_cc_Core_5 =
{
...
function AICoreComputeObjective(currentObjective, addFriendSwitch) {
    ...
    switch (currentObjective.name) {
        case "get_in_formation":
            {
                SC_AI_Drone_Combat_cc_Rout_For_5.AIRoutineInit(currentObjective, addFriendSwitch);
                break;
            }
        case "station_vicinity":
            {            
                ...
                {              
                    ...
                    {                  
                        var aRepStatus = SC_AI_Drone_Combat_Sta_aRep_5.AIaRep(currentObjective, globIndex);
...
else
{
    ...
    {
        //var currentFormationWaypoint = SC_AI_Drone_Combat_cc_Rout_For_FWP_5.npcGWFP(currentObjective);
