...
include(SC_AI_PathFind_Mining_2.js);
...
var SC_AI_Drone_Mining_Rout_For_SFWPP_2 =
{
    npcPathfindToWaypoint: function (cData) //cData.nData, cData.pData, cData.objt, cData.cFWP,cData.cFWPD
    {
        if (cData.mSwtc == 1) {
            ...
            var pathData = SC_AI_PathFind_Mining_InitGrid_2.npcBuildGrid(gridWorldSize, nodeRadius, 0, cData, null);
            ...
            var pathData = null;
            for (var i = 0; i < 10; i++) {
                pathData = SC_AI_PathFind_Mining_2.npcPathFind(gridWorldSize, nodeRadius, cData);
