...
var SC_PathFindUtilities_cc_5 =
{
    ...
    getGridWorldPosition: function (initialPos, seekerPos, gridWorldSize, sid)  //yep still fail. yep. yeah... godamnit.
    {
        ...
        if ((gridWorldSize.xL + gridWorldSize.xR + 1) == 2)
        {
            ...
            dividerDecimal = 0.5; //doesn't work yet as of 06th april 2021 - ninekorn => widthL = 1 and widthR = 0
        }
    ...
    getNewGridIndex: function (initialPos, seekerPos, gridWorldSize, sid) {
        var gridData = SC_PathFindUtilities_cc_5.getGridWorldPosition(initialPos, seekerPos, gridWorldSize, sid);
