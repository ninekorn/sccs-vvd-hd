using(console);
include(SC_AI_PathFind_Mining_GetGridWorldPos_1.js);

var SC_AI_PathFind_Mining_GetGridIndex_1 =
{
    getNewGridIndex: function (initialPos, seekerPos, gridWorldSize, sid) 
    {
        var gridData = SC_AI_PathFind_Mining_GetGridWorldPos_1.getGridWorldPosition(initialPos, seekerPos, gridWorldSize, sid);
