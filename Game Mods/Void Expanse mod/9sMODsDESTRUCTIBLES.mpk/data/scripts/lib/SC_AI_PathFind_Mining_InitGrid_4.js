using(console);
include(SC_PathFindUtilities_Mining_4.js);
...
var SC_AI_PathFind_Mining_InitGrid_4 =
{
    ...
    npcBuildGrid: function (gridWorldSize, nodeRadius, indexOfGrid, cData, noder, stationTiles) {
        ...
        if (storage.IsSetGlobal("GlobalIndex_Player_" + cData.objt.pName)) {
            ...
            {
                console.PrintError("station tiles for base " + cData.SelectedStation + " -is- set." + " SC_AI_PathFind_Mining_InitGrid_Data_Mining_4.js");
                ...
                if (!storage.IsSetGlobal("station_tiles" + cData.SelectedStation))
                {
                    ...
                    switchForStationTiles = -1;
                    areThereAnyStations = -1;
                    console.PrintError("station tiles for base " + cData.SelectedStation + " -is not- set global." + " SC_AI_PathFind_Mining_InitGrid_Data_Mining_4.js");
                }
                else {
                    ...
                    if (cData.SelectedStation == null || isNaN(cData.SelectedStation)) {
                        console.PrintError("station tiles for base " + cData.SelectedStation + " -is not- set." + " SC_AI_PathFind_Mining_InitGrid_Data_Mining_4.js");
                    }
                    else {
                        console.PrintError("station tiles for base " + cData.SelectedStation + " -is set global" + " SC_AI_PathFind_Mining_InitGrid_Data_Mining_4.js");//
                    }
                }
        ...
        for (var x = -gridSizeXL; x <= gridSizeXR; x++) {
            for (var y = -gridSizeYB; y <= gridSizeYT; y++) {
                ...
                if (worldPoint.x === cData.lip.x && worldPoint.y === cData.lip.y) {
                    ...
                    var startNodehcoster = SC_PathFindUtilities_Mining_4.npcCheckDistance(worldPoint, cData.ltp);
                    ...
                    gcosty = SC_PathFindUtilities_Mining_4.npcCheckDistance(cData.lsp, worldPoint);
                    hcosty = SC_PathFindUtilities_Mining_4.npcCheckDistance(worldPoint, cData.ltp);
                    ...
                    gcosty = SC_PathFindUtilities_Mining_4.npcCheckDistance(cData.lsp, worldPoint);
                    hcosty = SC_PathFindUtilities_Mining_4.npcCheckDistance(cData.ltp, worldPoint);
                    fcosty = gcosty + hcosty;
                ...
                /*if (worldPoint.x === initialPathfindStartingPos[globIndex].x && worldPoint.y === initialPathfindStartingPos[globIndex].y) {
                    console.PrintError("found start Node");
                    var startNodegcoster = 0;
                    var startNodehcoster = SC_PathFindUtilities_Mining_4.npcCheckDistance(worldPoint, initialPathfindTargetPos[globIndex]);
                    var startNodefcoster = startNodegcoster + startNodehcoster;
                    ...
                    console.PrintError("new Grid");
                    gcosty = SC_PathFindUtilities_Mining_4.npcCheckDistance(cData.lsp, worldPoint);
                    hcosty = SC_PathFindUtilities_Mining_4.npcCheckDistance(worldPoint, initialPathfindTargetPos[globIndex]);
                    fcosty = gcosty + hcosty;
                    ...
                    gcosty = SC_PathFindUtilities_Mining_4.npcCheckDistance(cData.lsp, worldPoint);
                    hcosty = SC_PathFindUtilities_Mining_4.npcCheckDistance(initialPathfindTargetPos[globIndex], worldPoint);
                    fcosty = gcosty + hcosty;
