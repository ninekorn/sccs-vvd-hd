...
include(SC_AI_Drone_Combat_cc_Rout_For_1.js);
include(SC_AI_Drone_Combat_cc_Rout_For_FWP_1.js);
include(SC_AI_Drone_Combat_Sta_aRep_1.js);
...
var SC_AI_Drone_Combat_cc_Core_1 =
{
    AICoreInit: function (SHIP_ID, droneIndex, playerName, player_id, frameCounterArrayResetVisualTiles)
    {
        ...
        //console.PrintError("command: " + CToD.command);
...
function AICoreComputeObjective(currentObjective, addFriendSwitch) {
    ...
    switch (currentObjective.name) {
        case "get_in_formation":
            {
                SC_AI_Drone_Combat_cc_Rout_For_1.AIRoutineInit(currentObjective, addFriendSwitch);
                break;
            }
        case "station_vicinity":
            {            
                ...
                {              
                    ...
                    {                  
                        var aRepStatus = SC_AI_Drone_Combat_Sta_aRep_1.AIaRep(currentObjective, globIndex);
...
else
{
    ...
    {
        //var currentFormationWaypoint = SC_AI_Drone_Combat_cc_Rout_For_FWP_1.npcGWFP(currentObjective);
