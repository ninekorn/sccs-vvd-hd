...
include(SC_AI_PathFind_Mining_GetGridIndex_4.js);

var SC_AI_PathFind_Mining_CheckAllSides_4 =
{
    checkAllSides: function (node, gridWorldSize, cData, initialPos)
    {
        ...
        for (var x = -1; x <= 1; x++)
        {
            for (var y = -1; y <= 1; y++)
            {
                ...
                var gridData = SC_AI_PathFind_Mining_GetGridIndex_4.getNewGridIndex(initialPos, pos, gridWorldSize, cData.objt.sid);
