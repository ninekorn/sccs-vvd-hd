...
include(SC_AI_Drone_Mining_Rout_For_1.js);
...
var SC_AI_Drone_Mining_Core_1 =
{
	AICoreInit: function (SHIP_ID, droneIndex, playerName, player_id)
    {


        /*var theBase = storage.GetGlobal("player_starting_system_base_");

        if (theBase == null) {
            console.PrintError("there are no starting stations for this player starting point SC_AI_Drone_Mining_Core_1.js");
        }
        else {

            if (theBase == null) {
                console.PrintError("stationID NULL: " + theBase + " SC_AI_Drone_Mining_Core_1.js");
                cData.SelectedStation = null;
            }
            else {
                console.PrintError("stationID: " + theBase + " SC_AI_Drone_Mining_Core_1.js");
                cData.SelectedStation = theBase;
            }
        }*/
...
function AICoreComputeObjective(currentObjective, addFriendSwitch)
{
	...
	switch (currentObjective.name) 
	{
		case "get_in_formation":
			{
				SC_AI_Drone_Mining_Rout_For_1.AIRoutineInit(currentObjective, addFriendSwitch);
				break;
			}
