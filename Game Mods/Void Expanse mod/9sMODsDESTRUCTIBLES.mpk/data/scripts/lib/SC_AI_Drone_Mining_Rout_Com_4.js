...
include(SC_AI_Drone_Mining_Rout_For_SFWP_4.js);
include(SC_AI_Drone_Mining_Rout_Com_FndTarg_4.js);
include(SC_AI_Drone_Mining_InventoryChecks_4.js);

var tempLceData = null;
var dataToReturn = null;

var SC_AI_Drone_Mining_Rout_Com_4 =
{
    AICombatRoutine: function (cData, ceData)
    {  
		if(cData.objt.command == 0)
		{
			cData = SC_AI_Drone_Mining_Rout_For_SFWP_4.npcStayInFormation(cData);
		}
		else if(cData.objt.command == 11)
		{
			tempLceData = SC_AI_Drone_Mining_Rout_Com_FndTarg_4.npcFindTarget(cData);
			cData = tempLceData;
		}
...
function AIDepositMineralsInsidePlayersCargo(cData)
{
	...
	var isPlayerInventoryFull = SC_AI_Drone_Mining_InventoryChecks_4.AIIsPlayerCargoFull(cData.objt.pid);
