...
include(SC_AI_PathFind_Mining_GetGridIndex_2.js);

var SC_AI_PathFind_Mining_CheckAllSides_2 =
{
    checkAllSides: function (node, gridWorldSize, cData, initialPos)
    {
        ...
        for (var x = -1; x <= 1; x++)
        {
            for (var y = -1; y <= 1; y++)
            {
                ...
                var gridData = SC_AI_PathFind_Mining_GetGridIndex_2.getNewGridIndex(initialPos, pos, gridWorldSize, cData.objt.sid);
