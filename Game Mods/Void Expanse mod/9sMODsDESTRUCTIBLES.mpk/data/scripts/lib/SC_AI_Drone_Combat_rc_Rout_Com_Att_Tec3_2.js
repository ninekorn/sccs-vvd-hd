...
var SC_AI_Drone_Combat_rc_Rout_Com_Att_Tec3_2 =
{
    npcAttackTec3: function (ceData, otherShipCoord, distDroneToEnemy)
    {
        ceData.hasStP = 1;
        ...
        if (ceData.stopS == 0 && ceData.tec2C > 6 && alignedTowardsEnemy1 < 0.90 && alignedTowardsEnemy2 < 0 && distDroneToEnemy > ceData.npcLD)
        {
            ...
            /*else if (alignedTowardsEnemy0 > 0.97 && distDroneToEnemy < 4)
            {
