...
include(SC_AI_Drone_Combat_cc_Rout_For_3.js);
include(SC_AI_Drone_Combat_cc_Rout_For_FWP_3.js);
include(SC_AI_Drone_Combat_Sta_aRep_3.js);
...
var SC_AI_Drone_Combat_cc_Core_3 =
{
...
function AICoreComputeObjective(currentObjective, addFriendSwitch) {
    ...
    switch (currentObjective.name) {
        case "get_in_formation":
            {
                SC_AI_Drone_Combat_cc_Rout_For_3.AIRoutineInit(currentObjective, addFriendSwitch);
                break;
            }
        case "station_vicinity":
            {            
                ...
                {              
                    ...
                    {                  
                        var aRepStatus = SC_AI_Drone_Combat_Sta_aRep_3.AIaRep(currentObjective, globIndex);
...
else
{
    ...
    {
        //var currentFormationWaypoint = SC_AI_Drone_Combat_cc_Rout_For_FWP_3.npcGWFP(currentObjective);
