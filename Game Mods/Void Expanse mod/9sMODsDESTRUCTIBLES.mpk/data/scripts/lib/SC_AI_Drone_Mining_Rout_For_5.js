...
include(SC_AI_Drone_Mining_Rout_For_FWP_5.js);
include(SC_AI_Drone_Mining_Rout_Com_5.js);
include(SC_AI_Drone_Mining_Reset_Speed_5.js);
include(SC_AI_Drone_Mining_Friendlies_5.js);
...
var SC_AI_Drone_Mining_Rout_For_5 =
{
    AIRoutineInit: function (currentObjective,addFriendSwitch) 
	{
		arrayOfFriendlies = SC_AI_Drone_Mining_Friendlies_5.AIAddFriendlies(currentObjective,addFriendSwitch);
        ...
        if (cData.length >= currentObjective.droneIndex && ceData.length >= currentObjective.droneIndex && cData[currentObjective.droneIndex] != null && ceData[currentObjective.droneIndex] != null )
        {
            ...
            if (currentObjective.speedSwitch == 1)
            {
                if (nData != null && pData != null)
                {
                    ...
                    currentFormationWaypoint = SC_AI_Drone_Mining_Rout_For_FWP_5.npcGWFP(currentObjective, 5);
					...
					if (distToWaypoint >= 25) 
					{
                        ...
                        dataToReturn = SC_AI_Drone_Mining_Rout_Com_5.AICombatRoutine(cData[currentObjective.droneIndex], ceData[currentObjective.droneIndex]);
            ...
            {
                SC_AI_Drone_Mining_Reset_Speed_5.AICombatResetSpeed(currentObjective);
            }
        }
        else
        {
