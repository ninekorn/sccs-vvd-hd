using(console);
include(SC_PathFindUtilities_Mining_5.js);
...
var SC_AI_PathFind_Mining_InitGrid_5 =
{
        ...
        for (var x = -gridSizeXL; x <= gridSizeXR; x++) {
            for (var y = -gridSizeYB; y <= gridSizeYT; y++) {
                ...
                if (worldPoint.x === cData.lip.x && worldPoint.y === cData.lip.y) {
                    ...
                    var startNodehcoster = SC_PathFindUtilities_Mining_5.npcCheckDistance(worldPoint, cData.ltp);
                    ...
                    gcosty = SC_PathFindUtilities_Mining_5.npcCheckDistance(cData.lsp, worldPoint);
                    hcosty = SC_PathFindUtilities_Mining_5.npcCheckDistance(worldPoint, cData.ltp);
                    ...
                    gcosty = SC_PathFindUtilities_Mining_5.npcCheckDistance(cData.lsp, worldPoint);
                    hcosty = SC_PathFindUtilities_Mining_5.npcCheckDistance(cData.ltp, worldPoint);
                    fcosty = gcosty + hcosty;
                ...
                /*if (worldPoint.x === initialPathfindStartingPos[globIndex].x && worldPoint.y === initialPathfindStartingPos[globIndex].y) {
                    console.PrintError("found start Node");
                    var startNodegcoster = 0;
                    var startNodehcoster = SC_PathFindUtilities_Mining_5.npcCheckDistance(worldPoint, initialPathfindTargetPos[globIndex]);
                    var startNodefcoster = startNodegcoster + startNodehcoster;
                    ...
                    console.PrintError("new Grid");
                    gcosty = SC_PathFindUtilities_Mining_5.npcCheckDistance(cData.lsp, worldPoint);
                    hcosty = SC_PathFindUtilities_Mining_5.npcCheckDistance(worldPoint, initialPathfindTargetPos[globIndex]);
                    fcosty = gcosty + hcosty;
                    ...
                    gcosty = SC_PathFindUtilities_Mining_5.npcCheckDistance(cData.lsp, worldPoint);
                    hcosty = SC_PathFindUtilities_Mining_5.npcCheckDistance(initialPathfindTargetPos[globIndex], worldPoint);
                    fcosty = gcosty + hcosty;
