...
var SC_AI_Drone_Combat_rc_Core_3 =
{
...
function AICoreComputeObjective(currentObjective, addFriendSwitch)
{
	...
	switch (currentObjective.name) 
	{
		case "get_in_formation":
			{
				SC_AI_Drone_Combat_rc_Rout_For_3.AIRoutineInit(currentObjective, addFriendSwitch);
				break;
			}
