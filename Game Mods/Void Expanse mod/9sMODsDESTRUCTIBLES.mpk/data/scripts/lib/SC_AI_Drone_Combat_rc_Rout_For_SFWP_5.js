...
var SC_AI_Drone_Combat_rc_Rout_For_SFWP_5 = 
{
    npcStayInFormation: function (cData) //cData.nData, cData.pData, cData.objt, cData.cFWP,cData.cFWPD
    {
            ...
            {      
                ...
                var waypointOffsetX = cData.cFWP.x + (cData.pData.pForward.x * 3.5);
                var waypointOffsetY = cData.cFWP.y + (cData.pData.pForward.y * 3.5);
            ...
            if (cData.cFWPD <= 4 && cData.fSwtc == 0)
            {
                var pointInFrontOfWaypointX = cData.cFWP.x + cData.pData.pForward.x;
                var pointInFrontOfWaypointY = cData.cFWP.y + cData.pData.pForward.y;
            ...
            if (cData.cFWPD <= 4 && cData.fSwtc == 1) //cData.cFWPD <= 2 && 
            {
                if (cData.cFWPD > 1)
                {
                    ...
                    var newOffsetWaypointPosX = cData.cFWP.x + (dirToWaypointX * 3.5);
                    var newOffsetWaypointPosY = cData.cFWP.y + (dirToWaypointY * 3.5);
                ...
                {
                    var newOffsetWaypointPosX = cData.cFWP.x + (cData.pData.pForward.x * 3.5);
                    var newOffsetWaypointPosY = cData.cFWP.y + (cData.pData.pForward.y * 3.5);
