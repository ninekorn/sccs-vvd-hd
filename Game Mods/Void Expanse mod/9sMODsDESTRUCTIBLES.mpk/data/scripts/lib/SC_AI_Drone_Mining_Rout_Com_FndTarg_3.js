...
include(SC_AI_Drone_Mining_Rout_For_SFWPP_3.js);

var listOfAsteroids = [];
var lastListOfAsteroids = [];
var test;

var SC_AI_Drone_Mining_Rout_Com_FndTarg_3 =
{
    ...
    {		
		...
		if(cData.lLSwtc == 0)
		{
			var isNpcInventoryFull = SC_AI_Drone_Mining_InventoryChecks_3.AICheckStateOfInventory(cData.objt.nid);
		...
		else if(cData.lLSwtc == 2)
		{
			...
			if(distToAst <= 6)
			{
				...
				if(cData.mSwtc != 9)
				{	
					cData = SC_AI_Drone_Mining_Rout_For_SFWPP_3.npcPathfindToWaypoint(cData);
				}
				else
				{
