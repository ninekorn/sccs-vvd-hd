...
var SC_AI_Drone_Combat_rc_Core_5 =
{
...
function AICoreComputeObjective(currentObjective, addFriendSwitch)
{
	...
	switch (currentObjective.name) 
	{
		case "get_in_formation":
			{
				SC_AI_Drone_Combat_rc_Rout_For_5.AIRoutineInit(currentObjective, addFriendSwitch);
				break;
			}
