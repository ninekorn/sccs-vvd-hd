...
include(SC_AI_Drone_Combat_rc_Rout_Com_Att_Tec2_1.js);
include(SC_AI_Drone_Combat_rc_Rout_Com_Att_Tec3_1.js);

var lockdist = 20;
var randomPos = -1;

var SC_AI_Drone_Combat_rc_Rout_Com_Att_1 =
{
            ...
            if (distPlayerToEnemy <= 25) // && distPlayerToDrone <= 20
            {
                ...
                if (ceData.evad == 0) //ceData.evad != 1
                {
                    ...
                    if (ceData.mReset == 1)
                    {
                        ...
                        {
                            if (ceData.tec == 2) {
                                ceData = SC_AI_Drone_Combat_rc_Rout_Com_Att_Tec2_1.npcAttackTec2(ceData, otherShipCoord, distDroneToEnemy);
                            }
                            else if (ceData.tec == 3) {
                                ceData = SC_AI_Drone_Combat_rc_Rout_Com_Att_Tec3_1.npcAttackTec3(ceData, otherShipCoord, distDroneToEnemy);
                            }
                        }
