...
include(SC_AI_Drone_Combat_cc_Friendlies_1.js);

include(SC_Perceptron.js);
include(SC_AI_Drone_Combat_cc_Rout_For_Prot_1.js);
...
var SC_AI_Drone_Combat_cc_Rout_For_1 =
{
    AIRoutineInit: function (currentObjective, addFriendSwitch) {
        arrayOfFriendlies = SC_AI_Drone_Combat_cc_Friendlies_1.AIAddFriendlies(currentObjective, addFriendSwitch);
            ...
            if (currentObjective.speedSwitch == 1) {
                if (nData != null && pData != null) {
                    ...
                    if (cData[currentObjective.droneIndex].swtchForPathfind == 1 && activateThisFramePathfindCounter > activateThisFramePathfindCounterMax) // || cData[currentObjective.droneIndex].swtchForPathfind == 0
                    {
                        ...
                        //REPLACING THE FORMATION WAYPOINT WITH THE PATHFIND WAYPOINT SECTION. TO REVIEW .
                        //REPLACING THE FORMATION WAYPOINT WITH THE PATHFIND WAYPOINT SECTION. TO REVIEW .
                        cData[currentObjective.droneIndex] = SC_AI_Drone_Combat_cc_Rout_For_SFWPP_1.npcPathfindToWaypoint(cData[currentObjective.droneIndex]);
                        ...
                        //FROM THE SCRIPT SC_AI_Drone_Combat_cc_Rout_For_SFWPP_1.js
                        //FROM THE SCRIPT SC_AI_Drone_Combat_cc_Rout_For_SFWPP_1.js
                        var offSetDist = 6.5;
                        ...
                        //{
                                                    ...
                                                    if (isLeftOrRight > 0) {
                                                        if (pushToTheLEFT[currentObjective.droneIndex] == 1) {
                                                            if (leftPushCounter[currentObjective.droneIndex] >= dotToGoalRLLEFT) {
                                                                SC_AI_Drone_Combat_cc_Rout_For_Prot_1.AIMoveProtocol(cData, currentObjective, 2, 0, currentFormationWaypoint, _currentWaypointPathDirection);
                                                                //SC_AI_Drone_Combat_cc_Rout_For_Prot_1.AIMoveProtocol(cData, currentObjective, 2, 0, currentFormationWaypoint, _currentWaypointPathDirection);
                                            ...
                                            if (isLeftOrRight > 0) {
                                                if (pushBACK[currentObjective.droneIndex] == 1) {
                                                    if (backPushCounter[currentObjective.droneIndex] >= dotToGoalRLBACK) {
                                                        SC_AI_Drone_Combat_cc_Rout_For_Prot_1.AIMoveProtocol(cData, currentObjective, 1, 0, currentFormationWaypoint, _currentWaypointPathDirection);
                                                        //SC_AI_Drone_Combat_cc_Rout_For_Prot_1.AIMoveProtocol(cData, currentObjective, 1, 0, currentFormationWaypoint, _currentWaypointPathDirection);
                            ...
                            if (activateThisFramePathfindCounterTWO > activateThisFramePathfindCounterTWOMax) {
                                ...
                                if (alignedDirectionWithPlayerDirectionRIGHTDOT <= -0.05 || alignedDirectionWithPlayerDirectionRIGHTDOT >= 0.05) {
                                    SC_AI_Drone_Combat_cc_Rout_For_Prot_1.AIMoveProtocol(cData, currentObjective, 0, 0, currentFormationWaypoint, _currentWaypointPathDirection);
                                }
                    ...
                    else //cData[currentObjective.droneIndex].swtchForPathfind == 0 or else
                    {
                        ...
                        /*if (cData[currentObjective.droneIndex].objt.command == 0 && ceData.ts == -1) {
                            cData[currentObjective.droneIndex].mSwtc = 1;
                            cData[currentObjective.droneIndex] = SC_AI_Drone_Combat_cc_Rout_For_SFWP_1.npcStayInFormation(cData[currentObjective.droneIndex]);
                        }
                            ...
                            //ADD SCRIPTS FOR THE PERCEPTRON, TO GET THE NEXT NODE OUT OF THE ABOVE FUNCTION, REMOVE any sorts or form of npc.InstantStop or npc.Stop or npc.StickToPoint. create scripts and have the perceptron start a new script hierarchy otherwise the SC_PathFind_cc_1.js will be cluttered and bigger than 20-30 kb.
                        }*/
