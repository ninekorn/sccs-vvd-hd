...
var SC_AI_PathFind_Mining_InitGrid_Data_Mining_2 =
{
    npcGetGridData: function (gridWorldSize, nodeRadius, indexOfGrid, cData, noder) {
        ...
        if (areThereAnyStations == -1) // NO STATIONS AVAILABLE SO THE PATHFIND CANNOT ACCESS THE STATION TILES. RETURM
        {
            ...
            someData = SC_AI_PathFind_Mining_InitGrid_2.npcBuildGrid(gridWorldSize, nodeRadius, indexOfGrid, cData, noder, nocoords);//set to null tiles array //nocoords
            //send no station tiles to the pathfind
        }
        else if (areThereAnyStations == 1) //TODO STATION EXISTS SO THE PATHFIND CANNOT ACCESS STATION TILES. RETURN
        {
            ...
            someData = SC_AI_PathFind_Mining_InitGrid_2.npcBuildGrid(gridWorldSize, nodeRadius, indexOfGrid, cData, noder, stationTilesArray[cData.iop]);
        }
