using(console);
include(SC_AI_PathFind_Mining_GetGridWorldPos_4.js);

var SC_AI_PathFind_Mining_GetGridIndex_4 =
{
    getNewGridIndex: function (initialPos, seekerPos, gridWorldSize, sid) 
    {
        var gridData = SC_AI_PathFind_Mining_GetGridWorldPos_4.getGridWorldPosition(initialPos, seekerPos, gridWorldSize, sid);
