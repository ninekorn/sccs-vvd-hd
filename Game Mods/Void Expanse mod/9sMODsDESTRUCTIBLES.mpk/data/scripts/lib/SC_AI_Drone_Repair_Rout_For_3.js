...
include(SC_AI_Drone_Repair_Rout_For_FWP_3.js);
include(SC_AI_Drone_Repair_Rout_Com_3.js);
include(SC_AI_Drone_Repair_Reset_Speed_3.js);
include(SC_AI_Drone_Repair_Friendlies_3.js);
...
var SC_AI_Drone_Repair_Rout_For_3 =
{
    AIRoutineInit: function (currentObjective,addFriendSwitch) 
	{
		arrayOfFriendlies = SC_AI_Drone_Repair_Friendlies_3.AIAddFriendlies(currentObjective,addFriendSwitch);
        ...
        if (cData.length >= currentObjective.droneIndex && ceData.length >= currentObjective.droneIndex && cData[currentObjective.droneIndex] != null && ceData[currentObjective.droneIndex] != null )
        {
            ...
            if (currentObjective.speedSwitch == 1)
            {
                if (nData != null && pData != null)
                {
                    ...
                    currentFormationWaypoint = SC_AI_Drone_Repair_Rout_For_FWP_3.npcGWFP(currentObjective, 5);
					...
					if (distToWaypoint >= 25) 
					{
                        ...
                        dataToReturn = SC_AI_Drone_Repair_Rout_Com_3.AICombatRoutine(cData[currentObjective.droneIndex], ceData[currentObjective.droneIndex]);
            ...
            {
                SC_AI_Drone_Repair_Reset_Speed_3.AICombatResetSpeed(currentObjective);
            }
        }
        else
        {
