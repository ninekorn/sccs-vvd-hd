...
include(SC_AI_Drone_Combat_rc_Rout_For_FWP_2.js);
include(SC_AI_Drone_Combat_rc_Rout_Com_2.js);
include(SC_AI_Drone_Combat_rc_Reset_Speed_2.js);
include(SC_AI_Drone_Combat_rc_Friendlies_2.js);
...
var SC_AI_Drone_Combat_rc_Rout_For_2 =
{
    AIRoutineInit: function (currentObjective,addFriendSwitch) 
	{
		arrayOfFriendlies = SC_AI_Drone_Combat_rc_Friendlies_2.AIAddFriendlies(currentObjective,addFriendSwitch);
        ...
        if (cData.length >= currentObjective.droneIndex && ceData.length >= currentObjective.droneIndex && cData[currentObjective.droneIndex] != null && ceData[currentObjective.droneIndex] != null )
        {
            ...
            if (currentObjective.speedSwitch == 1)
            {
                if (nData != null && pData != null)
                {
                    ...
                    currentFormationWaypoint = SC_AI_Drone_Combat_rc_Rout_For_FWP_2.npcGWFP(currentObjective, 5);
					...
					if (distToWaypoint >= 25) 
					{
                        ...
                        dataToReturn = SC_AI_Drone_Combat_rc_Rout_Com_2.AICombatRoutine(cData[currentObjective.droneIndex], ceData[currentObjective.droneIndex]);
            ...
            {
                SC_AI_Drone_Combat_rc_Reset_Speed_2.AICombatResetSpeed(currentObjective);
            }
        }
        else
        {
