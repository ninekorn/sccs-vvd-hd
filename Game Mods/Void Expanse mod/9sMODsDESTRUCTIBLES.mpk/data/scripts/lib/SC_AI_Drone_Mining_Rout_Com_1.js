...
include(SC_AI_Drone_Mining_Rout_For_SFWP_1.js);
include(SC_AI_Drone_Mining_Rout_Com_FndTarg_1.js);
include(SC_AI_Drone_Mining_InventoryChecks_1.js);

var tempLceData = null;
var dataToReturn = null;

var SC_AI_Drone_Mining_Rout_Com_1 =
{
    AICombatRoutine: function (cData, ceData)
    {  
		if(cData.objt.command == 0)
		{
			cData = SC_AI_Drone_Mining_Rout_For_SFWP_1.npcStayInFormation(cData);
		}
		else if(cData.objt.command == 11)
		{
			tempLceData = SC_AI_Drone_Mining_Rout_Com_FndTarg_1.npcFindTarget(cData);
			cData = tempLceData;
		}
		else if(cData.objt.command == 2)
		{
            ...
            if (cData.lLSwtc == 5) //change pathfind to player instead of asteroid.
            {
                console.PrintError("cData.lLSwtc == 5 " + " SC_AI_Drone_Mining_Rout_Com_1.js");
                ...
                if (distToPlayer <= cData.DistanceToAsteroid)
                {
                    ...
                    if (cData.mSwtc != 9) {
                        console.PrintError("activating pathfind");
                        cData = SC_AI_Drone_Mining_Rout_For_SFWPP_1.npcPathfindToWaypoint(cData);
                    }
                    else {
                        console.PrintError("stick to point");
                        if (distToPlayer <= 4)  //ORIGINAL 4
                        {
                    ...
                    console.PrintError("distToAsteroid is to far " + "SC_AI_Drone_Mining_Rout_Com_1.js");
    ...
    /*AIDepositMineralsInsidePlayersCargo: function (cData) {
