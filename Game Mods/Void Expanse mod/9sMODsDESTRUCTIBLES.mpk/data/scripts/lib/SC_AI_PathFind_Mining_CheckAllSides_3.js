...
include(SC_AI_PathFind_Mining_GetGridIndex_3.js);

var SC_AI_PathFind_Mining_CheckAllSides_3 =
{
    checkAllSides: function (node, gridWorldSize, cData, initialPos)
    {
        ...
        for (var x = -1; x <= 1; x++)
        {
            for (var y = -1; y <= 1; y++)
            {
                ...
                var gridData = SC_AI_PathFind_Mining_GetGridIndex_3.getNewGridIndex(initialPos, pos, gridWorldSize, cData.objt.sid);
