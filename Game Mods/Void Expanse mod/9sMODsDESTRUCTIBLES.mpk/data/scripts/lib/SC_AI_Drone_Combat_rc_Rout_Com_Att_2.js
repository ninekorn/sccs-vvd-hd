...
include(SC_AI_Drone_Combat_rc_Rout_Com_Att_Tec2_2.js);
include(SC_AI_Drone_Combat_rc_Rout_Com_Att_Tec3_2.js);

var lockdist = 20;
var randomPos = -1;

var SC_AI_Drone_Combat_rc_Rout_Com_Att_2 =
{
            ...
            if (distPlayerToEnemy <= 25) // && distPlayerToDrone <= 20
            {
                ...
                if (ceData.evad == 0) //ceData.evad != 1
                {
                    ...
                    if (ceData.mReset == 1)
                    {
                        ...
                        {
                            if (ceData.tec == 2) {
                                ceData = SC_AI_Drone_Combat_rc_Rout_Com_Att_Tec2_2.npcAttackTec2(ceData, otherShipCoord, distDroneToEnemy);
                            }
                            else if (ceData.tec == 3) {
                                ceData = SC_AI_Drone_Combat_rc_Rout_Com_Att_Tec3_2.npcAttackTec3(ceData, otherShipCoord, distDroneToEnemy);
                            }
                        }
