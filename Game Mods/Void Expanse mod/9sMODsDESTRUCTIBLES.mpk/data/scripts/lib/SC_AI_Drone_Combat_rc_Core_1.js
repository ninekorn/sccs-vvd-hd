...
var SC_AI_Drone_Combat_rc_Core_1 =
{
...
function AICoreComputeObjective(currentObjective, addFriendSwitch)
{
	...
	switch (currentObjective.name) 
	{
		case "get_in_formation":
			{
				SC_AI_Drone_Combat_rc_Rout_For_1.AIRoutineInit(currentObjective, addFriendSwitch);
				break;
			}
