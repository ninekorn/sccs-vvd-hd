using(console);
include(SC_AI_PathFind_Mining_GetGridWorldPos_5.js);

var SC_AI_PathFind_Mining_GetGridIndex_5 =
{
    getNewGridIndex: function (initialPos, seekerPos, gridWorldSize, sid) 
    {
        var gridData = SC_AI_PathFind_Mining_GetGridWorldPos_5.getGridWorldPosition(initialPos, seekerPos, gridWorldSize, sid);
