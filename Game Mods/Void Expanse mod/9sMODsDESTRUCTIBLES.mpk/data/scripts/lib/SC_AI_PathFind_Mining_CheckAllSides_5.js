...
include(SC_AI_PathFind_Mining_GetGridIndex_5.js);

var SC_AI_PathFind_Mining_CheckAllSides_5 =
{
    checkAllSides: function (node, gridWorldSize, cData, initialPos)
    {
        ...
        for (var x = -1; x <= 1; x++)
        {
            for (var y = -1; y <= 1; y++)
            {
                ...
                var gridData = SC_AI_PathFind_Mining_GetGridIndex_5.getNewGridIndex(initialPos, pos, gridWorldSize, cData.objt.sid);
