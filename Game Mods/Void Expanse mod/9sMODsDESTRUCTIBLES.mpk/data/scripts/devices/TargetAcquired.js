...
function OnStart(args)
{
   ...
   //default cooldown - 60 seconds
    ...
    //game.ShipPlaySound(args.ship_id, "repair_module_use", "special/generic_device.ogg", 0, false);

	//game.ShipPlaySound(args.ship_id, "SC_NPC/SC_NPC_TalkDevice/SC_NPC_Combat_TalkDevice_TargetAcquired.ogg", 0, false);
	//game.ShipPlaySound(args.ship_id, "SC_NPC/TargetAcquired.ogg", 0, false);
	game.ShipPlaySound(args.ship_id, "TargetAcquired" + args.slot_id + "_" + args.target_id,  "special/TargetAcquired.ogg", 0.1, false);
}

function OnFrame(args)
{
	//game.ShipPlaySound(args.ship_id, "SC_NPC/TargetAcquired.ogg", 0, false);
	//game.ShipPlaySound(args.ship_id, "TargetAcquired" + args.slot_id + "_" + args.target_id, "special/TargetAcquired.ogg", 0.1, true);
}
